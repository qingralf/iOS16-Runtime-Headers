...
@property (readonly) NSDictionary *currentCatalystSDKDictionary;
@property (readonly) _EXExtensionPoint *currentExtensionPoint;
@property (readonly) NSString *currentIdentifier;
@property (readonly) NSDictionary *currentNativeSDKDictionary;
...
- (void).cxx_destruct;
- (id)config;
- (id)currentCatalystSDKDictionary;
- (id)currentExtensionPoint;
- (id)currentIdentifier;
- (id)currentNativeSDKDictionary;
- (id)extensionPoints;
