...
- (struct { unsigned int x1 : 1; unsigned int x2 : 1; unsigned int x3 : 1; unsigned int x4 : 1; unsigned int x5 : 1; unsigned int x6 : 1; unsigned int x7 : 1; unsigned int x8 : 1; unsigned int x9 : 1; unsigned int x10 : 55; })pipelineFlagsWithObjectVariant:(id)arg1 meshVariant:(id)arg2 fragmentVariant:(id)arg3;
...
- (void)updateAccelerationStructureDescriptor:(id)arg1 withDescriptor:(id)arg2;
