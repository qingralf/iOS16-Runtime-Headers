...
@interface _MTLBinaryArchive : _MTLObjectWithLabel <MTLBinaryArchiveSPI> {
    struct unordered_map<unsigned long long, std::vector<MTLFunctionId>, std::hash<unsigned long long>, std::equal_to<unsigned long long>, std::allocator<std::pair<const unsigned long long, std::vector<MTLFunctionId>>>> { 
        struct __hash_table<std::__hash_value_type<unsigned long long, std::vector<MTLFunctionId>>, std::__unordered_map_hasher<unsigned long long, std::__hash_value_type<unsigned long long, std::vector<MTLFunctionId>>, std::hash<unsigned long long>, std::equal_to<unsigned long long>, true>, std::__unordered_map_equal<unsigned long long, std::__hash_value_type<unsigned long long, std::vector<MTLFunctionId>>, std::equal_to<unsigned long long>, std::hash<unsigned long long>, true>, std::allocator<std::__hash_value_type<unsigned long long, std::vector<MTLFunctionId>>>> { 
            ...
            struct __compressed_pair<unsigned long, std::__unordered_map_hasher<unsigned long long, std::__hash_value_type<unsigned long long, std::vector<MTLFunctionId>>, std::hash<unsigned long long>, std::equal_to<unsigned long long>, true>> { 
                unsigned long long __value_; 
            } __p2_; 
            struct __compressed_pair<float, std::__unordered_map_equal<unsigned long long, std::__hash_value_type<unsigned long long, std::vector<MTLFunctionId>>, std::equal_to<unsigned long long>, std::hash<unsigned long long>, true>> { 
                float __value_; 
            } __p3_; 
        } __table_; 
    }  _airntBinaryList;
...
+ (unsigned int)archiveVersionCompatible:(struct MachOToolsVersion { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; })arg1 vendorVersion:(unsigned int)arg2;
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)addAirntExtraDataWithFunctionId:(const struct MTLFunctionId { struct { unsigned char x_1_1_1[32]; } x1; struct { unsigned char x_2_1_1[32]; } x2[4]; unsigned int x3; }*)arg1 descriptor:(const void*)arg2 bitcode:(id)arg3;
...
- (id)materializeAIRNTBlockForKey:(id)arg1;
...
- (id)materializeAirScript:(struct MTLAirNTObject { unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; unsigned int x8; unsigned int x9; unsigned int x10; unsigned int x11; char *x12; char *x13; char *x14; char *x15; struct { /* ? */ } *x16; }*)arg1;
- (void)materializeAll;
- (void)materializeAllAIRNTLegacy;
- (id)materializeBitCode:(struct MTLAirNTObject { unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; unsigned int x8; unsigned int x9; unsigned int x10; unsigned int x11; char *x12; char *x13; char *x14; char *x15; struct { /* ? */ } *x16; }*)arg1;
- (id)materializeDriverReflection:(struct MTLAirNTObject { unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; unsigned int x8; unsigned int x9; unsigned int x10; unsigned int x11; char *x12; char *x13; char *x14; char *x15; struct { /* ? */ } *x16; }*)arg1;
...
- (id)materializePostLoaderReflection:(struct MTLAirNTObject { unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; unsigned int x8; unsigned int x9; unsigned int x10; unsigned int x11; char *x12; char *x13; char *x14; char *x15; struct { /* ? */ } *x16; }*)arg1;
- (id)newArchiverIdWithFunctionId:(const struct MTLFunctionId { struct { unsigned char x_1_1_1[32]; } x1; struct { unsigned char x_2_1_1[32]; } x2[4]; unsigned int x3; }*)arg1 srcArchiverId:(id)arg2 functionType:(unsigned long long)arg3;
- (id)newComputePipelineDescriptorWithScript:(const struct PipelineScript { unsigned char x1[1]; }*)arg1;
- (id)newFunctionWithAIRNTObject:(struct MTLAirNTObject { unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; unsigned int x8; unsigned int x9; unsigned int x10; unsigned int x11; char *x12; char *x13; char *x14; char *x15; struct { /* ? */ } *x16; }*)arg1 error:(id*)arg2;
- (id)newLibraryInArchiveAtPos:(struct MTLAirNTObject { unsigned long long x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; unsigned int x8; unsigned int x9; unsigned int x10; unsigned int x11; char *x12; char *x13; char *x14; char *x15; struct { /* ? */ } *x16; }*)arg1 error:(id*)arg2;
...
- (bool)supportsAIRNT;
- (bool)supportsStoringCompileOutput:(int)arg1;
- (id)unmaterializedAIRNTFunctionHashes;
- (id)unmaterializedArchiveHashes;
- (id)unmaterializedFunctionHashes;
- (void)updatePipelineWithPipelineArchiverId:(id)arg1 functionType:(unsigned long long)arg2;
