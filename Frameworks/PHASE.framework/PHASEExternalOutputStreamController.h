...
- (void).cxx_destruct;
- (struct UniqueObjectId { unsigned long long x1[2]; })controlToken;
- (void)dealloc;
- (id)description;
- (id)init;
- (id)initWithEngine:(id)arg1 streamGroupUUID:(id)arg2 gainMetaParameterDefinition:(id)arg3 mixerDefinition:(id)arg4 source:(id)arg5 listener:(id)arg6 group:(id)arg7 normalize:(bool)arg8 calibrationMode:(long long)arg9 level:(double)arg10 outError:(id*)arg11;
- (id)metaParameters;
- (id)metaParametersForStreamUUID:(id)arg1;
- (id)mixer;
- (id)mixers;
- (bool)prepareAndReturnError:(id*)arg1;
- (void)setControlToken:(struct UniqueObjectId { unsigned long long x1[2]; })arg1;
