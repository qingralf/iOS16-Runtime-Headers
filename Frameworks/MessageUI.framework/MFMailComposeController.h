...
@interface MFMailComposeController : UIViewController <CNAutocompleteGroupDetailViewControllerDelegate, CNComposeHeaderViewDelegate, CNContactContentViewControllerDelegate, CNContactPickerDelegate, ComposeViewNavigationBarDelegate, MFComposeActivityHandoffOperationDelegate, MFComposeImageSizeViewDelegate, MFComposeStyleSelectorViewControllerDelegate, MFComposeSubjectViewDelegate, MFComposeTypeFactoryDelegate, MFDatePickerViewControllerDelegate, MFMailComposeRecipientTextViewDelegate, MFMailComposeToFieldDelegate, MFMailComposeViewDelegate, MFMailMenuCommandProvider, MFPhotoPickerControllerDelegate, MFPreferredTitleProvider, MFSecureMIMECompositionManagerDelegate, NSUserActivityDelegate, QLPreviewControllerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIPopoverPresentationControllerDelegate, VNDocumentCameraViewControllerDelegate, _MFMailCompositionContextDelegate> {
    ...
    bool  _hideMyEmailForMailToURLCompose;
...
@property (nonatomic) bool hideMyEmailForMailToURLCompose;
...
- (bool)hideMyEmailForMailToURLCompose;
...
- (void)setHideMyEmailForMailToURLCompose:(bool)arg1;
