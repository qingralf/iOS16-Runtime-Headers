...
+ (void)registerModelEquivalencyOf:(id)arg1 to:(id)arg2;
+ (void)registerRequestClass:(Class)arg1 revision:(unsigned long long)arg2 modelEquivalencyToRevision:(unsigned long long)arg3;
+ (void)registerRequestClassName:(id)arg1 revision:(unsigned long long)arg2 modelEquivalencyToRevision:(unsigned long long)arg3;
