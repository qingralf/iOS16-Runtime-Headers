...
- (id)initWithOriginatingRequestSpecifier:(id)arg1 topLeft:(struct CGPoint { double x1; double x2; })arg2 bottomLeft:(struct CGPoint { double x1; double x2; })arg3 bottomRight:(struct CGPoint { double x1; double x2; })arg4 topRight:(struct CGPoint { double x1; double x2; })arg5;
- (id)initWithOriginatingRequestSpecifier:(id)arg1 topLeft:(struct CGPoint { double x1; double x2; })arg2 bottomLeft:(struct CGPoint { double x1; double x2; })arg3 bottomRight:(struct CGPoint { double x1; double x2; })arg4 topRight:(struct CGPoint { double x1; double x2; })arg5 boundingBox:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg6;
