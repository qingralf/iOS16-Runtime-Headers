...
+ (bool)createSingleNetworkPlanFromResourceName:(id)arg1 usingProcessingDevice:(id)arg2 lowPriorityMode:(bool)arg3 inputBlobNames:(id)arg4 outputBlobNames:(id)arg5 networkConfiguration:(id)arg6 memoryPoolId:(unsigned long long)arg7 espressoResources:(id*)arg8 error:(id*)arg9;
...
+ (bool)getWidth:(unsigned long long*)arg1 height:(unsigned long long*)arg2 ofBlobNamed:(id)arg3 forNetworkModelFileWithName:(id)arg4 error:(id*)arg5;
