...
@interface VNObservation : NSObject <NSCopying, NSSecureCoding, VNEntityIdentificationModelObservation, VNObjectCloning, VNOriginatingRequestSpecifierProviding, VNRequestRevisionProviding> {
    float  _confidence;
