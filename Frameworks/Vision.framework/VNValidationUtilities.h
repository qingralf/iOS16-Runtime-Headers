...
+ (bool)getOptionalExplicitProcessingDevice:(id*)arg1 inOptions:(id)arg2 error:(id*)arg3;
+ (bool)getOptionalObject:(id*)arg1 ofClass:(Class)arg2 forKey:(id)arg3 inOptions:(id)arg4 error:(id*)arg5;
+ (bool)getOptionalOriginatingRequestSpecifier:(id*)arg1 forKey:(id)arg2 inOptions:(id)arg3 specifyingSupportedRevisionsForRequestClass:(Class)arg4 error:(id*)arg5;
...
+ (bool)validateScoreRange:(float)arg1 error:(id*)arg2;
