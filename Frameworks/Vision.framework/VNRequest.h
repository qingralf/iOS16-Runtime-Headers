...
@interface VNRequest : NSObject <NSCopying, PADVNRequestProtocol, VNAsyncStatusProviding, VNClassCodeProviding, VNSequencedRequestSupporting, VNWarningRecorder> {
...
- (Class)applicableDetectorClassForRevision:(unsigned long long)arg1 error:(id*)arg2;
