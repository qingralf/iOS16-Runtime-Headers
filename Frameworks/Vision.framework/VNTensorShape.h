...
- (id)initWithBatchNumber:(unsigned long long)arg1 channels:(unsigned long long)arg2 width:(unsigned long long)arg3 height:(unsigned long long)arg4;
...
- (id)initWithSizes:(const unsigned long long*)arg1 count:(unsigned long long)arg2;
