...
@interface PKDrawingPaletteView : PKPaletteView <PKDrawingPaletteViewStateSubject, PKPaletteAdditionalOptionsViewDelegate, PKPaletteColorPickerViewDelegate, PKPaletteContentViewInputAssistantDelegate, PKPaletteFloatingKeyboardControllerDelegate, PKPalettePopoverUpdating, PKPaletteToolPickerViewDataSource, PKPaletteToolPickerViewDelegate, PKPaletteToolPreviewDelegate, PKPaletteUndoRedoViewDelegate, PKPaletteViewStateSubject, PKTextInputWindowFirstResponderControllerDelegate, UIPencilInteractionDelegate, UIPopoverPresentationControllerDelegate> {
...
@property (nonatomic, retain) UIView *floatingLabel;
...
- (void)showFloatingLabel:(id)arg1 atRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg2 edge:(unsigned long long)arg3 offset:(double)arg4;
