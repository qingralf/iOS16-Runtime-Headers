...
@interface PKTextInputInteraction : NSObject <PKTextInputCanvasControllerChangeObserver, PKTextInputCanvasControllerDelegate, PKTextInputContainerViewDelegate, PKTextInputCursorControllerDelegate, PKTextInputDebugStateReporting, PKTextInputDebugViewControllerDelegate, PKTextInputDrawingGestureRecognizerDelegate, PKTextInputElementsControllerDelegate, PKTextInputFeedbackControllerDelegate, PKTextInputHandwritingControllerDelegate, PKTextInputLanguageSelectionControllerObserver, PKTextInputPaletteControllerDelegate, PKTextInputReserveSpaceControllerDelegate, PKTextInputTouchDetectionGestureRecognizerDelegate, UIEditingOverlayInteractionWithView, UIInteraction> {
