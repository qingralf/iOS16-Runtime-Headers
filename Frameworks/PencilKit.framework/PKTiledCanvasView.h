...
@interface PKTiledCanvasView : UIView <PKControllerDelegate, PKDrawingGestureRecognizerDelegate, PKDrawingGestureTarget, PKShapeDrawingControllerDelegate> {
    ...
    struct { 
        ...
        unsigned int delegateSupportsWillBeginNewStrokeWithLocation : 1; 
...
- (void)_drawingBegan:(id)arg1 inputPoint:(struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; bool x9; long long x10; double x11; bool x12; })arg2 locationInView:(struct CGPoint { double x1; double x2; })arg3 forPreview:(bool)arg4 disableDetachedRendering:(bool)arg5;
- (id)_drawingController;
- (void)_drawingDisplay:(double)arg1;
- (void)_drawingEnded:(id)arg1;
...
- (void)_handleEndOfStroke:(id)arg1 groupedUndoCommands:(id)arg2 invalidateTiles:(bool)arg3;
- (id)_inkForNewStroke;
- (double)_inputScale;
...
- (void)_previewDrawingBegan:(struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; bool x9; long long x10; double x11; bool x12; })arg1 tiledViewLocation:(struct CGPoint { double x1; double x2; })arg2 disableDetachedRendering:(bool)arg3;
- (void)_previewDrawingEnded;
- (void)_previewDrawingMoved:(struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; bool x9; long long x10; double x11; bool x12; })arg1;
- (id)_rendererController;
- (struct CGSize { double x1; double x2; })_rendererControllerPixelSize;
- (void)_replayDrawingBegan:(struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; bool x9; long long x10; double x11; bool x12; })arg1;
- (void)_replayDrawingCancelled;
- (void)_replayDrawingEnded;
- (void)_replayDrawingMoved:(struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; bool x9; long long x10; double x11; bool x12; })arg1;
- (void)_setDrawing:(id)arg1 tiles:(id)arg2 image:(struct CGImage { }*)arg3 tileTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg4 setupComplete:(id /* block */)arg5 completionBlock:(id /* block */)arg6;
- (void)_setDrawing:(id)arg1 tiles:(id)arg2 tileTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg3 snapshotTexture:(id)arg4 snapshotTextureTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg5 setupComplete:(id /* block */)arg6 completionBlock:(id /* block */)arg7;
...
- (void)_updateMetalLayerOpacityIsDoingBitmapErase:(bool)arg1;
- (id)activeDrawing;
