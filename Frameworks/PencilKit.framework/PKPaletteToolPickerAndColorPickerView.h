...
@interface PKPaletteToolPickerAndColorPickerView : UIView <PKPaletteEdgeLocating, PKPalettePopoverDismissing, PKPaletteViewSizeScaling> {
    ...
    NSLayoutConstraint * _lassoToolEditingViewCompactHeightConstraint;
    NSLayoutConstraint * _lassoToolEditingViewCompactWidthConstraint;
    NSLayoutConstraint * _lassoToolEditingViewHeightConstraint;
    bool  _lassoToolEditingViewVisible;
    NSLayoutConstraint * _lassoToolEditingViewWidthConstraint;
...
@property (nonatomic, retain) NSLayoutConstraint *lassoToolEditingViewCompactHeightConstraint;
@property (nonatomic, retain) NSLayoutConstraint *lassoToolEditingViewCompactWidthConstraint;
@property (nonatomic, retain) NSLayoutConstraint *lassoToolEditingViewHeightConstraint;
@property (getter=isLassoToolEditingViewVisible, nonatomic) bool lassoToolEditingViewVisible;
@property (nonatomic, retain) NSLayoutConstraint *lassoToolEditingViewWidthConstraint;
...
- (id)lassoToolEditingViewCompactHeightConstraint;
- (id)lassoToolEditingViewCompactWidthConstraint;
- (id)lassoToolEditingViewHeightConstraint;
- (id)lassoToolEditingViewWidthConstraint;
...
- (void)setLassoToolEditingViewCompactHeightConstraint:(id)arg1;
- (void)setLassoToolEditingViewCompactWidthConstraint:(id)arg1;
- (void)setLassoToolEditingViewHeightConstraint:(id)arg1;
- (void)setLassoToolEditingViewVisible:(bool)arg1;
- (void)setLassoToolEditingViewWidthConstraint:(id)arg1;
