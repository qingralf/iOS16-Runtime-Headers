...
- (void)dealloc;
- (id)init;
- (void)replayCanvasViewDrawingMoved:(id)arg1 inputPoint:(struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; bool x9; long long x10; double x11; bool x12; })arg2;
