...
- (double)dynamicStep;
- (id)initWithTextureName:(id)arg1 textureImage:(struct CGImage { }*)arg2 maskTextureName:(id)arg3 maskTextureImage:(struct CGImage { }*)arg4 particleSpacing:(double)arg5 particleCount:(long long)arg6 particleSize:(struct CGSize { double x1; double x2; })arg7 particleRotation:(unsigned long long)arg8 maskScale:(double)arg9 maskMovement:(double)arg10 maskDepth:(double)arg11 initialRandomRotation:(bool)arg12 maskInitialRandomOffset:(bool)arg13 adjustEndCapParticleAlpha:(bool)arg14 particleBlendMode:(unsigned long long)arg15;
