...
@interface PKMetalRenderer : NSObject {
    ...
    /* Warning: unhandled struct encoding: '{vector<PKStroke *, std::allocator<PKStroke *>>="__begin_"^@"__end_"^@"__end_cap_"{__compressed_pair<PKStroke *__strong *, std::allocator<PKStroke *>>="__value_"^@}}' */ struct vector<PKStroke *, std::allocator<PKStroke *>> { 
        __end_ **__begin_; 
    }  _combinedStrokes;
    /* Warning: unhandled struct encoding: '{vector<PKStroke *, std::allocator<PKStroke *>>="__begin_"^@"__end_"^@"__end_cap_"{__compressed_pair<PKStroke *__strong *, std::allocator<PKStroke *>>="__value_"^@}}' */ struct vector<PKStroke *, std::allocator<PKStroke *>> { 
        __end_ **__begin_; 
    }  _combinedStrokesToAddWhenFrontStrokeFinishes;
