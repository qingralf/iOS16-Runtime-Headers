...
@interface PKTiledView : UIView <PKDrawableView, PKRulerDelegate, PKRulerHostingDelegate, PKTiledCanvasViewDelegate, UIDropInteractionDelegate_Private, UIGestureRecognizerDelegate, UIScrollViewDelegate, _UIEditMenuInteractionDelegate, _UIScrollViewLayoutObserver, _UIScrollViewScrollObserver> {
    ...
    _UIEditMenuInteraction * _editMenuInteraction;
    ...
    struct { 
        ...
        unsigned int delegateWillCreateSnapshot : 1; 
    }  _tiledViewFlags;
...
@property (nonatomic, readonly) _UIEditMenuInteraction *editMenuInteraction;
...
- (void)_editMenuInteraction:(id)arg1 didDismissMenuForConfiguration:(id)arg2;
- (void)_editMenuInteraction:(id)arg1 didPresentMenuForConfiguration:(id)arg2;
...
- (void)canvasViewWillBeginNewStroke:(id)arg1 location:(struct CGPoint { double x1; double x2; })arg2;
