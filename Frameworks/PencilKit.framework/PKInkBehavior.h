...
- (id)identifier;
- (id)initWithRenderingDescriptor:(id)arg1 blendAlpha:(double)arg2 targetMultiple:(double)arg3 baseAlpha:(double)arg4 inkTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg5 useUnclampedWeight:(bool)arg6 smoothingDescriptor:(id)arg7 featheringDescriptor:(id)arg8 pencilFeatheringDescriptor:(id)arg9 animationDescriptor:(id)arg10 identifier:(id)arg11 version:(unsigned long long)arg12 variant:(id)arg13 showBrushIndicator:(bool)arg14 rulerOffsetScale:(double)arg15 rulerOffsetConstant:(double)arg16 weightFunction:(id)arg17 inkFunctions:(id)arg18;
- (id)initWithRenderingDescriptor:(id)arg1 blendAlpha:(double)arg2 targetMultiple:(double)arg3 baseAlpha:(double)arg4 inkTransform:(struct CGAffineTransform { double x1; double x2; double x3; double x4; double x5; double x6; })arg5 useUnclampedWeight:(bool)arg6 smoothingDescriptor:(id)arg7 featheringDescriptor:(id)arg8 pencilFeatheringDescriptor:(id)arg9 animationDescriptor:(id)arg10 identifier:(id)arg11 version:(unsigned long long)arg12 variant:(id)arg13 showBrushIndicator:(bool)arg14 rulerOffsetScale:(double)arg15 rulerOffsetConstant:(double)arg16 weightFunction:(void*)arg17 radiusOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction {} *x1; struct PKOutputFunction {} *x2; struct __compressed_pair<PKOutputFunction *, std::allocator<PKOutputFunction>> { struct PKOutputFunction {} *x_3_1_1; } x3; })arg18 opacityOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction {} *x1; struct PKOutputFunction {} *x2; struct __compressed_pair<PKOutputFunction *, std::allocator<PKOutputFunction>> { struct PKOutputFunction {} *x_3_1_1; } x3; })arg19 edgeWidthOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction {} *x1; struct PKOutputFunction {} *x2; struct __compressed_pair<PKOutputFunction *, std::allocator<PKOutputFunction>> { struct PKOutputFunction {} *x_3_1_1; } x3; })arg20 aspectRatioOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction {} *x1; struct PKOutputFunction {} *x2; struct __compressed_pair<PKOutputFunction *, std::allocator<PKOutputFunction>> { struct PKOutputFunction {} *x_3_1_1; } x3; })arg21 brushOpacityOutput:(struct vector<PKOutputFunction, std::allocator<PKOutputFunction>> { struct PKOutputFunction {} *x1; struct PKOutputFunction {} *x2; struct __compressed_pair<PKOutputFunction *, std::allocator<PKOutputFunction>> { struct PKOutputFunction {} *x_3_1_1; } x3; })arg22;
