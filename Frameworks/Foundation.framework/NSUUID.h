...
@interface NSUUID : NSObject <AFSecurityDigestibleChunksProviding, ASDNotificationType, BSXPCSecureCoding, CRCoding, CRDataType, CREquatable, GCSJSONSerializable, HKUUIDProvider, HMBQueryableModelFieldCoder, HMDOPACKValue, HMFObject, MPCPlaybackEngineEventPayloadValueJSONConvertible, NSCopying, NSSecureCoding, PKDrawingUUID, PQLValuable, SASerializable, _PASDistilledString>
