...
@interface NSValue : NSObject <BSXPCSecureCoding, DebugHierarchyValue_Fallback, MTFilterIdentityValueProviding, MTMaterialSettingsPropertyIdentityValueProviding, NSCopying, NSSecureCoding, OZSCNValueJSExport, REDonatedActionIdentifierProviding, TSDMixing>
...
@property (readonly) struct { long long x1[2][2]; bool x2[2][2]; } integerByBandTransitionValue;
@property (readonly) struct { long long x1[2]; bool x2[2]; } integerByBandValue;
...
+ (id)avt_valueWithSCNVector3:(struct SCNVector3 { float x1; float x2; float x3; })arg1;
+ (id)avt_valueWithSCNVector3AsFloat3;
+ (id)avt_valueWithSCNVector4:(struct SCNVector4 { float x1; float x2; float x3; float x4; })arg1;
+ (id)avt_valueWithSCNVector4AsFloat4;
...
+ (id)valuewithIntegerByBand:(struct { long long x1[2]; bool x2[2]; })arg1;
+ (id)valuewithIntegerByBandTransition:(struct { long long x1[2][2]; bool x2[2][2]; })arg1;

- (struct { long long x1[2][2]; bool x2[2][2]; })integerByBandTransitionValue;
- (struct { long long x1[2]; bool x2[2]; })integerByBandValue;
