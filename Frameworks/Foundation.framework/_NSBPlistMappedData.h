...
- (const void*)bytes;
- (id)initWithBinaryPlistData:(const void*)arg1 size:(unsigned long long)arg2 trailer:(struct { unsigned char x1[5]; unsigned char x2; unsigned char x3; unsigned char x4; unsigned long long x5; unsigned long long x6; unsigned long long x7; })arg3 offset:(unsigned long long)arg4 marker:(unsigned char)arg5;
