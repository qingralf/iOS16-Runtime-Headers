...
@interface NSError : NSObject <AMSSecureCodingSanitizable, ARDictionaryCoding, BSDescriptionProviding, EFPubliclyDescribable, HMFObject, IMJSONSerializableValueProviding, IMMetricsDataSource, MPCPlaybackEngineEventPayloadValueJSONConvertible, MSPJournaled, NSCopying, NSSecureCoding, PQLValuable> {
    long long  _code;
    NSString * _domain;
    void * _reserved;
...
@property (getter=chipplugin_isCHIPError, readonly) bool chipplugin_chipError;
...
@property (nonatomic, readonly) bool sh_isMediaLibrarySyncFailed;
...
- (bool)sh_isMediaLibrarySyncFailed;
