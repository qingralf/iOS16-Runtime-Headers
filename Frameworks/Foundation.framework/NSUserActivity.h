...
@interface NSUserActivity : NSObject <CMSCoding, CRContent, INCacheableObject, INJSONSerializable, NSSecureCoding, REUserActivityProperties, UIItemProviderReading, UIItemProviderWriting> {
    id  _delegate;
...
@property (nonatomic, readonly) bool vui_isPlaybackActivity;
