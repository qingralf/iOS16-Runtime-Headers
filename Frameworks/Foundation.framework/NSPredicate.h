...
+ (id)predicateFromDateInterval:(id)arg1 withKeyPath:(id)arg2;

- (bool)_hasCompoundPredicateType:(unsigned long long)arg1;
- (id)constantValueForLeftExpression:(id)arg1;
- (id)constantValueForLeftKeyPath:(id)arg1;
- (bool)isAndPredicate;
- (bool)isOrPredicate;
- (id)keyPathsAndValues;
- (id)ppt_sqlPredicateForSelect;
- (id)predicateByRemovingSubPredicateWithLeftExpression:(id)arg1;
- (id)predicateByRemovingSubPredicateWithLeftKeyPath:(id)arg1;
- (id)subPredicateForLeftExpression:(id)arg1;
- (id)subPredicateForLeftKeyPath:(id)arg1;
- (id)subPredicatesWithLeftExpression:(id)arg1;
- (id)subPredicatesWithLeftKeyPath:(id)arg1;
