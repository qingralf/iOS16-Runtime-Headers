...
@interface NSString : NSObject <AADataType, AFSecurityDigestibleChunksProviding, APPCSupplementalContextAllowedTypes, ASDNotificationType, ASParsingLeafNode, ATXScoreLogSerializable, BMDSLNativeJSONArchiving, CKLParsedObject, CKRecordValue, CKShortDescription, CKVDatabaseValue, CLSGraphVertex, CMSCoding, CNKeyDescriptor_Private, CNUIURLDestinationID, CRCodable, CRCoding, CRDataType, CREquatable, CSCoderEncoder, CUByteCodable, ECEmailAddressConvertible, EFSQLBindable, EFSQLValueExpressable, FCKeyValueStoreCoding, GCSJSONObject, HAP2AccessoryCharacteristicEncodableBodyValue, HFPropertyListConvertible, HFStringGenerator, HMBQueryableModelFieldCoder, HMDOPACKValue, IMJSONSerializableValueProviding, INCodableAttributeRelationComparing, INJSONSerializable, ISCompositorResource, LNStaticDeferredLocalizedString, MAPropertyTypeProtocol, MPArtworkDataSourceVisualIdenticality, MPCPlaybackEngineEventPayloadJSONValue, MTMaterialSettingsPropertyIdentityValueProviding, NSCopying, NSItemProviderReading, NSItemProviderWriting, NSMutableCopying, NSSecureCoding, PKIdentifiable, PQLValuable, REContentEncodable, REDonatedActionIdentifierProviding, REMDAChangedIdentifierResult, SASerializable, SBFFileCacheFileIdentifier, SiriCoreSQLiteValue, TLIdentifiable, UIItemProviderReading, UIItemProviderWriting, VCControlChannelMessageProtocol, WFJSONObject, WFJavaScriptCoreBridgeableObject, WFNaming, WFPropertyListObject, WFSlotTemplateContent, WFVariableStringContent, _DKDeduping, _OSDeduping, _PASDistilledString, _UIMenuImageOrName>
...
@property (readonly) bool mf_isHorizontalSeparator;
...
@property (nonatomic, readonly) /* Warning: unhandled struct encoding: '{basic_string<char' */ struct  rtcStdString; /* unknown property attribute:  std::allocator<char>>={__rep=(?={__long=*QQ}{__short=[23c]{?=C}}{__raw=[3Q]})}}} */
...
@property (nonatomic, readonly) NSString *sf_stringByAddingSoftBreaksBeforePeriods;
...
- (void)_accessibilityEnumerateDelayedDescriptionsWithBlock:(id /* block */)arg1;
...
+ (id)cnaui_commaSeparatedRecipientListWithRecipientCount:(unsigned long long)arg1 prefixForRecipientAtIndex:(id /* block */)arg2 stringForRecipientAtIndex:(id /* block */)arg3 lengthValidationBlock:(id /* block */)arg4 shouldStripEllipses:(bool)arg5;
...
- (struct optional<std::string> { union { BOOL x_1_1_1; struct basic_string<char, std::char_traits<char>, std::allocator<char>> { struct __compressed_pair<std::basic_string<char>::__rep, std::allocator<char>> { struct __rep { union { struct __long { char *x_1_6_1; unsigned long long x_1_6_2; unsigned long long x_1_6_3; } x_1_5_1; struct __short { BOOL x_2_6_1[23]; struct { unsigned char x_2_7_1; } x_2_6_2; } x_1_5_2; struct __raw { unsigned long long x_3_6_1[3]; } x_1_5_3; } x_1_4_1; } x_1_3_1; } x_2_2_1; } x_1_1_2; } x1; bool x2; })ear_toStringOrNothing;
...
// Image: /System/Library/PrivateFrameworks/RemoteManagement.framework/Frameworks/RemoteManagementStore.framework/RemoteManagementStore
