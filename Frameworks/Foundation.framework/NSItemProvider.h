...
- (id)_px_registerFileRepresentationForTypeIdentifier:(id)arg1 visibility:(long long)arg2 fileProviderManager:(id)arg3 domain:(id)arg4 asset:(id)arg5 shouldRequestCurrentIfPossible:(bool)arg6 downscalingTargetDimension:(id)arg7;
- (id)_px_registerFileRepresentationsForAsset:(id)arg1 usage:(long long)arg2 fileProviderManager:(id)arg3 domain:(id)arg4 shouldRequestCurrentIfPossible:(bool)arg5 downscalingTargetDimension:(id)arg6;
...
- (id)px_registerFileRepresentationsForAsset:(id)arg1 usage:(long long)arg2 domain:(id)arg3 shouldRequestCurrentIfPossible:(bool)arg4 downscalingTargetDimension:(id)arg5;
