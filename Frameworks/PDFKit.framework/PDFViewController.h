...
- (void)_activateNearestAnnotationFromPage:(id)arg1 startPage:(id)arg2 previous:(bool)arg3 withCompletion:(id /* block */)arg4;
...
- (bool)_annotationIsValidTextFieldToActivate:(id)arg1;
...
- (void)activateNearestAnnotation:(bool)arg1 withCompletion:(id /* block */)arg2;
- (void)activateNextAnnotation:(bool)arg1;
- (void)activateNextAnnotation:(bool)arg1 withCompletion:(id /* block */)arg2;
- (id)activeAnnotation;
