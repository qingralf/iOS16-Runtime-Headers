...
- (id)fetchContentsForItemWithID:(id)arg1 version:(id)arg2 request:(id)arg3 extent:(id)arg4 alignment:(unsigned long long)arg5 options:(unsigned long long)arg6 shouldForwardVersion:(bool)arg7 completionHandler:(id /* block */)arg8;
