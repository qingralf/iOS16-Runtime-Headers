...
@interface RPScreenRecorder : NSObject <RPPreviewViewControllerDelegate, UINavigationControllerDelegate, UIPopoverPresentationControllerDelegate> {
    ...
    <RPScreenRecordeScreenCapureKitDelegate> * _screenCaptureKitDelegate;
...
@property (nonatomic, retain) <RPScreenRecordeScreenCapureKitDelegate> *screenCaptureKitDelegate;
