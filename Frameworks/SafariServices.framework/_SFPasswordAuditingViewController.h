...
@interface _SFPasswordAuditingViewController : _SFAccountTableViewController <ASAccountAuthenticationModificationControllerDelegate, ASAccountAuthenticationModificationControllerPresentationContextProviding, PSStateRestoration, SFAccountDetailViewControllerDelegate, SFActionableSecurityRecommendationDataDelegate, SFPasswordBreachToggleCellDelegate, _ASAccountAuthenticationModificationExtensionManagerObserver, _SFTableLinkableFooterViewDelegate, _SFTableViewDiffableDataSourceDelegate> {
