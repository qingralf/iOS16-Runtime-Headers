...
@interface _SFBrowserContentViewController : UIViewController <PKAddPassesViewControllerDelegate, SFAppSuggestionBannerDelegate, SFBrowserKeyCommandSafariViewControllerMethods, SFBrowserViewDelegate, SFOverlayProviderDelegate, SFReaderEnabledWebViewControllerDelegate, SFReaderViewControllerDelegate, UIGestureRecognizerDelegate, UIScrollViewDelegate, WBSDigitalHealthManagerDelegate, WBSFluidProgressControllerWindowDelegate, WBSFluidProgressStateSource, WBSTranslationConsentAlertHelperDelegate, WBSTranslationContextDelegate, WBSWebExtensionCommandHandling, WBSWebExtensionTab, _SFActivityItemCustomizationDelegate, _SFActivityViewControllerDelegate, _SFBarManagerDelegate, _SFBrowserContentController, _SFBrowserDocument, _SFDownloadDelegate, _SFDynamicBarAnimatorDelegate, _SFLinkPreviewHandler, _SFMailContentProviderDataSource, _SFNavigationBarDelegate, _SFPageLoadErrorControllerDelegate, _SFPrintControllerDelegate, _SFQuickLookDocumentSource, _SFSaveToFilesOperationDelegate, _SFSingleBookmarkNavigationControllerDelegate> {
...
- (bool)_showOverlayForResultIfNeeded:(id)arg1;
