...
- (void)addAttachmentWithName:(id)arg1 contentType:(id)arg2 URL:(id)arg3 toObjectWithIdentifier:(id)arg4 attachmentMetadata:(id)arg5 referenceMetadata:(id)arg6 completion:(id /* block */)arg7;
...
- (void)attachmentReferencesForObjectIdentifier:(id)arg1 completion:(id /* block */)arg2;
...
- (id)initWithHealthStore:(id)arg1 schemaProviderIdentifier:(id)arg2;
- (id)proxyProvider;
- (id)remoteInterface;
- (void)removeAttachment:(id)arg1 fromObject:(id)arg2 completion:(id /* block */)arg3;
- (void)removeReference:(id)arg1 completion:(id /* block */)arg2;
- (id)streamDataForAttachment:(id)arg1 dataHandler:(id /* block */)arg2;

// Image: /usr/lib/swift/libswiftHealthKit.dylib

- (void)_getDataChunkForAttachment:(id)arg1 chunkSize:(unsigned long long)arg2 offset:(unsigned long long)arg3 completion:(id /* block */)arg4;
