...
- (id)initWithUserString:(id)arg1 currentSuggestion:(id)arg2 displayString:(id)arg3 attributeValues:(id)arg4 bundleIdentifiers:(id)arg5;
...
- (id)initWithUserString:(id)arg1 previousSuggestionTokens:(id)arg2 displayString:(id)arg3 attributeValues:(id)arg4 bundleIdentifiers:(id)arg5 enableFragements:(bool)arg6;
