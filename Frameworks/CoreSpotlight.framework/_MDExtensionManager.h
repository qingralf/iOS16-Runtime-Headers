...
@property (nonatomic, retain) id fileProviderMonitorToken;
...
@property (nonatomic, retain) NSDictionary *providerDomainsByID;
...
- (id)fileProviderMonitorToken;
- (void)findExtensionsWithCompletionBlock:(id /* block */)arg1;
- (id)getProviderIDFromFileProvider:(id)arg1;
