...
@interface NSDictionary : NSObject <AADataType, AFSecurityDigestibleChunksProviding, AMSHashable, AMSSecureCodingSanitizable, APPCSupplementalContextAllowedTypes, ASDNotificationType, ATXScoreLogSerializable, CARMutableDeepCopying, CCChartDataRow, CKLParsedObject, CMSCoding, CRKJSONRepresentable, CSCoderEncoder, CUByteCodable, FPAuxDataType, GCSJSONObject, GCSJSONSerializable, HFPropertyListConvertible, HMDOPACKValue, HMFObject, IMJSONSerializableValueProviding, INJSONSerializable, InnerContentHash, MPCPlaybackEngineEventPayloadJSONValue, MPCSupportedCommands, NNSyncableHeadline, NNSyncableResult, NNSyncableSection, NSCopying, NSFastEnumeration, NSFetchRequestResult, NSMutableCopying, NSSecureCoding, PBFPosterSnapshotProviding, PHFetchDictionaryAccessing, PQLBindable, REDonatedActionIdentifierProviding, TSPResourceLocalStrategyProvider, WFJSONObject, WFJavaScriptCoreBridgeableObject, WFPropertyListObject, WFSerializableContent>
...
- (unsigned long long)getCHIPAttributeId;
- (unsigned long long)getCHIPClusterId;
- (id)getCHIPCommandFields;
- (unsigned long long)getCHIPCommandId;
- (id)getCHIPData;
- (unsigned long long)getCHIPEndpointId;
- (unsigned long long)getCHIPMaxInterval;
- (unsigned long long)getCHIPMinInterval;
- (id)getCHIPRemoteCommand;
- (id)getCHIPRemoteResults;
- (long long)getCHIPStatus;
