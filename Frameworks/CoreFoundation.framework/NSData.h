...
@interface NSData : NSObject <AFContextSnapshot, AFSecurityDigestibleChunksProviding, ASDNotificationType, ASParsingLeafNode, CKLParsedObject, CKPropertiesDescription, CKRecordValue, CKVDatabaseValue, CRCoding, CRDataType, CREquatable, CUByteCodable, EFSQLBindable, FCKeyValueStoreCoding, GTVMBufferSubRegion, HAP2AccessoryCharacteristicEncodableBodyValue, HAP2AccessoryCharacteristicEncodedData, HFPropertyListConvertible, HKUUIDCollection, HMBQueryableModelFieldCoder, HMDOPACKValue, HMFObject, IMJSONSerializableValueProviding, INJSONSerializable, MPCPlaybackEngineEventPayloadValueJSONConvertible, NSCopying, NSMutableCopying, NSSecureCoding, PQLValuable, REDonatedActionIdentifierProviding, SiriCoreSQLiteValue, TSPSplitableData, VCControlChannelMessageProtocol, WFActionReversalState, WFPropertyListObject, _PASDistilledString>
