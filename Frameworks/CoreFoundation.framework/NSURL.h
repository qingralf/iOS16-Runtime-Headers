...
@property (nonatomic, readonly) NSString *mailToFromQueryItem;
...
- (id)_fp_scanForURLOfChildWithName:(id)arg1 isFolder:(bool)arg2 notMatchingFileID:(id)arg3 maximumBounceNumber:(id*)arg4;
...
- (id)fp_existingURLOfChildWithName:(id)arg1 isFolder:(bool)arg2 notMatchingFileID:(id)arg3 maximumBounceNumber:(id*)arg4 forceFetchingBounceNumber:(bool)arg5;
- (id)fp_fpfsRootURL;
...
- (void)pbf_setExcludedFromBackup:(bool)arg1 error:(out id*)arg2;
