...
- (id)setCHIPCommandFields:(id)arg1;
- (id)setCHIPData:(id)arg1;
- (id)setCHIPEndpointId:(unsigned long long)arg1 clusterId:(unsigned long long)arg2 attributeId:(unsigned long long)arg3;
- (id)setCHIPEndpointId:(unsigned long long)arg1 clusterId:(unsigned long long)arg2 commandId:(unsigned long long)arg3;
- (id)setCHIPMaxInterval:(unsigned long long)arg1;
- (id)setCHIPMinInterval:(unsigned long long)arg1;
- (id)setCHIPRemoteCommand:(id)arg1;
- (id)setCHIPRemoteResults:(id)arg1;
- (id)setCHIPStatus:(long long)arg1;
