...
@property (nonatomic, readonly) bool hkmc_triggerSharingNotificationsImmediately;
...
- (bool)hkmc_triggerSharingNotificationsImmediately;
...
+ (bool)bannersEnabled;
+ (bool)jindoDisableTapToApp;
+ (bool)jindoUseIconOnlyLayoutInCompact;
+ (bool)linkEnabled;
