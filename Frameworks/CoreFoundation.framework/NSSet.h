...
@interface NSSet : NSObject <EFSQLValueCollectionExpressable, HKUUIDCollection, HMFObject, InnerContentHash, NSCopying, NSFastEnumeration, NSMutableCopying, NSSecureCoding, PQLBindable, PXFastEnumeration, _SetOperable>
