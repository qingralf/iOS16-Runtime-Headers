...
@interface NSArray : NSObject <AADataType, AFSecurityDigestibleChunksProviding, AMSHashable, AMSSecureCodingSanitizable, APPCSupplementalContextAllowedTypes, ASDNotificationType, ATXScoreLogSerializable, CARMutableDeepCopying, CKLParsedObject, CKRecordValue, CLSCurationDebugItemCluster, CMSCoding, CRCodable, CRKJSONRepresentable, CSCoderEncoder, CUByteCodable, EFSQLValueCollectionExpressable, FCContentArchivable, FCOrderedCollectionAdditions, GCSJSONObject, HFPropertyListConvertible, HKCodedObject, HKFeatureAvailabilityRequirementsProviding, HKUUIDCollection, HMDOPACKValue, HMFObject, HVHeaderCollection, IMJSONSerializableValueProviding, INCacheableContainer, INCodableAttributeRelationComparing, INImageProxyInjecting, INIntentResolutionResultDataProviding, INJSONSerializable, INKeyImageProducing, ISStackedCompositorResource, InnerContentHash, MPCPlaybackEngineEventPayloadJSONValue, NSCoding, NSCopying, NSFastEnumeration, NSMutableCopying, NSObject, NSSecureCoding, PQLBindable, PXSectionedFetchResult, REDonatedActionIdentifierProviding, WFJSONObject, WFJavaScriptCoreBridgeableObject, WFPropertyListObject, _EFOrderedCollection>
