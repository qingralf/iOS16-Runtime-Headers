...
- (void)deregisterReportHandlersWithController:(id)arg1 nodeId:(unsigned long long)arg2 completion:(id /* block */)arg3;
...
- (void)registerReportHandlerWithController:(id)arg1 nodeId:(unsigned long long)arg2 handler:(id /* block */)arg3;
