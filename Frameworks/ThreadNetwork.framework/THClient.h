...
- (void)ctcsAddPreferredNetworkWithCompletion:(id)arg1 extendedPANId:(id)arg2 borderAgentID:(id)arg3 completion:(id /* block */)arg4;
- (void)ctcsCleanPreferredAndBlaclistedThreadNetworksWithCompletion:(id /* block */)arg1;
