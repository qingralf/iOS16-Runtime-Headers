...
- (void)generateThumbnailOfSize:(struct CGSize { double x1; double x2; })arg1 minimumSize:(double)arg2 scale:(double)arg3 badgeType:(unsigned long long)arg4 iconFlavor:(int)arg5 contentType:(id)arg6 interpolationQuality:(int)arg7 withContents:(id)arg8 additionalResourcesWrapper:(id)arg9 generatorData:(id)arg10 completionHandler:(id /* block */)arg11;
- (void)generateThumbnailOfSize:(struct CGSize { double x1; double x2; })arg1 minimumSize:(double)arg2 scale:(double)arg3 badgeType:(unsigned long long)arg4 iconFlavor:(int)arg5 contentType:(id)arg6 interpolationQuality:(int)arg7 withFileURLHandler:(id)arg8 additionalResourcesWrapper:(id)arg9 generatorData:(id)arg10 completionHandler:(id /* block */)arg11;
