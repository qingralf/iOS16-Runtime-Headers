...
- (id)generationData;
- (int)iconFlavor;
- (id)initWithMaximumSize:(struct CGSize { double x1; double x2; })arg1 minimumSize:(double)arg2 scale:(double)arg3 badgeType:(unsigned long long)arg4 iconFlavor:(int)arg5 contentType:(id)arg6 fileURL:(id)arg7 generationData:(id)arg8 interpolationQuality:(int)arg9;
