...
@interface PHPickerViewController : UIViewController <_PUPickerExtensionContextHostInterface, _PUPickerUnavailableViewControllerDelegate, _UIAppearanceRestriction, _UIRemoteViewControllerContaining> {
    ...
    id  __overlayStorage;
    bool  __providedCustomPreferredContentSize;
...
@property (setter=_setProvidedCustomPreferredContentSize:, nonatomic) bool _providedCustomPreferredContentSize;
...
- (void)_setProvidedCustomPreferredContentSize:(bool)arg1;
