...
@interface EKEventEditViewController : UINavigationController <EKCalendarItemEditorDelegate, EKUIManagedViewController, UIAdaptivePresentationControllerDelegate> {
