...
+ (id)_createCalendarsMenuForEvents:(id)arg1 presentationController:(id)arg2 isEditMenu:(bool)arg3 overrideActionBlock:(id /* block */)arg4;
...
+ (id)menuForEvents:(id)arg1 presentationController:(id)arg2 isEditMenu:(bool)arg3 overrideActionBlock:(id /* block */)arg4;
