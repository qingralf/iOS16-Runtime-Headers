...
@interface EKDayViewController : UIViewController <BlockableScrollViewDelegate, EKDayOccurrenceViewDelegate, EKDayViewDataSource, EKDayViewDelegate, EKEventGestureControllerDelegate, EKUIPasteboardManagerCutDelegate, EKUIPasteboardManagerPasteDelegate, EKUIRightClickEmptySpaceInteractionDelegate, UIScrollViewDelegate> {
