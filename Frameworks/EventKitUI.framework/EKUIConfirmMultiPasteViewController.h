...
@interface EKUIConfirmMultiPasteViewController : UIViewController <EKUIPasteboardManagerPasteDelegate, UIAdaptivePresentationControllerDelegate, UITableViewDataSource, UITableViewDelegate> {
...
- (void)pasteboardManager:(id)arg1 didFinishPasteWithResult:(unsigned long long)arg2;
