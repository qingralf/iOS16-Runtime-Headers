...
@interface EKDayOccurrenceView : UIView <EKDayOccurrenceTravelTimeViewMetricsDelegate, NSCopying, UIEditMenuInteractionDelegate, UIPointerInteractionDelegate> {
    bool  _allDay;
