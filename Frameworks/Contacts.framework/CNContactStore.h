...
@interface CNContactStore : NSObject <CHContactDataSource, CNKContactProvider, EFLoggable, IMAssistantContactsDataSource, TUContactProvider, TUContactsDataSource, TUConversationContactProvider, TUHandleContactProvider> {
