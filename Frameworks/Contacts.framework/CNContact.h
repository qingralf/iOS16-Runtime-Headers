...
@interface CNContact : NSObject <ABSCNLegacyIdentifiable, CKVocabularyItem, CNContactAugmentation, CNSuggested, NSCopying, NSItemProviderReading, NSItemProviderWriting, NSMutableCopying, NSSecureCoding, PXFaceTileImageCombinerItem, TUSearchResult> {
