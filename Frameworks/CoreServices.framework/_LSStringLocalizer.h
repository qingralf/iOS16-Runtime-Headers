...
+ (void)gatherLocalizedStringsForCFBundle:(struct __CFBundle { }*)arg1 infoDictionary:(id)arg2 domains:(unsigned int)arg3;
+ (void)gatherLocalizedStringsForCFBundle:(struct __CFBundle { }*)arg1 infoDictionary:(id)arg2 domains:(unsigned int)arg3 delegatesMightBeMainBundle:(bool)arg4;
...
- (id)initWithBundleURL:(id)arg1 stringsFile:(id)arg2 checkMainBundle:(bool)arg3;
