...
- (void)performPostInstallationRegistration:(id)arg1 operationUUID:(id)arg2 reply:(id /* block */)arg3;
- (void)performPostUninstallationUnregistrationOfBundleID:(id)arg1 operationUUID:(id)arg2 unregisterType:(unsigned int)arg3 reply:(id /* block */)arg4;
