...
@property (nonatomic, retain) CKDSStorage *atomBatchStorage;
...
@property (nonatomic, retain) CKMergeableDeltaMetadata *metadata;
...
+ (unsigned long long)maxInlineDeltaSizeForContainer:(id)arg1;
