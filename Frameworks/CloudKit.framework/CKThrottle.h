...
@property (nonatomic, retain) NSNumber *currentRequestWindowIndex;
...
@property (nonatomic, retain) NSNumber *sentRequestCount;
@property (nonatomic, copy) NSString *serviceName;
@property (nonatomic, copy) NSNumber *throttleID;
