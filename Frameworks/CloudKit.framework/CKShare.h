...
- (void)_ingestAndExportPPPCSFromShareInvitationToken:(id)arg1 container:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)_prepPCSDataUsingPreDecryptedPCSOnlyWithContainer:(id)arg1 databaseScope:(long long)arg2;
- (void)_prepPCSDataWithContainer:(id)arg1 databaseScope:(long long)arg2 publicSharingKey:(id)arg3 removeServerSpecifiedKeys:(bool)arg4 containerID:(id)arg5 completionHandler:(id /* block */)arg6;
- (void)_prepPCSDataWithContainer:(id)arg1 databaseScope:(long long)arg2 publicSharingKey:(id)arg3 removeServerSpecifiedKeys:(bool)arg4 containerID:(id)arg5 sharedRecordZone:(id)arg6 completionHandler:(id /* block */)arg7;
