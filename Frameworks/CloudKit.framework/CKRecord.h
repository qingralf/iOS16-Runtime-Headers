...
@interface CKRecord : NSObject <CKContainerAssignment, CKPropertiesDescription, HMBModelObjectStorage, ICHasDatabaseScope, NSCopying, NSSecureCoding, PQLBindable, PQLValuable> {
