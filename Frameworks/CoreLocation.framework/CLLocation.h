...
@interface CLLocation : NSObject <BMStoreData, CKRecordValue, HMBModelObjectStorage, HMFObject, INJSONSerializable, NSCopying, NSSecureCoding> {
    id  _internal;
}
...
+ (id)archiveLocation:(id)arg1;
+ (id)eventWithData:(id)arg1 dataVersion:(unsigned int)arg2;
+ (id)unarchiveLocationData:(id)arg1;
