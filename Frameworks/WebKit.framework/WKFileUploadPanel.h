...
@interface WKFileUploadPanel : UIViewController <UIAdaptivePresentationControllerDelegate, UIContextMenuInteractionDelegate, UIDocumentPickerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate> {
