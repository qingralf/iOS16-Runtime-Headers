...
@interface _MKPlaceViewController : MKLayoutCardViewController <GEOLogContextDelegate, MKETAProviderDelegate, MKETAProviderObserver, MKPlaceCardActionControllerDelegate, MKPlaceCardHeaderViewControllerDelegate, MKPlaceCardPhotosControllerDelegate, MKPlaceHeaderButtonsViewControllerDelegate, MKStackingViewControllerDelegate, _MKInfoCardAnalyticsDelegate, _MKPlaceCardConforming> {
