...
@property (nonatomic) /* Warning: unhandled struct encoding: '{shared_ptr<std::map<std::string' */ struct  relationshipValidationProperties; /* unknown property attribute:  mlcore::ModelPropertyBase *>>=^v^{__shared_weak_count}} */
...
- (struct shared_ptr<std::map<std::string, mlcore::ModelPropertyBase *>> { void *x1; struct __shared_weak_count {} *x2; })relationshipValidationProperties;
- (void)setForeignPropertyBase:(void*)arg1;
- (void)setRelationshipModelClass:(Class)arg1;
- (void)setRelationshipValidationProperties:(struct shared_ptr<std::map<std::string, mlcore::ModelPropertyBase *>> { void *x1; struct __shared_weak_count {} *x2; })arg1;
