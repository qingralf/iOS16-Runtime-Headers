...
@property (nonatomic, readonly) struct shared_ptr<std::vector<std::shared_ptr<mlcore::Entity>>> { void *x1; struct __shared_weak_count {} *x2; } itemIdentifierQueryResults;
...
- (id)initWithRequest:(id)arg1 itemQueryResults:(struct shared_ptr<mlcore::EntityQueryResult> { struct EntityQueryResult {} *x1; struct __shared_weak_count {} *x2; })arg2 itemIdentifierQueryResults:(struct shared_ptr<std::vector<std::shared_ptr<mlcore::Entity>>> { void *x1; struct __shared_weak_count {} *x2; })arg3;
- (id)itemAtIndexPath:(id)arg1;
- (struct shared_ptr<std::vector<std::shared_ptr<mlcore::Entity>>> { void *x1; struct __shared_weak_count {} *x2; })itemIdentifierQueryResults;
