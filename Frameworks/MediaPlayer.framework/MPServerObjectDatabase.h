...
- (id)_modelObjectMatchingIdentifierSet:(id)arg1 propertySet:(id)arg2;
...
- (id)modelGenericObjectFromObject:(id)arg1 playbackAuthorizationToken:(id)arg2;
- (id)modelObjectMatchingIdentifierSet:(id)arg1 propertySet:(id)arg2;
- (id)modelObjectMatchingIdentifierSet:(id)arg1 propertySet:(id)arg2 trustID:(id)arg3;
