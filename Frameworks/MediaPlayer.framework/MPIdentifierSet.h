...
@interface MPIdentifierSet : NSObject <MPCPlaybackEngineEventPayloadValueJSONConvertible, MPMutableIdentifierSet, MPMutableLocalLibraryIdentifiers, MPMutablePersonalStoreIdentifiers, MPMutableRadioIdentifiers, MPMutableUniversalStoreIdentifiers, NSCopying, NSSecureCoding> {
    long long  _adamID;
