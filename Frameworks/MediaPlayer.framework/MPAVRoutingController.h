...
+ (void)_getActiveRouteWithTimeout:(double)arg1 type:(long long)arg2 discoveredRoutes:(id)arg3 completion:(id /* block */)arg4;
+ (id)_iconImageForIdentifier:(id)arg1;
+ (id)_iconImageForRoutes:(id)arg1;
+ (id)_iconImageNameForClusterRoute:(id)arg1 isSymbol:(bool)arg2;
+ (id)_iconNameForRoute:(id)arg1;
+ (id)_iconNameForRoute:(id)arg1 isSymbol:(bool)arg2;
+ (id)_iconNameForRoutes:(id)arg1 isSymbol:(bool)arg2;
