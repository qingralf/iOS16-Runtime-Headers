...
@interface AVBorealisServer : NSObject <NSXPCListenerDelegate, VoiceTriggerInterface> {
    ...
    struct BorealisServerImpl { int (**x1)(); unsigned int x2; struct HALListener {} *x3; struct HALListener {} *x4; struct HALListener {} *x5; int x6; char *x7; bool x8; bool x9; bool x10; bool x11; bool x12; id x13; id x14; int x15; struct unfair_recursive_lock {} *x16; id x17; bool x18; bool x19; unsigned int x20; } * serverImpl;
}
