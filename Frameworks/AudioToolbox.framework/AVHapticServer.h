...
- (void)decrementRunningCountAndStopAudio:(bool)arg1 stopHaptics:(bool)arg2 clientID:(unsigned long long)arg3 category:(int)arg4;
...
- (void)incrementRunningCountForAudio:(bool)arg1 haptics:(bool)arg2 clientID:(unsigned long long)arg3 category:(int)arg4;
- (id)init;
