...
- (void)downloadIdentifierDidFinish:(id)arg1 clientStagedURL:(id)arg2 sandboxExtensionToken:(id)arg3 wasHandled:(id /* block */)arg4;
...
- (void)performWithExclusiveControlBeforeDate:(id)arg1 completion:(id /* block */)arg2;
