...
+ (id)collectionViewLayoutWithFloatingHeaderViews:(bool)arg1 contactListStyleApplier:(id)arg2 trailingSwipeActionsProvider:(id /* block */)arg3 shouldDisplaySupplementaryHeaderItemForSection:(id /* block */)arg4 shouldShowSeparatorsForSection:(id /* block */)arg5 directionalLayoutMargins:(id /* block */)arg6 collectionViewIsShowingIndexBar:(id /* block */)arg7 numberOfItemsInSection:(id /* block */)arg8;
+ (id)descriptorForRequiredKeysForPreferredForNameMeContact;
+ (id)emptyContact;
+ (id)layoutSectionForLayoutConfiguration:(id)arg1 layoutEnvironment:(id)arg2 section:(long long)arg3 contactListStyleApplier:(id)arg4 shouldDisplaySupplementaryHeaderItemForSection:(id /* block */)arg5 headerViewsFloat:(bool)arg6 directionalLayoutMargins:(id /* block */)arg7 collectionViewIsShowingIndexBar:(id /* block */)arg8;
...
- (void)willPerformDuplicatesMerge:(id)arg1;
