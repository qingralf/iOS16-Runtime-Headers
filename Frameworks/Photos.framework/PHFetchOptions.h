...
- (bool)includeNotUploadedSmartAlbum;
...
- (void)setIncludeCinematicVideoSmartAlbum:(bool)arg1;
...
- (void)setIncludeNotUploadedSmartAlbum:(bool)arg1;
...
- (void)setIncludeSharedLibrarySmartAlbum:(bool)arg1;
