...
- (id)initWithLibraryScopeIdentifier:(id)arg1 filterContactIDs:(id)arg2 homeLocations:(id)arg3 frequentLocations:(id)arg4;
- (id)initWithLibraryScopeIdentifier:(id)arg1 filterContactIDs:(id)arg2 homeLocations:(id)arg3 isOnTrip:(bool)arg4;
- (id)initWithLibraryScopeIdentifier:(id)arg1 identities:(id)arg2 homeLocations:(id)arg3 frequentLocations:(id)arg4;
