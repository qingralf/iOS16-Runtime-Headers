...
@property (nonatomic, retain) NSNumber *customMaximumNumberOfUserCuratedAssets;
...
- (id)customMaximumNumberOfUserCuratedAssets;
...
- (void)setCustomMaximumNumberOfUserCuratedAssets:(id)arg1;
