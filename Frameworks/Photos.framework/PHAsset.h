...
@interface PHAsset : PHObject <CLSInvestigationItem, CLSPHAssetSupportProtocol, CLSPHAssetUserBehaviorProtocol, PEAsset, PFParallaxAsset, PGShareBackSuggesterInputProtocol, PHResourceChooserAsset, PHThumbnailAsset, PUEditableAsset, PVAssetProtocol, PXDisplayAsset, PXLayoutItemInput, PXMetadataAsset, PXMetadataDetailsContentItem, PXPlacesGeotaggable, PXShareable, PXStoryDisplayAssetResource, _PLImageLoadingAsset> {
...
+ (bool)_isLivePhotoWithPhotoIris:(bool)arg1 hasAdjustments:(bool)arg2 videoCpDuration:(long long)arg3 videoCPVisibility:(unsigned short)arg4 sourceType:(unsigned long long)arg5 deferredProcessingNeeded:(unsigned short)arg6;
...
- (id)_computeCropVariantsWithConfigs:(id)arg1 forAspectRatio:(double)arg2;
...
- (void)_crop:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; }*)arg1 score:(double*)arg2 withZoom:(double)arg3 cropConfig:(id)arg4 aspectRatio:(double)arg5;
- (id)_cropVariantForConfig:(long long)arg1 aspectRatio:(double)arg2;
- (id)_filterCropVariants:(id)arg1;
- (id)_generateCropCandidates;
- (id)_getScaledCropForCropConfig:(id)arg1 aspectRatio:(double)arg2 withCropType:(long long)arg3;
- (id)_imageRequestOptionsForBaseVersion:(long long)arg1 options:(id)arg2 progressEstimateForImageProgress:(id /* block */)arg3;
- (id)_rankCropVariants:(id)arg1;
...
- (id)cropVariants;
- (id)cropVariantsForAspectRatio:(double)arg1;
...
- (id)pl_uuid;
- (bool)prepareWithAlternateJunkingHeuristicsWithContext:(id)arg1 curationContext:(id)arg2;
...
+ (struct CGSize { double x1; double x2; })wk_maximumImageSize;
