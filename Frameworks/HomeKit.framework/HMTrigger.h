...
@interface HMTrigger : NSObject <HFHomeKitObject, HFStateDumpBuildable, HFTriggerProtocol, HMFLogging, HMFMessageReceiver, HMObjectMerge, NSSecureCoding> {
...
- (void)_updateName:(id)arg1 configuredName:(id)arg2 completionHandler:(id /* block */)arg3;
