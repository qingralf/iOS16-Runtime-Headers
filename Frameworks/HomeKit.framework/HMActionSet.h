...
@interface HMActionSet : NSObject <HFFavoritable, HFHomeKitObject, HFIncludedContextProtocol, HFReorderableHomeKitObject, HFShowInHomeDashboard, HFStateDumpBuildable, HMFMessageReceiver, HMMutableApplicationData, HMObjectMerge, NSSecureCoding> {
