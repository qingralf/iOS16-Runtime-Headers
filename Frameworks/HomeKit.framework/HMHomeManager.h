...
@interface HMHomeManager : NSObject <HFStateDumpBuildable, HMAccessoryInfoDataProviderDataSource, HMAccessoryInfoDataProviderFactory, HMAccessorySettingsControllerDataSource, HMAccessorySettingsControllerFactory, HMAccessorySettingsDataSourceDataSource, HMAccessorySettingsDataSourceFactory, HMAccessorySettingsMessengerFactory, HMAccessorySettingsMetricsDispatcherFactory, HMApplicationData, HMCoreAnalyticsMetricEventDispatcherFactory, HMFLogging, HMFMessageReceiver, HMFTimerDelegate, HMMutableApplicationData, HMUserActionPredictionProviderDataSource> {
...
- (void)__mergeCurrentHomesWithNewHomes:(id)arg1 newPrimaryHome:(id)arg2 newCurrentHome:(id)arg3 newInvitations:(id)arg4 newAppData:(id)arg5 refreshRequested:(bool)arg6;
- (void)__preconfigure;
...
- (void)_mergeCurrentAppDataWithNewAppData:(id)arg1;
- (void)_mergeCurrentHomeInvitationsWithNewHomeInvitations:(id)arg1;
...
- (id)initWithUUID:(id)arg1 homeMangerConfiguration:(id)arg2 context:(id)arg3 xpcEventRouterClient:(id)arg4 lastEventStore:(id)arg5 timerFactory:(id /* block */)arg6 darwinNotificationProvider:(id)arg7;
- (id)initWithUUID:(id)arg1 homeMangerConfiguration:(id)arg2 context:(id)arg3 xpcEventRouterClient:(id)arg4 timerFactory:(id /* block */)arg5 darwinNotificationProvider:(id)arg6;
