...
@interface HMMediaSystem : NSObject <HFAccessoryLikeObjectRootHomeKitObjectProvider, HFAccessoryLikeObjectVendor, HFAccessoryRepresentable, HFHomeKitObject, HFIncludedContextProtocol, HFMediaProfileContainer, HFServiceNameComponentsProviding, HMAccessorySettingsAdapterDelegate, HMAccessorySettingsContainer, HMAccessorySettingsContainerInternal, HMApplicationData, HMControllable, HMFLogging, HMFMessageReceiver, HMMediaDestination, HMMediaDestinationInternal, HMMediaObject, HMObjectMerge, HRERecommendableObjectProtocol, NSSecureCoding, _COHomeKitNamedEntity> {
...
- (bool)_mergeWithNewObject:(id)arg1 isFromSerializedData:(bool)arg2;
