...
@interface HMRoom : NSObject <HFAccessoryLikeObjectContainer, HFDemoModeAccessoryContainer, HFHomeKitObject, HFReorderableHomeKitObject, HFStateDumpBuildable, HFWallaperHost, HMMutableApplicationData, HMObjectMerge, NSSecureCoding, _COHomeKitNamedEntity> {
