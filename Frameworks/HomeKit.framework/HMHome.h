...
@interface HMHome : NSObject <HFAccessoryLikeObjectContainer, HFCharacteristicValueReader, HFCharacteristicValueWriter, HFDemoModeAccessoryContainer, HFHomeKitObject, HFReorderableHomeKitObject, HFStateDumpBuildable, HFWallaperHost, HMFLogging, HMFMessageReceiver, HMMediaGroupSettingsControllerDataSource, HMMediaGroupsControllerDataSource, HMMutableApplicationData, HMObjectMerge, HMSiriEndpointProfilesMessengerFactory, NSSecureCoding, _COHomeKitNamedEntity> {
    bool  _adminUser;
    HMApplicationData * _applicationData;
    NSString * _assistantIdentifier;
    HMMediaGroupsController * _audioGroupsController;
    ...
    HMMutableArray * _stagedMediaSystems;
...
@property (retain) HMMediaGroupsController *audioGroupsController;
...
- (void)_handleMediaSystemRemovedMessage:(id)arg1;
...
- (unsigned long long)_mergeCurrentHomeAccessoriesWithNewHomeAccessories:(id)arg1;
- (unsigned long long)_mergeCurrentHomeAccessoryNetworkProtectionGroupsWithNewAccessoryNetworkProtectionGroups:(id)arg1;
- (unsigned long long)_mergeCurrentHomeActionSetsWithNewHomeActionSets:(id)arg1;
- (unsigned long long)_mergeCurrentHomeAudioGroupsControllerWithNewHome:(id)arg1;
- (unsigned long long)_mergeCurrentHomeInvitationsWithNewHomeInvitations:(id)arg1;
- (unsigned long long)_mergeCurrentHomeMediaSystemsWithNewMediaSystems:(id)arg1;
- (unsigned long long)_mergeCurrentHomeResidentDevicesWithNewHomeResidentDevices:(id)arg1;
- (unsigned long long)_mergeCurrentHomeRoomsWithNewHomeRooms:(id)arg1;
- (unsigned long long)_mergeCurrentHomeServiceGroupsWithNewHomeServiceGroups:(id)arg1;
- (unsigned long long)_mergeCurrentHomeTriggerOwnedActionSetsWithNewHomeActionSets:(id)arg1;
- (unsigned long long)_mergeCurrentHomeTriggersWithNewHomeTriggers:(id)arg1;
- (unsigned long long)_mergeCurrentHomeUsersWithNewHomeUsers:(id)arg1;
- (unsigned long long)_mergeCurrentHomeZonesWithNewHomeZones:(id)arg1;
- (unsigned long long)_mergeIsFeatureHomeTheaterQFAEnabled:(id)arg1;
...
- (id /* block */)_removeMediaSystemRequestResponseHandlerWithMediaSystem:(id)arg1 context:(id)arg2 messageIdentifier:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (id)audioGroupsController;
- (id)availableDestinationsForMediaGroupsController:(id)arg1;
...
- (id /* block */)legacyRemoveMediaSystemRequestResponseHandlerWithMessageIdentifier:(id)arg1 context:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (id)mediaGroupsController:(id)arg1 internalDestinationWithIdentifier:(id)arg2;
- (id)mediaPassword;
...
- (void)setAudioGroupsController:(id)arg1;
...
- (void)stageMediaSystem:(id)arg1;
- (void)stageRemovedMediaSystemUUID:(id)arg1;
- (id)stagedMediaSystems;
...
- (void)unstageMediaSystems:(id)arg1;
- (void)unstageRemovedMediaSystemUUID:(id)arg1;
- (void)unstageRemovedMediaSystemsUsingCurrentMediaSystems:(id)arg1;
...
- (id)updateTargetIdentierFromGroupDestinationIdentifiers:(id)arg1;
