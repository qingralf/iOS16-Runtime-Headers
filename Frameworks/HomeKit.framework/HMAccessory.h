...
@interface HMAccessory : NSObject <HFAccessoryLikeObjectContainer, HFAccessoryLikeObjectRootHomeKitObjectProvider, HFAccessoryRepresentable, HFFavoritable, HFHomeContainedObject, HFHomeStatusVisible, HFIncludedContextProtocol, HFReorderableHomeKitObject, HFRoomContextProviding, HFServiceNameComponentsProviding, HFShowInHomeDashboard, HFStateDumpBuildable, HFSymptomFixableObject, HMAccessoryInfoDataProviderDelegate, HMAccessorySettingsAdapterDelegate, HMAccessorySettingsContainerInternal, HMApplicationData, HMControllable, HMFLogging, HMFMessageReceiver, HMFObject, HMMediaDestination, HMMediaDestinationControllerDataSource, HMMediaDestinationInternal, HMMutableApplicationData, HMObjectMerge, HRERecommendableObjectProtocol, NSSecureCoding> {
...
- (bool)_mergeControlTargets:(id)arg1;
- (void)_mergeProfileObjects:(id)arg1;
