...
- (id)initWithUser:(id)arg1 allowAccess:(bool)arg2 owner:(bool)arg3 administratorPrivilege:(bool)arg4 remoteAccess:(bool)arg5 presenceAuthStatus:(id)arg6 presenceComputeStatus:(id)arg7 announceAccess:(bool)arg8 camerasAccess:(id)arg9;
