...
@interface HMService : NSObject <HFAccessoryLikeObjectRootHomeKitObjectProvider, HFAccessoryLikeObjectVendor, HFAccessoryRepresentable, HFFavoritable, HFHomeContainedObject, HFHomeStatusVisible, HFIncludedContextProtocol, HFReorderableHomeKitObject, HFRoomContextProviding, HFServiceNameComponentsProviding, HFShowInHomeDashboard, HFStateDumpBuildable, HFUserNotificationServiceSettingsProviding, HMFLogging, HMMutableApplicationData, HMObjectMerge, HRERecommendableObjectProtocol, NSSecureCoding> {
