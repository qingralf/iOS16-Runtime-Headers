...
- (id)getTrafficDescriptorsInfo:(id)arg1 connectionType:(int)arg2 error:(id*)arg3;
...
- (id)private_getTrafficDescriptorsInfo:(id)arg1 connectionType:(int)arg2 error:(id*)arg3;
