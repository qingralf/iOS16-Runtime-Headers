...
@interface NWConcrete_nw_path_parameters : NSObject <OS_nw_path_parameters> {
    ...
    struct nw_parameters_extended_objects { id x1; id x2; id x3; id x4; id x5; id x6; id x7; id x8; id x9; id x10; id x11; id x12; id x13; id x14; id x15; id x16; id x17; } * extended_objects;
