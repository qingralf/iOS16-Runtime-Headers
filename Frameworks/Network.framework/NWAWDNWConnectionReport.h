...
- (int)StringAsMptcpVersion:(id)arg1;
...
- (int)mptcpVersion;
- (id)mptcpVersionAsString:(int)arg1;
...
- (void)setHasMptcpVersion:(bool)arg1;
...
- (void)setHasTlsECHEnabled:(bool)arg1;
...
- (void)setTlsECHEnabled:(bool)arg1;
