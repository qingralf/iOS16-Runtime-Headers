...
+ (id)_iMIPScheduledEvent:(id)arg1 attendeesDeleted:(bool)arg2;
...
- (id)_nextEventWithFetchBlock:(id /* block */)arg1 steps:(id)arg2;
...
- (void)_processExternalChangesWithLatestTimestamp:(id)arg1 changedObjectIDsData:(id)arg2 changesWereSyncStatusOnly:(bool)arg3 forceImmediateNotification:(bool)arg4;
...
- (void)_setIsSpotlightTesting:(bool)arg1;
...
- (id)attachmentUUIDWithExternalID:(id)arg1 inSource:(id)arg2;
...
- (void)requestAccessToEntityType:(unsigned long long)arg1 testing:(bool)arg2 completion:(id /* block */)arg3;
- (void)reset;
...
- (void)setFetchingSharedCalendarInvitationsDisallowed:(bool)arg1;
- (bool)setFetchingSharedCalendarInvitationsDisallowedAndGetPreviousValue:(bool)arg1;
