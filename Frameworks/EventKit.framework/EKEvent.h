...
- (void)_adjustAfterMovingOrCopyingFromOldCalendar:(id)arg1 toNewCalendar:(id)arg2 savingItem:(id)arg3;
- (void)_adjustAlarmsAfterMovingOrCopyingFromCalendar:(id)arg1 toCalendar:(id)arg2;
- (void)_adjustAttachmentsAfterMovingOrCopyingFromCalendar:(id)arg1 toCalendar:(id)arg2 savingItem:(id)arg3;
...
- (void)_adjustPrivacyAfterMovingOrCopyingFromCalendar:(id)arg1 toCalendar:(id)arg2 savingItem:(id)arg3;
- (void)_adjustRecurrenceRulesAfterMovingOrCopyingFromCalendar:(id)arg1 toCalendar:(id)arg2 notes:(id)arg3;
- (void)_adjustScheduleAgentAfterMovingOrCopyingFromCalendar:(id)arg1 toCalendar:(id)arg2;
- (void)_adjustTimeZoneAfterMovingOrCopyingFromCalendar:(id)arg1 toCalendar:(id)arg2 notes:(id)arg3;
- (void)_adjustURLAfterMovingOrCopyingFromCalendar:(id)arg1 toCalendar:(id)arg2 notes:(id)arg3;
...
- (void)_snoozeAlarm:(id)arg1 withTimeIntervalFromNow:(double)arg2 orTargetDate:(id)arg3;
