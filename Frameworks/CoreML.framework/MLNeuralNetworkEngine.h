...
@interface MLNeuralNetworkEngine : MLModel <MLClassifier, MLCompiledModelLoader, MLNeuralNetwork, MLRegressor> {
    ...
    struct map<std::string, Espresso::vimage2espresso_param, std::less<std::string>, std::allocator<std::pair<const std::string, Espresso::vimage2espresso_param>>> { 
        struct __tree<std::__value_type<std::string, Espresso::vimage2espresso_param>, std::__map_value_compare<std::string, std::__value_type<std::string, Espresso::vimage2espresso_param>, std::less<std::string>, true>, std::allocator<std::__value_type<std::string, Espresso::vimage2espresso_param>>> { 
            void *__begin_node_; 
            ...
            struct __compressed_pair<unsigned long, std::__map_value_compare<std::string, std::__value_type<std::string, Espresso::vimage2espresso_param>, std::less<std::string>, true>> { 
                unsigned long long __value_; 
            } __pair3_; 
        } __tree_; 
    }  _params;
...
- (bool)verifyMultiArrayOutputBacking:(id)arg1 forFeature:(id)arg2 error:(id*)arg3;
- (bool)verifyOutputBacking:(id)arg1 forFeature:(id)arg2 error:(id*)arg3;
- (bool)verifyPixelBufferOutputBacking:(struct __CVBuffer { }*)arg1 forFeature:(id)arg2 error:(id*)arg3;
