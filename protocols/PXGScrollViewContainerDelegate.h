...
- (void)scrollViewContainerWillEndScrolling:(PXGScrollViewContainer *)arg1 withVelocity:(struct CGPoint { double x1; double x2; })arg2 targetContentOffset:(inout struct CGPoint { double x1; double x2; }*)arg3;
