...
- (void)getLogicalDeviceScopedDaemonProxyCreatorForTestDeviceReference:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 7: CKTestDeviceReference *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, <CKXPCLogicalDeviceScopedDaemon> *, void*
...
- (void)getTestAdminDaemonProxyCreatorWithCompletionHandler:(void *)arg1; // needs 1 arg types, found 6: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, <CKXPCTestDaemonAdmin> *, void*
