...
- (void)CADDatabaseGetAttachmentUUIDWithExternalID:(void *)arg1 store:(void *)arg2 reply:(void *)arg3; // needs 3 arg types, found 9: NSString *, CADObjectID *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, int, NSString *, void*
