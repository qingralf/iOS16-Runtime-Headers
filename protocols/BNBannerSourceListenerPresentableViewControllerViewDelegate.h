...
- (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })contentInsetsForBannerSourceListenerPresentableViewControllerView:(BNBannerSourceListenerPresentableViewControllerView *)arg1;
