...
- (void)action:(void *)arg1 wantsToToastSessionKitSessionWithIdentifier:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 8: WFAction *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
- (<WFActionReversalState> *)actionReversalStateForAction:(WFAction *)arg1;
- (<WFActionSandboxExtensionProvider> *)actionSandboxExtensionProviderForAction:(WFAction *)arg1;
