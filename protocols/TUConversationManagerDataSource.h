...
- (void)launchApplicationForActivitySessionUUID:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 7: NSUUID *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)launchApplicationForActivitySessionUUID:(void *)arg1 forceBackground:(void *)arg2 completionHandler:(void *)arg3; // needs 3 arg types, found 8: NSUUID *, bool, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (void)setAudioEnabled:(bool)arg1 forRemoteParticipantWithIdentifier:(unsigned long long)arg2 conversation:(TUConversation *)arg3;
...
- (void)setVideoEnabled:(bool)arg1 forRemoteParticipantWithIdentifier:(unsigned long long)arg2 conversation:(TUConversation *)arg3;
