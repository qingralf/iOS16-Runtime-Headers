...
- (void)presentAuthorizationWithContext:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 8: ASCAuthorizationPresentationContext *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, <ASCCredentialProtocol> *, NSError *, void*
