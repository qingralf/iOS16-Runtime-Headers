...
- (void)textureProvider:(PXGTextureProvider *)arg1 didProvideCGImage:(struct CGImage { }*)arg2 options:(struct { id x1; })arg3 isDegraded:(bool)arg4 forRequestID:(int)arg5;
...
- (void)textureProvider:(PXGTextureProvider *)arg1 didProvidePixelBuffer:(struct __CVBuffer { }*)arg2 options:(struct { id x1; })arg3 forRequestID:(int)arg4;
