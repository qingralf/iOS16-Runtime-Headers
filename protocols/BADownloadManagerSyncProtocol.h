...
- (void)downloadIdentifierDidFinish:(void *)arg1 clientStagedURL:(void *)arg2 sandboxExtensionToken:(void *)arg3 wasHandled:(void *)arg4; // needs 4 arg types, found 9: NSString *, NSURL *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
