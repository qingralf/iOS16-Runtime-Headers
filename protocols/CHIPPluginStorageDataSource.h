...
@protocol CHIPPluginStorageDataSource <NSObject>

@optional

- (NSSet *)allFabricIndexes;
...
- (<CHIPPluginFabricStorageDataSource> *)storageDataSourceForFabricWithIndex:(NSNumber *)arg1;
