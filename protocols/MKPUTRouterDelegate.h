...
- (void)router:(MKPUTRouter *)arg1 didReceiveImageChunk:(NSData *)arg2 identifier:(NSString *)arg3 offset:(unsigned long long)arg4 length:(unsigned long long)arg5 total:(unsigned long long)arg6 filename:(NSString *)arg7 collection:(NSString *)arg8;
...
- (void)router:(MKPUTRouter *)arg1 didReceiveVideoChunk:(NSData *)arg2 identifier:(NSString *)arg3 offset:(unsigned long long)arg4 length:(unsigned long long)arg5 total:(unsigned long long)arg6 filename:(NSString *)arg7 collection:(NSString *)arg8;
