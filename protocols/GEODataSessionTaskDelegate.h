...
- (void)dataSession:(void *)arg1 shouldConvertDataTask:(void *)arg2 toDownloadTaskForEstimatedResponseSize:(void *)arg3 completionHandler:(void *)arg4; // needs 4 arg types, found 9: <GEODataSession> *, <GEODataSessionTask> *, unsigned long long, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
