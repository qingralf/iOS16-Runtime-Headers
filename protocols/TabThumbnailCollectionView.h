...
- (void)endSearching;
- (void)enumerateItemsOrderedByVisibility:(void *)arg1; // needs 1 arg types, found 6: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, <TabCollectionItem> *, void*
- (bool)isSearching;
...
- (void)setSidebarButton:(UIButton *)arg1;
