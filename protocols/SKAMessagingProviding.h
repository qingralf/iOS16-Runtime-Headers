...
- (bool)sendMessage:(NSDictionary *)arg1 toHandle:(SKHandle *)arg2 fromHandle:(SKHandle *)arg3 limitToPresenceCapable:(bool)arg4 error:(id*)arg5;
- (bool)sendMessage:(NSDictionary *)arg1 toHandles:(NSArray *)arg2 fromHandle:(SKHandle *)arg3 limitToPresenceCapable:(bool)arg4 error:(id*)arg5;
