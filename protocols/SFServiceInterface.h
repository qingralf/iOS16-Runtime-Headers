...
- (void)requestReverseGeocodeForLatitude:(void *)arg1 longitude:(void *)arg2 reply:(void *)arg3; // needs 3 arg types, found 10: double, double, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSString *, NSString *, NSError *, void*
