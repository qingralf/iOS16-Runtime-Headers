...
- (void)replaceFileAtPath:(void *)arg1 withFileHandle:(void *)arg2 reply:(void *)arg3; // needs 3 arg types, found 8: NSString *, BMFileHandle *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)sharedMemoryForFileAtPath:(void *)arg1 flags:(void *)arg2 reply:(void *)arg3; // needs 3 arg types, found 9: NSString *, int, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, BMSharedMemory *, NSError *, void*
