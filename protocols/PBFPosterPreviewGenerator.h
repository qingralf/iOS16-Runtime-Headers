...
- (void)fetchSnapshotForPosterPreview:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: <PBFPosterPreview> *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, UIImage *, NSError *, void*
