...
- (void)validateInvitationToken:(void *)arg1 albumName:(void *)arg2 completionBlock:(void *)arg3; // needs 3 arg types, found 9: NSString *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, NSError *, void*
