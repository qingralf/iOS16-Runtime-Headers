...
- (oneway void)vendSandboxExtensionWithResource:(void *)arg1 readonly:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 9: int, bool, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSString *, NSError *, void*
