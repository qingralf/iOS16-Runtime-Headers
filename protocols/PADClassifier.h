...
- (void)finishLivenessWithSelfie:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: PADFrame *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, PADClassifierResult *, NSError *, void*
