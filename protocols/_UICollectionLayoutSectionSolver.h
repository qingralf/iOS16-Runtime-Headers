...
- (void)solveForContainer:(id <NSCollectionLayoutContainer>)arg1 supplementaryContainer:(id <NSCollectionLayoutContainer>)arg2 traitCollection:(UITraitCollection *)arg3 layoutAxis:(unsigned long long)arg4 frameCount:(long long)arg5 preferredSizes:(id <_UICollectionPreferredSizes>)arg6 layoutRTL:(bool)arg7;
