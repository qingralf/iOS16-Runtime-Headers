...
+ (id)uiElementAtCoordinate:(struct CGPoint { double x1; double x2; })arg1 forApplication:(const struct __AXUIElement { }*)arg2 contextId:(unsigned int)arg3;
...
- (NSArray *)uiElementsWithAttribute:(long long)arg1 parameter:(const void*)arg2 fetchAttributes:(bool)arg3;
