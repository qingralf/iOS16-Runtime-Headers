...
- (void)bringDialogsToFrontForRunningContext:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 7: WFWorkflowRunningContext *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
...
- (void)returnFocusToOriginatingAppForRunningContext:(void *)arg1 completionHandler:(void *)arg2; // needs 2 arg types, found 7: WFWorkflowRunningContext *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
