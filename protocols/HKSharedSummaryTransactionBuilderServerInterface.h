...
- (void)remote_allAddedSummariesWithPackage:(void *)arg1 resultsHandler:(void *)arg2; // needs 2 arg types, found 9: NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSArray *, bool, NSError *, void*
