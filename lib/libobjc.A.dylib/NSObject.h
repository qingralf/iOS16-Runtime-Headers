...
@interface NSObject <ATXScoreLogSerializable, BNPresentableUniquelyIdentifying, CAAnimatableValue, CARenderValue, CKLParsedObject, DebugHierarchyObject_Fallback, INCodableAttributeRelationComparing, INEnumerable, MAPropertyTypeProtocol, MusicKit_SoftLinking_MPArtworkCatalog, MusicKit_SoftLinking_MPArtworkColorAnalysis, MusicKit_SoftLinking_MPIdentifierSet, MusicKit_SoftLinking_MPModelInnerObjectProviding, NSObject, NSObjectInitJSExports, PQLResultSetInitializer, REDonatedActionIdentifierProviding, SAElementUniquelyIdentifying, SBUISystemApertureElementContextProviding, SwiftUI.PlatformAccessibilityElement, WFNaming, WFTyping, WatchQuickActionHost, _DKProtobufConverting> {
    Class  isa;
}
...
- (bool)isSettlingFromSystemApertureOvershootingTransition;
- (void)setPerformingSystemApertureCustomContentTransition:(bool)arg1;
- (void)setSettlingFromSystemApertureOvershootingTransition:(bool)arg1;
