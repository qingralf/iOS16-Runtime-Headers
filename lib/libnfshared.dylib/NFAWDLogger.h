...
- (void)postAWDRadioIsEnabledStatistic:(bool)arg1 changed:(bool)arg2;
...
- (void)postAWDSEMemoryInfo:(id)arg1;
- (void)postAWDSERemovedEvent:(id)arg1;
- (void)postAWDSERestrictedModeEntered:(id)arg1;
