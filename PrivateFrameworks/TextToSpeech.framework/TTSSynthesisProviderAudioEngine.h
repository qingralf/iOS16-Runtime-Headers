...
@interface TTSSynthesisProviderAudioEngine : NSObject <TTSSynthesisProviderHandlerDelegate> {
    ...
    TTSSynthesisProviderAudioOutput * _offlineToRealtimePlayer;
...
@property (nonatomic, copy) id /* block */ bufferCallback;
...
@property (nonatomic, retain) TTSSynthesisProviderAudioOutput *offlineToRealtimePlayer;
...
- (void)_pausePlaying;
- (void)_safelyCallDeferredReplyBlock:(bool)arg1;
- (bool)_setupAudioUnitForVoice:(id)arg1;
- (bool)_setupAudioUnitForVoice:(id)arg1 remote:(bool)arg2;
...
- (void)renderWithObserver:(id /* block */)arg1;
