...
@interface AFUISiriViewController : UIViewController <AFUINetworkAvailabilityStateMachineDelegate, AFUISiriCompactViewDelegate, AFUISiriContentDelegate, AFUISiriRemoteSceneViewControllerDataSource, AFUISiriRemoteSceneViewControllerDelegate, AFUISiriSessionLocalDataSource, AFUISiriSessionLocalDelegate, AFUISiriTapPanDismissalPolicyManagerDelegate, AFUISiriViewDataSource, AFUISiriViewDelegate, SRUIFDelayedActionCommandCacheDelegate, SiriUIAudioRoutePickerControllerDelegate, SiriUIKeyboardViewDelegate, SiriUIPresentationRemoteControlling> {
    ...
    bool  _skipLoggingListeningEventForLaunchIntoListening;
...
- (void)_donateUIDismissalToBiome:(unsigned long long)arg1;
...
- (void)emitUIStateTransitionForSiriDismissalWithReason:(unsigned long long)arg1;
- (void)endSession;
...
- (void)setSkipLoggingListeningEventForLaunchIntoListening:(bool)arg1;
- (void)setStatusBarEnabled:(bool)arg1;
- (void)setSystemApertureEdgeInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1;
...
- (bool)skipLoggingListeningEventForLaunchIntoListening;
