...
@interface AXWatchRemoteScreenUI.AXTwiceCompanionRootViewController : UIViewController <AXTwiceCompanionAirplayReceiverDelegate, AXTwiceRemoteScreenMessengerDelegateProtocolObjc, AXWatchRemoteScreenUI.AXTwiceCompanionRendererViewDelegate, AXWatchRemoteScreenUI.AXTwiceRootViewControllerProtocol> {
...
- (void)prepareToDisappearWithCompletion:(id /* block */)arg1;
