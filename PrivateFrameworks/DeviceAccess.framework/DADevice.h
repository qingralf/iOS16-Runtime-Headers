...
@property (nonatomic, readonly, copy) NSString *mediaContentArtistNameSafe;
@property (nonatomic, copy) NSString *mediaContentTitle;
@property (nonatomic, readonly, copy) NSString *mediaContentTitleSafe;
@property (nonatomic) long long mediaPlaybackState;
@property (nonatomic, readonly) long long mediaPlaybackStateSafe;
...
- (bool)isKnown;
- (id)mediaContentArtistNameSafe;
- (id)mediaContentTitleSafe;
- (long long)mediaPlaybackStateSafe;
