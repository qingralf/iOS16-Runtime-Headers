...
- (bool)_IS_multiSizeImageExistsWithName:(id)arg1;
- (id)_IS_multisizedImageWithName:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 scale:(double)arg3;
- (id)_IS_multisizedImageWithName:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2 scale:(double)arg3 layoutDirection:(long long)arg4;
