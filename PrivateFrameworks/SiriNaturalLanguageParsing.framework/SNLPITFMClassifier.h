...
+ (id)_convertResponse:(struct ITFMParserResponse { int (**x1)(); struct unique_ptr<sirinluexternal::Parser, std::default_delete<sirinluexternal::Parser>> { struct __compressed_pair<sirinluexternal::Parser *, std::default_delete<sirinluexternal::Parser>> { struct Parser {} *x_1_2_1; } x_2_1_1; } x2; float x3; bool x4; struct { unsigned int x_5_1_1 : 1; unsigned int x_5_1_2 : 1; } x5; })arg1;
