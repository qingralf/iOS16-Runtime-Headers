...
+ (void)_donateText:(id)arg1 withTitle:(id)arg2 debugText:(id)arg3 debugUrlString:(id)arg4 rawHTML:(id)arg5 leadImage:(id)arg6 snapshot:(id)arg7 uiElements:(id)arg8 usingContextFromExecutor:(id)arg9;
