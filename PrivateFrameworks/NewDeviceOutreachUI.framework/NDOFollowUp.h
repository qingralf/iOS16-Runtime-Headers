...
- (id)refreshFollowupWithDeviceInfo:(id)arg1 allowForcePost:(bool)arg2;
- (id)refreshFollowupWithDeviceInfos:(id)arg1;
- (id)refreshFollowupWithDeviceInfos:(id)arg1 clearUntrackedDeviceFollowups:(bool)arg2 allowForcePost:(bool)arg3;
