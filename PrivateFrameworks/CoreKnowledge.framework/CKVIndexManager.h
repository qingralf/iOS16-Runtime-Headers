...
- (void)_verifyIndexesAtDataDirectory:(id)arg1 description:(id)arg2 userId:(id)arg3 clean:(bool)arg4;
- (bool)_verifySkitAtDataDirectory:(id)arg1 description:(id)arg2;
...
- (bool)updateStoredLanguageCodes:(id)arg1;
