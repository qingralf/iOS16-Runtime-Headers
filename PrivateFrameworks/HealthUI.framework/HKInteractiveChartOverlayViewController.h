...
- (void)_deliverOrWaitForDataSource:(id)arg1 graphSeriesContext:(id)arg2 priorityDelegate:(id)arg3 timeScope:(long long)arg4 startDate:(id)arg5 endDate:(id)arg6 queryIfNeeded:(bool)arg7 completion:(id /* block */)arg8;
...
- (void)cachedDataForCustomGraphSeries:(id)arg1 timeScope:(long long)arg2 startDate:(id)arg3 endDate:(id)arg4 queryIfNeeded:(bool)arg5 completion:(id /* block */)arg6;
...
- (void)cachedDataForStandardDisplayType:(id)arg1 timeScope:(long long)arg2 startDate:(id)arg3 endDate:(id)arg4 completion:(id /* block */)arg5;
