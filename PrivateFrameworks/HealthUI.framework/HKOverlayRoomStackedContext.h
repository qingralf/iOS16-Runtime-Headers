...
- (id)displayType;
- (id)initWithDisplayType:(id)arg1 overlayDisplayType:(id)arg2 stackedDisplayType:(id)arg3 overlayChartController:(id)arg4 currentCalendarOverride:(id)arg5 applicationItems:(id)arg6;
- (id)initWithDisplayType:(id)arg1 overlayDisplayType:(id)arg2 stackedSampleType:(id)arg3 overlayChartController:(id)arg4 currentCalendarOverride:(id)arg5 applicationItems:(id)arg6;
- (id)initWithDisplayType:(id)arg1 templateDisplayType:(id)arg2 sampleType:(id)arg3 overlayDisplayType:(id)arg4 stackedDisplayType:(id)arg5 stackedTemplateDisplayType:(id)arg6 stackedSampleType:(id)arg7 overlayChartController:(id)arg8 currentTimeScope:(long long)arg9 currentCalendar:(id)arg10 applicationItems:(id)arg11;
- (id)initWithSampleType:(id)arg1 overlayDisplayType:(id)arg2 stackedSampleType:(id)arg3 overlayChartController:(id)arg4 currentCalendarOverride:(id)arg5 applicationItems:(id)arg6;
- (id)lastUpdatedItem;
