...
- (id)initWithBaseChartDisplayType:(id)arg1 trendModel:(id)arg2 displayDate:(id)arg3 applicationItems:(id)arg4 timeScopeRanges:(id)arg5 initialTimeScope:(long long)arg6 wrappedOverlay:(id)arg7 overrideFirstWeekday:(long long)arg8 overrideCalendar:(id)arg9;
