...
+ (id)standHourChartingRulesWithDayChartStyle:(long long)arg1;
+ (id)timePeriodChartingRulesWithDayChartStyle:(long long)arg1 minimumYAxisSpacingPerDay:(double)arg2 startOfDayTransform:(id /* block */)arg3 noDataAxisRange:(id)arg4;
