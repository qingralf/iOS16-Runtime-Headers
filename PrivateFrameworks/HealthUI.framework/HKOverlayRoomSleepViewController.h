...
@interface HKOverlayRoomSleepViewController : HKOverlayRoomViewController <HKCurrentValueViewDataSourceDelegate, HKOverlayRoomTrendModelProviding, HKOverlaySleepRoomContextChangeDelegate> {
