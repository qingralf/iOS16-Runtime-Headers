...
@interface HKDisplayTypeContextVerticalCollectionViewCell : UICollectionViewCell {
    ...
    UILabel * _titleLabel;
    UILabel * _unitLabel;
    bool  _unitStringIsVeryLong;
    UILabel * _valueLabel;
    bool  _valueStringIsVeryLong;
...
- (id)_titleAttributes;
- (id)_titleFont;
- (id)_unitStringForContextItem:(id)arg1;
