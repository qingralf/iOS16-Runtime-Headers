...
@property (nonatomic, retain) SBKSyncTransaction *currentKVSTransaction;
@property (nonatomic, retain) <SBKUniversalPlaybackPositionDataSource> *dataSource;
@property (nonatomic, retain) <SBKUniversalPlaybackPositionTransactionContext> *dataSourceTransactionContext;
...
@property (nonatomic, retain) NSMutableDictionary *metadataItemsFromDataSource;
@property (nonatomic, retain) NSDictionary *metadataItemsToCommitToDataSource;
@property (nonatomic, retain) NSDictionary *metadataItemsToCommitToKVSStorage;
@property (nonatomic, retain) NSString *overrideSyncAnchor;
@property (nonatomic, retain) NSMutableDictionary *responseMetadataItemsMergedToCommitBackToKVSStorage;
@property (nonatomic, retain) NSMutableDictionary *responseMetadataItemsToCommitToDataSource;
