...
- (id)initWithInstance:(id)arg1 auditToken:(id)arg2 bundleData:(id)arg3 manageFlags:(unsigned char)arg4 beforeTranslocationBundlePath:(id)arg5 cache:(bool)arg6;
