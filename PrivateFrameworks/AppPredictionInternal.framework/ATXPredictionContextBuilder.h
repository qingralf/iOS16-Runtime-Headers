...
- (id)initWithAppInfoManager:(id)arg1 locationManager:(id)arg2 motionManagerWrapper:(id)arg3 ambientLightMonitor:(id)arg4 deviceStateMonitorClass:(Class)arg5 contextSourcesInitialized:(bool)arg6 contextStream:(id)arg7 locationStream:(id)arg8 biomeStreamsInitialized:(bool)arg9;
