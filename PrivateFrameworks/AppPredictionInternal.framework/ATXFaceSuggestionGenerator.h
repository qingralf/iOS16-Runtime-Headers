...
@interface ATXFaceSuggestionGenerator : NSObject <ATXDNDModeConfigurationClientObserver, ATXPosterConfigurationCacheObserver, ATXPosterDescriptorCacheObserver> {
...
- (void)configuredModesDidChange:(id)arg1;
- (void)dealloc;
- (id)delegate;
