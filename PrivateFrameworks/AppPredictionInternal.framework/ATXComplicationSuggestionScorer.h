...
- (id)_scoredComplicationsForModularSetGivenDescriptors:(id)arg1 appBundleIdScores:(id)arg2 heuristicScores:(id)arg3;
- (id)complicationDescriptorsForInlineSetGivenComplicationDescriptors:(id)arg1;
- (id)complicationDescriptorsForModularSetGivenComplicationDescriptors:(id)arg1;
- (id)init;
...
- (id)scoredComplicationDescriptorsForModularSetGivenComplicationDescriptors:(id)arg1 checkEligibility:(bool)arg2;
