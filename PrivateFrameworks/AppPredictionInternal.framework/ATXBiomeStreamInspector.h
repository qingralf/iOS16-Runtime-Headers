...
+ (void)makeJSONRepresentationForStreamWithBlock:(id /* block */)arg1 blendingPublisher:(id)arg2 clientPublisher:(id)arg3 uiPublisher:(id)arg4 appLaunchPublisher:(id)arg5 appIntentPublisher:(id)arg6 inferredModePublisher:(id)arg7;
