...
- (id)initWithSearchString:(id)arg1 performNLSearch:(bool)arg2 performTopHitSearch:(bool)arg3 suggestions:(id)arg4 suggestionsQueryString:(id)arg5 modernResultsOnly:(bool)arg6;
