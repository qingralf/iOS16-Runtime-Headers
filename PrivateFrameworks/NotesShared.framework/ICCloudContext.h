...
- (void)_injestFetchedRecord:(id)arg1 forAccountID:(id)arg2 forceMerge:(bool)arg3 context:(id)arg4;
...
- (id)init;
- (void)injestFetchedRecord:(id)arg1 forAccountID:(id)arg2 forceMerge:(bool)arg3 context:(id)arg4;
