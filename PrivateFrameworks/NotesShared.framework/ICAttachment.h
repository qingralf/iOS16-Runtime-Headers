...
@property (nonatomic, readonly) bool alwaysUsesSmallSize;
...
@property (readonly) <ICAttachmentCryptoStrategy> *cryptoStrategy;
...
@property (nonatomic, readonly) LPLinkMetadata *fallbackRemoteAttachmentMetadata;
...
@property (nonatomic, readonly) LPLinkMetadata *fileMetadata;
...
@property (nonatomic, readonly) LPLinkMetadata *loadingAttachmentsMetadata;
...
@property (nonatomic, readonly) bool metadataExists;
...
@property (nonatomic, readonly) LPLinkMetadata *plainURLMetadata;
...
@property (nonatomic, readonly) LPLinkMetadata *scannedDocumentsMetadata;
...
@property (nonatomic, readonly) LPLinkMetadata *synapseBasedMetadata;
...
@property (nonatomic, readonly) bool usesLinkPresentation;
...
- (id)markupModelData;
- (void)mergeDataFromRecord:(id)arg1 accountID:(id)arg2 force:(bool)arg3;
- (void)mergeDataFromRecord:(id)arg1 accountID:(id)arg2 force:(bool)arg3 newAttachment:(bool)arg4;
- (id)mergeDecryptedValue:(id)arg1 withOldValue:(id)arg2 forKey:(id)arg3;
- (void)mergeFallbackImageFromRecord:(id)arg1;
...
- (void)saveMergeableDataIfNeededAndSaveContextIfNeeded:(bool)arg1;
