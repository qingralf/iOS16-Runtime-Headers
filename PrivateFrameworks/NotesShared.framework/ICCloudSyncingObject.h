...
@property (nonatomic, readonly) NSData *primaryEncryptedData;
...
@property (nonatomic, readonly, copy) NSString *shareViaICloudGelatoActionTitle;
...
- (void)didFailToSaveUserSpecificRecordWithID:(id)arg1 accountID:(id)arg2 error:(id)arg3;
...
- (void)objectFailedToBePushedToCloudWithOperation:(id)arg1 recordID:(id)arg2 error:(id)arg3;
...
- (id)shareViaICloudGelatoActionTitle;
