...
+ (void)enumerateInlineAttachmentsInContext:(id)arg1 batchSize:(unsigned long long)arg2 visibleOnly:(bool)arg3 saveAfterBatch:(bool)arg4 usingBlock:(id /* block */)arg5;
...
+ (void)checkForIncompatibleDevicesForAttachment:(id)arg1 completion:(id /* block */)arg2;
...
+ (id)incompatibilityAlertMessageForDevices:(id)arg1 hasNonUpgradableDevice:(bool)arg2;
+ (id)incompatibilityAlertTitle;
+ (id)prefKeyForKey:(id)arg1 accountIdentifier:(id)arg2;
+ (void)showOneTimeCompatibilityAlertForDevices:(id)arg1 hasNonUpgradableDevice:(bool)arg2 accountIdentifier:(id)arg3 parentViewController:(id)arg4 withCompletion:(id /* block */)arg5;
