...
@interface ICNote : ICCloudSyncingObject <ICCloudObject, ICDerivedAttributeProviding, ICItemProviderWriting, ICNoteUI, ICSearchIndexableNote, TTMergeableStringDelegate, TTTextStorageDelegate> {
...
@property (readonly) <ICNoteCryptoStrategy> *cryptoStrategy;
...
- (void)markAttachmentsPassingTestAsNeedingReindexForSearch:(id /* block */)arg1;
...
- (void)setIsSystemPaper:(bool)arg1;
...
- (id)visibleAttachmentTextStorages;
- (id)writableTypeIdentifiersForItemProvider;
