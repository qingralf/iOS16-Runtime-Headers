...
@interface SASActivationCondition : NSObject {
    ...
    SASUnderstandingOnDeviceAssetsState * _uodAssetsState;
}
...
@property (nonatomic, retain) SASUnderstandingOnDeviceAssetsState *uodAssetsState;
...
- (void)setUodAssetsState:(id)arg1;
- (id)systemState;
- (id)uodAssetsState;
