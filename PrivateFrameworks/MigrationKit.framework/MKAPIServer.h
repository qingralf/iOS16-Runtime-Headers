...
@interface MKAPIServer : NSObject <MKGETCertificateRouterDelegate, MKGETSRPRouterDelegate, MKHTTPServerDelegate, MKMigratorDelegate, MKPOSTCertificateRouterDelegate, MKPOSTClientRouterDelegate, MKPOSTProgressRouterDelegate, MKPOSTSRPRouterDelegate, MKPUTRouterDelegate> {
...
- (void)router:(id)arg1 didReceiveImageChunk:(id)arg2 identifier:(id)arg3 offset:(unsigned long long)arg4 length:(unsigned long long)arg5 total:(unsigned long long)arg6 filename:(id)arg7 collection:(id)arg8;
...
- (void)router:(id)arg1 didReceiveVideoChunk:(id)arg2 identifier:(id)arg3 offset:(unsigned long long)arg4 length:(unsigned long long)arg5 total:(unsigned long long)arg6 filename:(id)arg7 collection:(id)arg8;
