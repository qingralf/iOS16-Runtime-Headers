...
- (id)albumMigrator;
- (void)import;
- (void)import:(id)arg1 identifier:(id)arg2 offset:(unsigned long long)arg3 length:(unsigned long long)arg4 total:(unsigned long long)arg5 filename:(id)arg6 collection:(id)arg7;
- (void)importChunk:(id)arg1 identifier:(id)arg2 offset:(unsigned long long)arg3 length:(unsigned long long)arg4 total:(unsigned long long)arg5 filename:(id)arg6 collection:(id)arg7;
