...
- (void)_tellSpeechDelegateDidRecognizeSpeechPhrases:(id)arg1 utterances:(id)arg2 nluResult:(id)arg3 languageModel:(id)arg4 correctionIdentifier:(id)arg5 audioAnalytics:(id)arg6;
