...
- (oneway void)speechDidRecognizePhrases:(id)arg1 utterances:(id)arg2 nluResult:(id)arg3 usingSpeechModel:(id)arg4 correctionContext:(id)arg5 audioAnalytics:(id)arg6;
