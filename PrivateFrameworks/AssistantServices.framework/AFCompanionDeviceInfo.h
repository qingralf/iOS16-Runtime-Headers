...
- (id)idsIdentifier;
- (id)init;
- (id)initWithAssistantID:(id)arg1 speechID:(id)arg2 idsIdentifier:(id)arg3 productPrefix:(id)arg4 aceHost:(id)arg5 syncMetadata:(id)arg6 syncMetadataCapability:(bool)arg7 peerToPeerHandoffCapability:(bool)arg8 muxSupportCapability:(bool)arg9;
