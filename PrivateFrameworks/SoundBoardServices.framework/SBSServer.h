...
@interface SBSServer : NSObject <NSXPCListenerDelegate, SBSImplementer, SBSImplementerInternal> {
    ...
    <SBSCaptiveNetworkSupportImplementer> * _captiveNetworkDelegate;
...
@property (nonatomic) <SBSCaptiveNetworkSupportImplementer> *captiveNetworkDelegate;
...
- (void)captiveDetectedInternal:(id)arg1;
- (id)captiveNetworkDelegate;
...
- (void)setCaptiveNetworkDelegate:(id)arg1;
