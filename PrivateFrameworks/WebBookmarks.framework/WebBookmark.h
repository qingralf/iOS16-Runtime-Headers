...
- (void)_mergeFields:(id)arg1 withFields:(id)arg2 forBookmark:(id)arg3;
...
- (id)initFolderWithParentID:(int)arg1 deviceIdentifier:(id)arg2;
- (id)initFolderWithParentID:(int)arg1 subtype:(long long)arg2 deviceIdentifier:(id)arg3;
...
- (id)initWithSQLiteStatement:(struct sqlite3_stmt { }*)arg1 deviceIdentifier:(id)arg2;
- (id)initWithSQLiteStatement:(struct sqlite3_stmt { }*)arg1 deviceIdentifier:(id)arg2 hasIcon:(bool)arg3;
- (id)initWithTitle:(id)arg1 address:(id)arg2;
- (id)initWithTitle:(id)arg1 address:(id)arg2 parentID:(int)arg3;
- (id)initWithTitle:(id)arg1 address:(id)arg2 parentID:(int)arg3 deviceIdentifier:(id)arg4;
- (id)initWithTitle:(id)arg1 address:(id)arg2 parentID:(int)arg3 folder:(bool)arg4 deviceIdentifier:(id)arg5;
- (id)initWithTitle:(id)arg1 address:(id)arg2 parentID:(int)arg3 subtype:(long long)arg4 deviceIdentifier:(id)arg5;
- (bool)isAddedLocally;
...
- (void)mergeAttributes:(unsigned long long)arg1 withBookmark:(id)arg2;
...
- (int)parentID;
- (void)performWithFieldsWriteLockIfNeeded:(id /* block */)arg1;
- (id)pinnedAddress;
- (id)pinnedTitle;
- (id)previewText;
