...
- (id)_generateSyncPositionForBookmark:(id)arg1;
...
- (bool)_insertTombsonesRecursivelyHelperCurrentDepth:(unsigned long long)arg1 folder:(id)arg2 insertTombstoneBlock:(id /* block */)arg3;
...
- (void)_mergeBookmarkIntoPersistedBookmark:(id)arg1 forAttributes:(unsigned long long)arg2;
...
- (bool)_unsafeSaveBookmark:(id)arg1 withSpecialID:(int)arg2 updateGenerationIfNeeded:(bool)arg3;
- (bool)_updateBookmarkSyncPositionIfNeeded:(id)arg1;
...
- (int)parentIdentifierOfBookmark:(id)arg1;
...
- (id)secondaryZoneNameForBookmark:(id)arg1;
