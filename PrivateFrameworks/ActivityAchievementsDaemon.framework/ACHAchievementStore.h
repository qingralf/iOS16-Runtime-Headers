...
@interface ACHAchievementStore : NSObject <ACHAchievementProgressEngineObserving, ACHAchievementStoring, ACHEarnedInstanceStoreObserving, ACHTemplateAssetRegistryDelegate, ACHTemplateStoreObserving> {
...
- (bool)_lock_addProgressAndGoalToAchievement:(id)arg1;
...
- (id)initWithClient:(id)arg1 templateStore:(id)arg2 earnedInstanceStore:(id)arg3 templateAssetRegistry:(id)arg4 progressProvider:(id)arg5;
- (id)internalQueue;
