...
@interface ACHLegacyAchievementStore : NSObject <ACHAchievementProgressEngineObserving, ACHAchievementStoring, ACHEarnedInstanceStoreObserving, ACHTemplateAssetRegistryDelegate, ACHTemplateStoreObserving> {
