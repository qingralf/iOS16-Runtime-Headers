...
- (id)initWithIdentifier:(id)arg1 originatingBundleIdentifier:(id)arg2 dataTypes:(unsigned long long)arg3 policy:(long long)arg4 expirationDate:(id)arg5 region:(id)arg6;
