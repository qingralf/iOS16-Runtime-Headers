...
- (id)initWithCoordinate:(struct { double x1; double x2; double x3; })arg1 angle:(double)arg2 road:(id)arg3 startCoordinate:(struct { double x1; double x2; double x3; })arg4 endCoordinate:(struct { double x1; double x2; double x3; })arg5;
- (id)junction;
- (id)road;
- (double)score;
- (double)segmentAngle;
