...
- (struct RoadNetworkPath<GEOPathMatcherRoadKey> { double x1; double x2; struct vector<GEOPathMatcherRoadKey, std::allocator<GEOPathMatcherRoadKey>> { struct GEOPathMatcherRoadKey {} *x_3_1_1; struct GEOPathMatcherRoadKey {} *x_3_1_2; struct __compressed_pair<GEOPathMatcherRoadKey *, std::allocator<GEOPathMatcherRoadKey>> { struct GEOPathMatcherRoadKey {} *x_3_2_1; } x_3_1_3; } x3; })_decodePathForRoute:(id)arg1 start:(struct PolylineCoordinate { unsigned int x1; float x2; })arg2 end:(struct PolylineCoordinate { unsigned int x1; float x2; })arg3 roadNetwork:(const void*)arg4 internalInfo:(id)arg5;
...
- (void)_verifySegmentDistanceFromRoute:(id)arg1 segmentIndex:(long long)arg2 requestedPathRange:(struct GEOPolylineCoordinateRange { struct PolylineCoordinate { unsigned int x_1_1_1; float x_1_1_2; } x1; struct PolylineCoordinate { unsigned int x_2_1_1; float x_2_1_2; } x2; })arg3;
