...
- (void)_set15moDeviceRawSessionData:(id)arg1;
- (void)_set15moDeviceSessionData:(id)arg1;
- (void)_set15moUserPresyncDeviceRawSessionData:(id)arg1;
- (void)_set15moUserPresyncDeviceSessionData:(id)arg1;
- (void)_set15moUserPresyncUserRawSessionData:(id)arg1;
- (void)_set15moUserPresyncUserSessionData:(id)arg1;
...
- (void)_setPreSyncDeviceSessionDataHasMigrated:(bool)arg1;
