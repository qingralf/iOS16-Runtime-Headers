...
@interface GEOResourceManifestServerLocalProxy : NSObject <GEOConfigChangeListenerDelegate, GEODataStateCapturing, GEOKeyBagProtectedDataDidBecomeAvailableObserver, GEOResourceFiltersManagerDelegate, GEOResourceManifestServerProxy, GEOTileGroupActivationSessionDelegate> {
