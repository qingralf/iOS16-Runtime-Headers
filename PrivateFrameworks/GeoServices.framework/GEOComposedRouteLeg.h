...
@interface GEOComposedRouteLeg : NSObject <NSSecureCoding> {
    ...
    GEOFormattedString * _destinationListInstruction;
    double  _distance;
    int  _drivingSide;
    ...
    GEOFormattedString * _originListInstruction;
    struct _NSRange { 
...
@property (nonatomic, readonly) <GEOServerFormattedString> *destinationListInstruction;
...
@property (nonatomic, readonly) <GEOServerFormattedString> *originListInstruction;
