...
- (id)findUnjoinedRoadsAtJunction:(id)arg1 desiredRoadDirectionality:(unsigned long long)arg2 muid:(unsigned long long)arg3 requireExactMuidMatch:(bool)arg4 featureToIgnore:(id)arg5 handler:(id /* block */)arg6 completionHandler:(id /* block */)arg7;
