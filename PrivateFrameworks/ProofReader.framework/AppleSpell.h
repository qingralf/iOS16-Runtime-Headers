...
- (id)_correctionResultForWord:(id)arg1 replacementRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 inString:(id)arg3 offset:(unsigned long long)arg4 languageObject:(id)arg5 capitalize:(bool)arg6 isCapitalized:(bool)arg7 isSecondCapitalized:(bool)arg8 hasCurlyApostrophe:(bool)arg9 capitalizationLocale:(id)arg10 proposedCorrection:(id)arg11;
...
- (void)spellServer:(id)arg1 checkSentenceCorrectionInString:(id)arg2 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg3 languageObject:(id)arg4 offset:(unsigned long long)arg5 keyEventArray:(id)arg6 selectedRangeValue:(id)arg7 autocorrect:(bool)arg8 checkGrammar:(bool)arg9 mutableResults:(id)arg10;
- (void)spellServer:(id)arg1 checkSentenceCorrectionInString:(id)arg2 rangeInParagraph:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg3 languageObject:(id)arg4 locale:(id)arg5 tagger:(id)arg6 offset:(unsigned long long)arg7 keyEventArray:(id)arg8 selectedRangeValue:(id)arg9 autocorrect:(bool)arg10 checkGrammar:(bool)arg11 mutableResults:(id)arg12;
