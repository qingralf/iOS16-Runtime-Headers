...
@interface TVPPlayer : NSObject <AVPlayerItemDelegate, AVPlayerPlaybackCoordinatorDelegate, TVPAVFPlayback> {
    ...
    bool  _invalidated;
    bool  _isLive;
    NSString * _lastSelectedAudioLanguageCode;
    struct { 
        long long value; 
        int timescale; 
        unsigned int flags; 
...
@property (nonatomic, retain) NSString *lastSelectedAudioLanguageCode;
...
+ (id)_audioSelectionCriteriaForPreferredAudioLanguageCodes:(id)arg1;
...
+ (void)_updateAudioSelectionCriteriaForAVQueuePlayer:(id)arg1 preferredAudioLanguageCodes:(id)arg2;
...
- (bool)invalidated;
- (bool)isLive;
- (id)lastSelectedAudioLanguageCode;
...
- (void)setLastSelectedAudioLanguageCode:(id)arg1;
