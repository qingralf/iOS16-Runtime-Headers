...
- (void)_clearBodyData;
- (void)_enumerateBodyByPartsWithIndexesDeleted:(id)arg1 rangesDeletedMap:(id)arg2 block:(id /* block */)arg3;
...
- (id)initWithSenderInfo:(id)arg1 time:(id)arg2 timeRead:(id)arg3 timeDelivered:(id)arg4 timePlayed:(id)arg5 subject:(id)arg6 body:(id)arg7 bodyData:(id)arg8 attributes:(id)arg9 fileTransferGUIDs:(id)arg10 flags:(unsigned long long)arg11 guid:(id)arg12 messageID:(long long)arg13 account:(id)arg14 accountID:(id)arg15 service:(id)arg16 handle:(id)arg17 roomName:(id)arg18 unformattedID:(id)arg19 countryCode:(id)arg20 expireState:(long long)arg21 balloonBundleID:(id)arg22 payloadData:(id)arg23 expressiveSendStyleID:(id)arg24 timeExpressiveSendPlayed:(id)arg25 bizIntent:(id)arg26 locale:(id)arg27 errorType:(unsigned int)arg28 type:(long long)arg29 threadIdentifier:(id)arg30 syndicationRanges:(id)arg31 syncedSyndicationRanges:(id)arg32 partCount:(unsigned long long)arg33 dateEdited:(id)arg34;
- (bool)isAlert;
- (bool)isAudioMessage;
- (bool)isAutoReply;
- (bool)isBeingRetried;
