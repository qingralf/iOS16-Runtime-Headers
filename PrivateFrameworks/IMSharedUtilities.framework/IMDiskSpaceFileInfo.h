...
- (id)guid;
- (id)initWithPath:(id)arg1 fileSize:(struct IMFileSize { unsigned long long x1; unsigned long long x2; })arg2 isDirectory:(bool)arg3 isAttachment:(bool)arg4 isSticker:(bool)arg5 isPurgableOnDisk:(bool)arg6;
- (bool)isAttachment;
- (bool)isDirectory;
