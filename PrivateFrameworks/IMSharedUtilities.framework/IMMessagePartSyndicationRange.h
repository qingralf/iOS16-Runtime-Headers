...
- (id)initWithSyndicationType:(long long)arg1 messagePartRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 syndicationStartDate:(id)arg3 syndicationStatus:(long long)arg4;
