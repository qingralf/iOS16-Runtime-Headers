...
@property (nonatomic, readonly) NSURL *requestedRemoteUIURL;
@property (nonatomic, retain) NSURL *requestedRemoteUIURL;
...
- (id)bannerSpecificationForReason:(id)arg1 bundleId:(id)arg2;
- (id)bundleIdentifier;
...
- (void)setRequestedRemoteUIURL:(id)arg1;
