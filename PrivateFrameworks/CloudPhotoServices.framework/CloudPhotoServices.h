...
+ (bool)_createVideoResourcesFromInputURL:(id)arg1 withItemScopedIdentifier:(id)arg2 videoAdjustments:(id)arg3 resourceType:(unsigned long long)arg4 forIris:(bool)arg5 destinationDirectory:(id)arg6 outputResources:(id)arg7 error:(id*)arg8;
...
+ (void)_generateImageDerivativeResourcesFromInputResource:(id)arg1 destinationDirectory:(id)arg2 isAdjusted:(bool)arg3 derivativesFilter:(id)arg4 recordChangeType:(unsigned long long)arg5 completionHandler:(id /* block */)arg6;
+ (void)_generateVideoDerivativeResourcesFromInputResource:(id)arg1 withCPLAdjustments:(id)arg2 destinationDirectory:(id)arg3 derivativesFilter:(id)arg4 recordChangeType:(unsigned long long)arg5 includePosterFrame:(bool)arg6 completionHandler:(id /* block */)arg7;
...
+ (void)generateDerivativeResourcesFromInputResource:(id)arg1 withAdjustments:(id)arg2 destinationDirectory:(id)arg3 derivativesFilter:(id)arg4 recordChangeType:(unsigned long long)arg5 includePosterFrameForVideo:(bool)arg6 completionHandler:(id /* block */)arg7;
+ (void)generateDerivativeResourcesFromInputResource:(id)arg1 withAdjustments:(id)arg2 destinationDirectory:(id)arg3 includePosterFrameForVideo:(bool)arg4 completionHandler:(id /* block */)arg5;
