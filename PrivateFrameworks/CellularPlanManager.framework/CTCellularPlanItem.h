...
- (id)iccid;
- (id)identifier;
- (id)initWithCellularPlan:(id)arg1 uuid:(id)arg2 iccid:(id)arg3 name:(id)arg4 type:(long long)arg5 phoneNumber:(id)arg6 label:(id)arg7 isLocalTransferToeSIMSupported:(bool)arg8 isTransferred:(bool)arg9 transferredStatus:(long long)arg10 transferredToDeviceDisplayName:(id)arg11 supportedTransferOption:(unsigned long long)arg12;
- (id)initWithCellularPlan:(id)arg1 uuid:(id)arg2 type:(long long)arg3 phoneNumber:(id)arg4 label:(id)arg5 transferredStatus:(long long)arg6 transferredToDeviceDisplayName:(id)arg7 supportedTransferOption:(unsigned long long)arg8;
- (id)initWithCoder:(id)arg1;
- (id)initWithIccid:(id)arg1 uuid:(id)arg2 name:(id)arg3 phoneNumber:(id)arg4 label:(id)arg5 isLocalTransferToeSIMSupported:(bool)arg6 isTransferred:(bool)arg7 transferredStatus:(long long)arg8 transferredToDeviceDisplayName:(id)arg9 supportedTransferOption:(unsigned long long)arg10;
