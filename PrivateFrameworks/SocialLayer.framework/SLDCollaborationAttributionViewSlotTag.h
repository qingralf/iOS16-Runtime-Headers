...
+ (id)displayNameForAttribution:(id)arg1;
+ (id)displayNamesForPersons:(id)arg1;
+ (id)placeholderTagForMaxWidth:(double)arg1;
+ (id)recipientsForAttribution:(id)arg1;
+ (bool)supportsSecureCoding;
+ (id)tagForTitle:(id)arg1 attributions:(id)arg2 maxWidth:(double)arg3 variant:(long long)arg4;
...
- (id)initWithTitle:(id)arg1 attributions:(id)arg2 maxWidth:(double)arg3 variant:(long long)arg4 isPlaceholder:(bool)arg5;
