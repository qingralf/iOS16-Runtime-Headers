...
- (void).cxx_destruct;
- (id)_lineRegionFromTextFeature:(id)arg1 imageSize:(struct CGSize { double x1; double x2; })arg2 titleFeature:(id)arg3 title:(id*)arg4;
- (id)_lineRegionsFromTextFeatures:(id)arg1 imageSize:(struct CGSize { double x1; double x2; })arg2 titleFeature:(id)arg3 title:(id*)arg4;
- (id)_regionsFromTextFeatures:(id)arg1 imageSize:(struct CGSize { double x1; double x2; })arg2 titleFeature:(id)arg3 title:(id*)arg4;
- (void)cancel;
