...
@property (nonatomic, retain) UILayoutGuide *letterKeyGuide;
...
- (id)constraintsForStringKeys:(id)arg1 inRowGuide:(id)arg2 matchingLetterGuide:(id)arg3 splitIndex:(long long)arg4;
...
- (void)setLetterKeyGuide:(id)arg1;
