...
- (id)initWithAttachmentDictionary:(id)arg1 recipientConservativeDictionary:(id)arg2 recipientDictionary:(id)arg3 nicknameDictionary:(id)arg4 followUpOnOutgoingMailsQuestionsDictionary:(id)arg5 followUpOnOutgoingMailsAsksDictionary:(id)arg6 followUpOnIncomingMailsDictionary:(id)arg7;
- (id)nickname;
- (id)recipient;
