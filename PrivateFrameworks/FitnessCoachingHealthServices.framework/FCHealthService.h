...
@interface FCHealthService : NSObject <FCGoalCompletionCoordinatorDelegate, FCGoalProgressCoordinatorDelegate, FCMoveModeCoordinatorDelegate, HDHealthDaemonReadyObserver> {
