...
@interface FCGoalProgressCoordinator : NSObject <FCCXPCActivitySchedulerDelegate, FCGoalProgressDebouncerDelegate, FCGoalProgressEvaluationDelegate, HDDatabaseProtectedDataObserver, HDHealthDaemonReadyObserver> {
