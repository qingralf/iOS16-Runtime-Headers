...
@property (getter=isWaitingForPostCommitHandlerToUpdateContextId, nonatomic) bool waitingForPostCommitHandlerToUpdateContextId;
...
- (bool)isWaitingForPostCommitHandlerToUpdateContextId;
- (id)keyColor;
- (id)launchURL;
- (id)leadingView;
...
- (void)setWaitingForPostCommitHandlerToUpdateContextId:(bool)arg1;
