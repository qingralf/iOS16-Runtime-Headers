...
@property (nonatomic, readonly, copy) NSString *presenceIdenfifier;
...
- (void)assertPresenceForIdentifier:(id)arg1 completion:(id /* block */)arg2;
- (id)clientConnection;
...
- (void)registerForDelegateCallbacksWithPresenceIdentifier:(id)arg1 completion:(id /* block */)arg2;
