...
- (id)_existingChannelsForPresenceIdentifier:(id)arg1 databaseContext:(id)arg2;
...
- (id)createPresenceChannelForPresenceIdentifier:(id)arg1 channelIdentifier:(id)arg2 channelToken:(id)arg3 peerKey:(id)arg4 serverKey:(id)arg5 membershipKey:(id)arg6 databaseContext:(id)arg7;
...
- (id)existingChannelForPresenceIdentifier:(id)arg1 databaseContext:(id)arg2;
