...
- (void)assertPresence:(id)arg1 onChannel:(id)arg2 membershipKey:(id)arg3 serverKey:(id)arg4 timestamp:(id)arg5 withChannelToken:(id)arg6 isRefresh:(bool)arg7 completion:(id /* block */)arg8;
- (void)createChannelWithCompletion:(id /* block */)arg1;
- (void)createPresenceChannelWithMembershipKey:(id)arg1 serverKey:(id)arg2 completion:(id /* block */)arg3;
- (id)delegate;
...
- (void)pollActiveParticipantsForChannel:(id)arg1 membershipKey:(id)arg2 serverKey:(id)arg3 withChannelToken:(id)arg4 completion:(id /* block */)arg5;
...
- (void)releasePresenceOnChannel:(id)arg1 membershipKey:(id)arg2 serverKey:(id)arg3 timestamp:(id)arg4 withChannelToken:(id)arg5 completion:(id /* block */)arg6;
- (id)serverTime;
