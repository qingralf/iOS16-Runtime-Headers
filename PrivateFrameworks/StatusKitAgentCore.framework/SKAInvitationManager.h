...
- (void)rollPresenceChannelWithPresenceIdentifier:(id)arg1 completion:(id /* block */)arg2;
...
- (void)sendInvitationForPresenceChannelWithPresenceIdentifier:(id)arg1 toHandles:(id)arg2 fromSenderHandle:(id)arg3 completion:(id /* block */)arg4;
