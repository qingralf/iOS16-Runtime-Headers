...
@interface QLItem : NSObject <NSSecureCoding, QLPreviewItemPrivateProtocol, QLTExtensionThumbnailItem> {
    ...
    FPSandboxingURLWrapper * _temporaryEditionDirectoryURLWrapper;
...
@property (nonatomic, retain) FPSandboxingURLWrapper *temporaryEditionDirectoryURLWrapper;
...
- (void)setTemporaryEditionDirectoryURLWrapper:(id)arg1;
