...
- (void)encodeBackwarpLossWithFlowMagnitudeToCommandBuffer:(id)arg1 first:(id)arg2 second:(id)arg3 flow:(id)arg4 timeScale:(float)arg5 gamma:(float)arg6 destination:(id)arg7;
