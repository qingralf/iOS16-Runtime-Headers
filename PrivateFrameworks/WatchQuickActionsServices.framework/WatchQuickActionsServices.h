...
- (void)_sendAsyncMessageToServer:(id)arg1 withIdentifier:(long long)arg2 completion:(id /* block */)arg3;
- (id)_sendMessageToServer:(id)arg1 withIdentifier:(long long)arg2;
- (id)_sendMessageToServer:(id)arg1 withIdentifier:(long long)arg2 error:(id*)arg3;
