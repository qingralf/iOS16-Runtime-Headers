...
- (id)configuration;
- (id)configurePrivateData:(id)arg1 confidentialData:(id)arg2 contaclessPersistentVisibility:(id)arg3 wiredPersistentVisibility:(id)arg4 nfcExpressOnlyInLPM:(id)arg5;
