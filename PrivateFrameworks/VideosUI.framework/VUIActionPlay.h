...
@property (nonatomic, retain) VUIActionPlayParams *actionPlayParams;
...
+ (void)_playMediaInfo:(id)arg1 watchType:(long long)arg2 extrasInfo:(id)arg3 isRentAndWatchNow:(bool)arg4 completion:(id /* block */)arg5;
+ (void)_playPlayables:(id)arg1 appContext:(id)arg2 watchType:(long long)arg3 isUpNextPlayback:(bool)arg4 userPlaybackInitiationDate:(id)arg5 openURLCompletionDate:(id)arg6;
+ (void)_presentPlaybackWithMediaInfo:(id)arg1 extrasInfo:(id)arg2 allowsCellular:(bool)arg3 completion:(id /* block */)arg4;
...
- (id)initWithMediaInfo:(id)arg1 watchType:(long long)arg2 isRentAndWatchNow:(bool)arg3 completion:(id /* block */)arg4;
- (bool)isAccountRequired;
- (bool)isUpNextPlayback;
- (id)openURLCompletionDate;
- (void)performWithTargetResponder:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)setActionPlayParams:(id)arg1;
