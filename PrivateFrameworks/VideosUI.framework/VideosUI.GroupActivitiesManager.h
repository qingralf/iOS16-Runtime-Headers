...
@interface VideosUI.GroupActivitiesManager : NSObject <VUIGroupActivitiesManagerDelegate> {
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  _associateSceneIdentifier;
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  _isSessionActive;
    union { in /* Warning: Unrecognized filer type: 'u' using 'void*' */ void*x1; long x2; long x3; }  _sceneIdentifier;
...
- (id)itemProviderForActivityWithSharedWatchId:(id)arg1 sharedWatchUrl:(id)arg2 previewMetadata:(id)arg3;
- (void)leaveSession;
