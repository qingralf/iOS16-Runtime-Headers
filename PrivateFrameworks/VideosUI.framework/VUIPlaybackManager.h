...
@interface VUIPlaybackManager : NSObject <AVPlayerViewControllerDelegatePrivate, VUINowPlayingFeatureMonitorDelegate, VUIPlaybackContainerViewControllerDelegate, VUIPostPlayViewDelegate, VideosExtrasContextDelegate> {
...
- (void)playbackContainerVieControllerDidAutoPlay:(id)arg1;
