...
- (id)_createSessionForPlayer_Legacy:(id)arg1;
...
- (void)_playerCurrentMediaItemWillSeek_Legacy:(id)arg1;
- (void)_reportForSession:(id)arg1 state:(id)arg2 reason:(id)arg3;
- (void)_reportForSession_Legacy:(id)arg1 state:(id)arg2 reason:(id)arg3;
...
- (void)_reportSeekStopAtTimeInMS_Legacy:(unsigned long long)arg1 playbackDate:(id)arg2 session:(id)arg3 tracker:(id)arg4 player:(id)arg5;
- (id)_screenInfo;
...
- (id)_trackerWithBaseEventDataForSession_Legacy:(id)arg1;
