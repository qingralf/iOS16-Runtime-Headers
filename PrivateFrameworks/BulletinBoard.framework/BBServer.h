...
@interface BBServer : NSObject <AFSiriAnnouncementRequestCapabilityObserving, BBDataProviderManagerDelegate, BBMuteExpirationManagerDelegate, BBSectionAuthorizationManagerDelegate, BBServerConduitServerInterface, BBSettingsGatewayServerInterface, BBSyncServiceDelegate, NSXPCListenerDelegate> {
