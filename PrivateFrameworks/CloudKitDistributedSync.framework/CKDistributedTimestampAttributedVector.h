...
@property (nonatomic, readonly) NSDictionary *attributeToSparseVector;
@property (nonatomic, retain) NSMutableDictionary *mutableAttributeToSparseVector;
...
- (void)setMutableAttributeToSparseVector:(id)arg1;
