...
- (void)_presentCellularOutrankAlertForNetwork:(id)arg1;
...
- (void)networkListViewController:(id)arg1 setCompatibilityModeEnabled:(bool)arg2;
...
- (bool)networkListViewControllerCompatibilityModeEnabled:(bool)arg1;
- (bool)networkListViewControllerCompatibilityModeIsVisible:(bool)arg1;
