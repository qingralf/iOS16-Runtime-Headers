...
@interface WFInterface : NSObject {
    ...
    WFNetworkScanRecord * _mobileWiFiCurrentNetwork;
...
@property (nonatomic, retain) WFNetworkScanRecord *mobileWiFiCurrentNetwork;
...
- (void)setMobileWiFiCurrentNetwork:(id)arg1;
