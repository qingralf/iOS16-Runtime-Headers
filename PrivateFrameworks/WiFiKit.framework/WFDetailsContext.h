...
@interface WFDetailsContext : NSObject <WFContextPresenting, WFDetailsProviderContext> {
    ...
    NetworkQualityExecutions * _networkQualityExecution;
...
@property (getter=isAutoJoinConfigurable, nonatomic) bool autoJoinConfigurable;
...
@property (nonatomic, retain) NetworkQualityExecutions *networkQualityExecution;
...
- (id)initWithNetwork:(id)arg1 profile:(id)arg2 ipMonitor:(id)arg3 privateMACConfig:(id)arg4 wifiModeConfig:(id)arg5;
- (id)ipMonitor;
- (bool)isAutoJoinConfigurable;
...
- (void)setNetworkQualityExecution:(id)arg1;
