...
@interface TVRUIRemoteViewController : UIViewController <SBSHardwareButtonEventConsuming, TVRAlertControllerDelegate, TVRUIContentPresenter, TVRUIDeviceDelegate, TVRUIDevicePickerDelegate, TVRUIDeviceSearchDelegate, _TVRUIEventDelegate> {
