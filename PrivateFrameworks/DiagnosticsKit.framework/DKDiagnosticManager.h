...
@interface DKDiagnosticManager : NSObject <DKAccessoryResponder, DKAssetResponder, DKBrightnessResponder, DKPluginReloadResponder, DKRequestViewControllerDelegate, DKVolumeHUDResponder> {
