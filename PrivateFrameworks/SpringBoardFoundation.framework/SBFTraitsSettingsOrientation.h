...
@interface SBFTraitsSettingsOrientation : NSObject <BSDescriptionProviding, NSCopying, NSMutableCopying> {
    long long  _orientation;
    <BSInterfaceOrientationMapResolving><BSXPCSecureCoding> * _orientationMapResolver;
    SBFTraitsArbitrationDeviceOrientationInputs * _rawOrientationInputs;
    SBFTraitsArbitrationDeviceOrientationInputs * _validatedOrientationInputs;
}
