...
@interface SBFTraitsOrientationResolutionPolicyInfo : NSObject <BSDescriptionProviding, NSCopying> {
...
@property (nonatomic, copy) SBFTraitsSettingsActuationContext *actuationContext;
