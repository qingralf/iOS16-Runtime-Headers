...
@interface PSUICellularController : PSListController <CoreTelephonyClientCellularPlanManagementDelegate, CoreTelephonyClientSubscriberDelegate, TSSIMSetupDelegate> {
