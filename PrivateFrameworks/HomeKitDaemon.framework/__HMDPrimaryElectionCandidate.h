...
- (id)initWithVersion:(id)arg1 deviceIdentifier:(id)arg2 name:(id)arg3 currentPrimaryIdentifier:(id)arg4 enabledAsResident:(bool)arg5 supportsPingRequest:(bool)arg6 connectionType:(unsigned long long)arg7 pcsEnabled:(bool)arg8;
- (id)name;
- (bool)pcsEnabled;
