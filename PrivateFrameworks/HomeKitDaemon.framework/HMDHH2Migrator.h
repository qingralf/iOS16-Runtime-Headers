...
- (void)_saveSharedUserAccessCodeOnOutgoingInvitation:(id)arg1 context:(id)arg2;
...
- (id)homeData;
- (id)init;
- (id)initWithMigratorRecord:(id)arg1 coreData:(id)arg2 cloudTransform:(id)arg3 backgroundOperationManager:(id)arg4 defaultDatabase:(id)arg5 cameraClipsDatabase:(id)arg6;
