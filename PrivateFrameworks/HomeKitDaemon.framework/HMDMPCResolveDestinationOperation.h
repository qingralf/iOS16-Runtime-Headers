...
- (id)initWithHashedRouteIDs:(id)arg1 mediaApplicationDestination:(long long)arg2 forceSingleGroup:(bool)arg3 completion:(id /* block */)arg4 remoteControlDestinationFactory:(id)arg5;
- (void)main;
