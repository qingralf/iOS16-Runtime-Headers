...
- (id)home;
- (id)initWithUUID:(id)arg1 workQueue:(id)arg2 home:(id)arg3 user:(id)arg4;
- (id)initWithUUID:(id)arg1 workQueue:(id)arg2 home:(id)arg3 user:(id)arg4 context:(id)arg5 residentSyncManager:(id)arg6 notificationCenter:(id)arg7;
