...
- (id)initWithDatabase:(id)arg1 isOwnedTrust:(bool)arg2 queue:(id)arg3 shareMessenger:(id)arg4 ownerCloudShareID:(id)arg5 logEventSumbitter:(id)arg6 dailyScheduler:(id)arg7;
- (bool)isFromOwner;
