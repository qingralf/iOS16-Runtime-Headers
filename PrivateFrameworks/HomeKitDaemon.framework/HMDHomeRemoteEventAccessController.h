...
- (bool)isMediaGroupUUID:(id)arg1 error:(id*)arg2;
- (bool)isMediaSystemUUID:(id)arg1 error:(id*)arg2;
- (bool)isSiriEndpointAccessoryUUID:(id)arg1 error:(id*)arg2;
- (bool)remoteEventAllowForMediaGroupSettingEventTopic:(id)arg1 deviceType:(unsigned long long)arg2 userType:(unsigned long long)arg3;
