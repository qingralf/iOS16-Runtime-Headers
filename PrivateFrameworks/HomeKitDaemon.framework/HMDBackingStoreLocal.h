...
@interface HMDBackingStoreLocal : HMFObject <HMFLogging> {
    ...
    bool  _isTransactionReplayFeatureEnabled;
...
- (id)initWithDB:(id)arg1 migrate:(bool)arg2 shouldEnableTransactionReplayMode:(bool)arg3 error:(id*)arg4;
- (id)initWithDatastore:(id)arg1;
- (id)initWithDatastore:(id)arg1 shouldEnableTransactionReplayMode:(bool)arg2;
- (bool)isTransactionReplayFeatureEnabled;
- (id)logIdentifier;
