...
- (id)cameraAccessModeBulletinRegistrationWithDeviceIdsIdentifier:(id)arg1 context:(id)arg2;
- (id)cameraReachabilityBulletinRegistrationWithDeviceIdsIdentifier:(id)arg1 context:(id)arg2;
- (id)cameraSignificantEventBulletinRegistrationWithDeviceIdsIdentifier:(id)arg1 context:(id)arg2;
...
- (id)pairedUsers;
- (id)predicateToFetchBulletinRegistrationOnDeviceIdsIdentifier:(id)arg1;
