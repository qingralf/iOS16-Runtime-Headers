...
@interface HMDHomeManager : HMFObject <HAPFragmentationStreamDelegate, HMDAccessoryBrowserManagerDelegate, HMDBackingStoreObjectProtocol, HMDBiomeLogEventObserverDataSource, HMDBiomeMigrationManagerDataSource, HMDCapabilitiesControllerDataSource, HMDCloudManagerDelegate, HMDCompositeSettingsControllerManagerDataSource, HMDDeviceSetupSessionDelegate, HMDDuetPredictionSubscriberDataSource, HMDIDSServerBagDelegate, HMDMediaGroupParticipantLocalDataStorageDataSource, HMDMicroLocationLogEventObserverDataSource, HMDMobileAssetManagerDelegate, HMDMultiUserSettingsMetricsEventDispatcherDataSource, HMDMultiUserStatusControllerDelegate, HMDPairedSyncDelegate, HMDSiriEndpointOnboardingManagerDataSource, HMDSiriEndpointProfileMessageHandlerDataSource, HMDSiriEndpointSettingsSyncManagerDataSource, HMDSyncOperationManagerDataSource, HMDUserManagementOperationDelegate, HMDXPCEventRouterServerDataSource, HMEDelegatingEventRouterDataSource, HMEMemoryEventBusDataSource, HMFLogging, HMFMessageReceiver, HMFNetMonitorDelegate, HMFTimerDelegate> {
    ...
    bool  _switchingToHH2AsSharedUser;
...
@property (nonatomic) bool switchingToHH2AsSharedUser;
...
- (void)setSwitchingToHH2AsSharedUser:(bool)arg1;
...
- (bool)switchingToHH2AsSharedUser;
- (id)syncManager;
