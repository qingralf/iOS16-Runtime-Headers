...
- (void)_createAudioDestinationControllerWithControllerIdentifier:(id)arg1;
- (void)_createAudioDestinationWithIdentifier:(id)arg1 supportedOptions:(unsigned long long)arg2;
