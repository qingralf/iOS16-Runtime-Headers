...
+ (void)_markHome:(id)arg1 asNeedingWalletKeyRollAfterHH2Migration:(bool)arg2;
+ (id)homekitErrorWithPassLibraryError:(id)arg1;
+ (id)logCategory;
+ (id)preferenceKeyForShouldRollWalletKeyAfterHH2MigrationForHomeUUID:(id)arg1;
...
- (id)uuid;
- (void)walletDidEnableAddingPassesForPassLibrary:(id)arg1;
