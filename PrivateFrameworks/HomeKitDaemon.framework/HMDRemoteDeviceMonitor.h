...
@interface HMDRemoteDeviceMonitor : HMFObject <HMDIDSActivityMonitorObserverDelegate, HMDIDSServiceDelegate, HMDModernTransportDeviceReachabilityObserverListener, HMDRemoteDeviceMonitorFactory, HMFLogging, HMFNetMonitorDelegate, HMFTimerDelegate, IDSAccountDelegate, IDSAccountRegistrationDelegate> {
...
- (void)start;
- (void)startMonitoringDevice:(id)arg1 withInitialReachability:(id)arg2;
