...
@interface HMDHAPAccessory : HMDAccessory <CHIPAccessoryServerDelegate, HAPAccessoryDelegate, HAPAccessoryServerNotification, HMDAccessoryMinimumUserPrivilegeCapable, HMDAccessoryUserManagement, HMDServiceOwner, HMDSiriEndpointProfileMetricsDispatcherDataSource, HMDSiriEndpointProfileMetricsDispatcherFactory, HMFTimerDelegate> {
...
- (id)accessCodeCache;
- (void)accessory:(id)arg1 didUpdateConnectionState:(bool)arg2;
...
- (void)postUpdateEventsIfDifferentWithPerferredMediaUUID:(id)arg1 selectionType:(unsigned long long)arg2;
