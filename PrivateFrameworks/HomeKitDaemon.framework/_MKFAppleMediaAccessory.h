...
- (id)_analysisPredicateToFetchBulletinRegistrationOnDeviceIdsIdentifier:(id)arg1;
- (id)actionsAppleMediaAccessoryPower;
- (id)analysisBulletinRegistrationWithDeviceIdsIdentifier:(id)arg1 context:(id)arg2;
