...
- (void)_setUpUMServerXPCConnectionIfNeeded:(id)arg1 isOutgoingConnection:(bool)arg2;
...
- (bool)dataMigrationSetup:(id)arg1 WithPasscode:(id)arg2 withError:(id*)arg3;
- (bool)deleteSecureBackupBlobwithError:(id*)arg1;
...
- (bool)isLoginWindowWithError:(id*)arg1;
...
- (void)setSe:(id)arg1;
- (bool)setSecureBackupBlob:(id)arg1 withError:(id*)arg2;
...
- (bool)switchToLoginWindowWithError:(id*)arg1;
