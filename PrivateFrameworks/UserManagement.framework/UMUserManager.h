...
@interface UMUserManager : NSObject <UMUserManagement, UMUserPersonaAttributesList, UMUserPersonaLoginSessionManagement, UMUserPersonaManagement, UMUserSessionProvisioning, UMUserSwitchManagement, UMUserVolumeMigration> {
    NSArray * _allUsers;
