...
+ (id)_trimOnlyCompositionControllerFor:(id)arg1 keepOrientationAdjustment:(bool)arg2;
+ (void)burnInTrimToNewAsset:(id)arg1 compositionController:(id)arg2 asShotCompositionController:(id)arg3 cinematographyScript:(id)arg4 keepOrientationAdjustmentForRender:(bool)arg5 queue:(id)arg6 completion:(id /* block */)arg7;
