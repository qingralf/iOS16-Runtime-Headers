...
- (void)postRecipeResponse:(id)arg1 recipeID:(id)arg2 bundleIdentifier:(id)arg3 uploadTransport:(id)arg4 completion:(id /* block */)arg5;
...
- (bool)submitLogWithJSONResult:(id)arg1 requestObject:(id)arg2 recipe:(id)arg3 error:(id*)arg4;
- (id)systemMetaData;
...
- (void)uploadViaLegacyRouteWithResult:(id)arg1 recipe:(id)arg2 uploadTransport:(id)arg3 error:(id)arg4 completion:(id /* block */)arg5;
