...
@interface BrowserWindowController : NSObject <CloudTabStoreDelegate, _SFNavigationIntentHandling> {
    ...
    <WBStateProvider> * _stateProvider;
...
@property (nonatomic, readonly) <WBStateProvider> *stateProvider;
...
- (id)initWithStateProvider:(id)arg1 tabGroupManager:(id)arg2;
- (id)initWithStateProvider:(id)arg1 tabGroupManager:(id)arg2 perSitePreferencesVendor:(id)arg3 shouldMergeAllWindowsIfNeeded:(bool)arg4 browserControllerUIDelegateProvider:(id /* block */)arg5;
