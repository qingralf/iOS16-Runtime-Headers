...
@interface BrowserRootViewController : UIViewController <CapsuleNavigationBarViewControllerDelegate, SFCapsuleCollectionViewGestureObserving, SFOrderedContainerViewDelegate, SidebarContentDimmingViewDelegate, TabBarDropExpansionViewDelegate, TabDocumentViewGeometryProviding, TabOverviewThemeProviding, UIGestureRecognizerDelegate, UIViewControllerStatusBarPartStyleProvider, _SFDigitalHealthHostingViewController> {
    ...
    SFWebExtensionEnabledRemotelyBanner * _remotelyEnabledExtensionBanner;
    ...
    bool  _statusBarIsScrolledOffScreen;
    ...
    SFWebExtensionPermissionBanner * _webExtensionBanner;
    _SFWebView * _webView;
...
@property (nonatomic, retain) SFPinnableBanner *crashBanner;
...
@property (nonatomic, retain) SFWebExtensionEnabledRemotelyBanner *remotelyEnabledExtensionBanner;
...
@property (nonatomic, retain) SFPinnableBanner *tabGroupBanner;
@property (nonatomic, readonly) TabHoverPreview *tabHoverPreview;
@property (nonatomic) UIView<TabThumbnailCollectionView> *tabThumbnailCollectionView;
...
@property (nonatomic, retain) SFWebExtensionPermissionBanner *webExtensionBanner;
...
- (bool)_bannerIsSeparableFromStatusBar:(id)arg1;
...
- (bool)statusBarIsScrolledOffScreen;
- (id)statusBarView;
- (void)stopRefreshing;
- (id)tabBar;
