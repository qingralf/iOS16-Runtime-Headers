...
@interface BookmarksNavigationController : UINavigationController <BookmarksTableViewControllerDelegate, HistoryTableViewControllerDelegate, ReadingListViewControllerDelegate, UINavigationBarDelegate, UINavigationControllerDelegate, WBTabGroupManagerObserver, _SFBookmarkInfoViewControllerDelegate, _SFNavigationIntentHandling> {
    bool  _allowsEditing;
