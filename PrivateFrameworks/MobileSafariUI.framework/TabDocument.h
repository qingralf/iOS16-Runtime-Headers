...
@interface TabDocument : NSObject <LoadableResource, LoadingControllerDelegate, QuickWebsiteSearchEventListener, ReadingListMetadataProvider, SFAppBannerMetaTagContentObserver, SFAppSuggestionBannerDelegate, SFDialogControllerDelegate, SFDialogPresenting, SFDialogViewControllerPresenting, SFFormAutoFillControllerDelegate, SFHighlightAttributionPresenter, WBReusableTab, WBSFluidProgressControllerWindowDelegate, WBSFluidProgressStateSource, WBSOrderedTab, WBSTabItemSearchSupport, WBSTranslationConsentAlertHelperDelegate, WBSTranslationContextDelegate, WBSWebExtensionTab, WBTabGroupSyncAgentSyncObserver, WKNavigationDelegatePrivate, WKUIDelegatePrivate, _SFAutoFillContextProviding, _SFBrowserDocument, _SFDownloadDelegate, _SFLinkPreviewHandler, _SFMediaRecordingDocument, _SFNavigationIntentHandling, _SFPageLoadErrorControllerDelegate, _SFPrintControllerDelegate, _SFQuickLookDocumentSource, _SFReaderControllerDelegate, _SFWebViewDelegate, _WKAppHighlightDelegate, _WKDiagnosticLoggingDelegate, _WKFindDelegate, _WKFullscreenDelegate, _WKIconLoadingDelegate, _WKInputDelegate, _WKWebAuthenticationPanelDelegate> {
...
@property (nonatomic, readonly) bool canChangeSearchFieldPosition;
...
@property (nonatomic, readonly) _UIFindInteraction *findInteraction;
...
@property (nonatomic, copy) NSString *titleForLastUserInitiatedLoad;
...
@property (nonatomic, copy) NSURL *urlForLastUserInitiatedLoad;
...
- (bool)isMediaSuspendedForScreenTime;
- (bool)isMuted;
- (bool)isPDFDocument;
...
- (void)loadURL:(id)arg1 title:(id)arg2 deferNavigationWhenNotActive:(bool)arg3;
...
- (void)setIsMediaSuspendedForScreenTime:(bool)arg1;
...
- (void)setTitleForLastUserInitiatedLoad:(id)arg1;
...
- (void)setUrlForLastUserInitiatedLoad:(id)arg1;
...
- (id)titleForLastUserInitiatedLoad;
...
- (id)urlForExtensions;
- (id)urlForLastUserInitiatedLoad;
- (id)userActivity;
