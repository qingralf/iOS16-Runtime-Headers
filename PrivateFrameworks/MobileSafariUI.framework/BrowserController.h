...
@interface BrowserController : SFBrowserController <ActionPanelDelegate, AddBookmarkActivityDelegate, BookmarksBarViewDelegate, BookmarksNavigationControllerDelegate, BrowserRootViewControllerDelegate, CatalogViewControllerDelegate, CloudTabsViewControllerDelegate, CompletionDetailViewControllerDelegate, ContinuousReadingViewControllerDelegate, DownloadOpenHandler, LibraryItemOpenHandler, LinkPreviewProvider, QLPreviewControllerDelegate, SFBrowserControllerProxy, SFBrowserKeyCommandSafariMethods, SFOverlayProviderDelegate, SFSiriLinkActionPerformer, SFToastViewControllerDelegate, SKStoreProductViewControllerDelegate, StartPageDataSource, TabBarManagerObserving, TabControllerDocumentObserving, TabDocumentDelegate, TabOverviewPresentationObserving, TabSnapshotGeneratorDelegate, UIActivityItemsConfigurationProviding, UIAdaptivePresentationControllerDelegate, UICloudSharingControllerDelegate, UIGestureRecognizerDelegatePrivate, UIScreenshotServiceDelegate, UIScrollViewDelegate, UITextFieldDelegate, UIWindowSceneDelegate, WBSDigitalHealthManagerDelegate, WBSUnifiedBarAnalyticsProviding, WBSWebExtensionCommandHandling, WBTabGroupSyncAgentSyncObserver, _SFBarManagerDelegate, _SFBrowserContentController, _SFDigitalHealthViewControllerDelegate, _SFDynamicBarAnimatorDelegate, _SFMailContentProviderDataSource, _SFNavigationBarDelegate, _SFNavigationIntentHandling, _SFSaveToFilesOperationDelegate, _SFSingleBookmarkNavigationControllerDelegate> {
    NSUUID * _UUID;
...
@property (nonatomic, readonly, copy) NSString *searchCountKey;
...
@property (nonatomic, readonly) bool shouldUseRegularWidthTabViewAppearance;
...
- (bool)dismissTransientUIAnimated:(bool)arg1 preserveFavoritesState:(bool)arg2;
...
- (bool)shouldUseRegularWidthTabViewAppearance;
- (void)showBars;
...
- (void)tabControllerDidSwitchTabGroups:(id)arg1;
