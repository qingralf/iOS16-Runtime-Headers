...
@interface TabController : NSObject <PinnedTabsObserving, SFTabHoverPreviewControllerDelegate, TabBarDelegate, TabBarManagerObserving, TabDocumentDragDropDataSource, TabGroupProvider, TabOverviewDelegate, TabSnapshotCacheDelegate, UITextFieldDelegate, WBSTabGroupConfirmationAlertDelegate, WBSTabOrderProvider, WBTabGroupManagerObserver, WBTabGroupSyncAgentSyncObserver> {
...
@property (nonatomic, readonly) NSArray *syncedTabGroups;
@property (nonatomic) TabBar *tabBar;
@property (nonatomic) TabBarManager *tabBarManager;
@property (nonatomic, readonly) UIView<TabCollectionView> *tabCollectionView;
...
@property (nonatomic, readonly) UIView<TabThumbnailCollectionView> *tabThumbnailCollectionView;
...
- (id)contextMenuConfigurationForTabGroup:(id)arg1 forPickerSheet:(bool)arg2;
...
- (id)menuForTabGroup:(id)arg1 forPickerSheet:(bool)arg2 forEditMode:(bool)arg3;
- (id)moveLocalTabsToNewGroupTitle;
- (void)moveTab:(id)arg1 fromTabGroup:(id)arg2 toTabGroup:(id)arg3 overTab:(id)arg4;
...
- (id)tabGroupManager;
- (void)tabGroupManager:(id)arg1 didPerformBlockUpdatesForTabGroup:(id)arg2;
- (void)tabGroupManager:(id)arg1 didRemoveTabGroup:(id)arg2;
- (void)tabGroupManager:(id)arg1 didUpdateTab:(id)arg2 userDriven:(bool)arg3;
- (void)tabGroupManager:(id)arg1 didUpdateTabGroup:(id)arg2;
- (void)tabGroupManager:(id)arg1 didUpdateTabsInTabGroup:(id)arg2;
- (void)tabGroupManager:(id)arg1 willPerformBlockUpdatesForTabGroup:(id)arg2;
...
- (id)tabGroups;
- (id)tabGroupsMenuElementsWithOptions:(unsigned long long)arg1 newTabGroupName:(id)arg2 hostTitle:(id)arg3 descendantCount:(long long)arg4 movingSelectedTab:(id)arg5 actionHandler:(id /* block */)arg6;
...
- (bool)tabOverviewShouldReserveSpaceForSidebarButton:(id)arg1;
