...
- (id)idsService;
- (id)init;
- (id)initWithiMessageService:(id)arg1 bizChatService:(id)arg2 incomingMessageHandler:(id)arg3 messageStore:(id)arg4 chatRegistry:(id)arg5 accountController:(id)arg6 messageSuppressionController:(id)arg7 storageController:(id)arg8 recentsController:(id)arg9 attachmentStore:(id)arg10;
