...
@interface IMTextMessagePipelineParameter : NSObject <IMFindChatProcessingParameter, IMMessageFromStorageParameter, IMMessageLegacyProcessingParameter, IMMessageMomentShareProcessingParameter, IMTextMessageProcessingParameter> {
    NSString * _GUID;
...
+ (id)convertBlastdoorTypedAttributesToNativeTypesInAttributedString:(id)arg1 supportingStickerAttributes:(bool)arg2 existingFileTransfersForMessage:(id)arg3;
