...
@interface IMDChatRegistry : NSObject <IMSystemMonitorListener, TUConversationManagerDelegate> {
...
- (id)personCentricGroupedChatsArrayWithMaximumNumberOfChats:(long long)arg1 skipsLastMessageLoading:(bool)arg2 usingChats:(id)arg3 useCachedChatGroups:(bool)arg4 includingPinnedChatIdentifiers:(id)arg5;
