...
- (void)_addTransfer:(id)arg1 forGUID:(id)arg2 shouldNotify:(bool)arg3 forceNotify:(bool)arg4;
...
- (void)_postUpdated:(id)arg1 forceNotify:(bool)arg2;
...
- (bool)_shouldDownloadAssetForTransferCK:(id)arg1 forMessageItem:(id)arg2;
- (bool)_shouldUpdateSyncStats:(id)arg1 originalSyncState:(long long)arg2;
- (bool)_shouldUpdateSyncStatsCK:(id)arg1 originalSyncState:(long long)arg2;
- (id)_statsCollector;
...
- (void)_updateSyncStatsForAttachmentsCK:(id)arg1 incrementTotalAttachmentCount:(unsigned long long)arg2;
...
- (void)addTransfer:(id)arg1 forGUID:(id)arg2 forceNotify:(bool)arg3;
...
- (void)markTransferAsNotSuccessfullyDownloadedFromCloudCK:(id)arg1;
- (void)markTransferAsNotSyncedSuccessfully:(id)arg1;
- (void)markTransferAsNotSyncedSuccessfullyCK:(id)arg1;
...
- (void)resetSyncStateForRecordCK:(id)arg1 toState:(long long)arg2;
...
- (id)updateTransfersWithCKRecordCK:(id)arg1 recordWasFetched:(bool)arg2 downloadAsset:(bool*)arg3;
