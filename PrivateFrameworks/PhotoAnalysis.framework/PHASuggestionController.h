...
- (bool)existingWallpaperSuggestion:(id)arg1 matchesSuggestion:(id)arg2;
- (id)existingWallpaperSuggestionByKeyAssetUUIDWithSubtypes:(id)arg1;
...
- (void)processWallpaperSuggestions:(id)arg1 forRecyclingWithExistingWallpaperSuggestionByKeyAssetUUID:(id)arg2 resultBlock:(id /* block */)arg3;
