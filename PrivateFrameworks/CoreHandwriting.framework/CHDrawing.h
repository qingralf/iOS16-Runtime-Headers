...
@property (nonatomic) /* Warning: unhandled struct encoding: '{CHDrawingStrokes={vector<std::vector<double>' */ struct  drawing; /* unknown property attribute:  std::allocator<int>>=^i}}} */
...
- (struct CHDrawingStrokes { struct vector<std::vector<double>, std::allocator<std::vector<double>>> { void *x_1_1_1; void *x_1_1_2; struct __compressed_pair<std::vector<double> *, std::allocator<std::vector<double>>> { void *x_3_2_1; } x_1_1_3; } x1; struct vector<bool, std::allocator<bool>> { unsigned long long *x_2_1_1; unsigned long long x_2_1_2; struct __compressed_pair<unsigned long, std::allocator<unsigned long>> { unsigned long long x_3_2_1; } x_2_1_3; } x2; struct vector<double, std::allocator<double>> { double *x_3_1_1; double *x_3_1_2; struct __compressed_pair<double *, std::allocator<double>> { double *x_3_2_1; } x_3_1_3; } x3; struct vector<double, std::allocator<double>> { double *x_4_1_1; double *x_4_1_2; struct __compressed_pair<double *, std::allocator<double>> { double *x_3_2_1; } x_4_1_3; } x4; struct vector<std::vector<double>, std::allocator<std::vector<double>>> { void *x_5_1_1; void *x_5_1_2; struct __compressed_pair<std::vector<double> *, std::allocator<std::vector<double>>> { void *x_3_2_1; } x_5_1_3; } x5; long long x6; })drawing;
...
- (void)setDrawing:(struct CHDrawingStrokes { struct vector<std::vector<double>, std::allocator<std::vector<double>>> { void *x_1_1_1; void *x_1_1_2; struct __compressed_pair<std::vector<double> *, std::allocator<std::vector<double>>> { void *x_3_2_1; } x_1_1_3; } x1; struct vector<bool, std::allocator<bool>> { unsigned long long *x_2_1_1; unsigned long long x_2_1_2; struct __compressed_pair<unsigned long, std::allocator<unsigned long>> { unsigned long long x_3_2_1; } x_2_1_3; } x2; struct vector<double, std::allocator<double>> { double *x_3_1_1; double *x_3_1_2; struct __compressed_pair<double *, std::allocator<double>> { double *x_3_2_1; } x_3_1_3; } x3; struct vector<double, std::allocator<double>> { double *x_4_1_1; double *x_4_1_2; struct __compressed_pair<double *, std::allocator<double>> { double *x_3_2_1; } x_4_1_3; } x4; struct vector<std::vector<double>, std::allocator<std::vector<double>>> { void *x_5_1_1; void *x_5_1_2; struct __compressed_pair<std::vector<double> *, std::allocator<std::vector<double>>> { void *x_3_2_1; } x_5_1_3; } x5; long long x6; })arg1;
