...
@property (nonatomic, readonly) /* Warning: unhandled struct encoding: '{vector<std::map<long' */ struct  _resampledDrawingPointMap; /* unknown property attribute:  long>>>=^v}} */
...
- (struct vector<std::map<long, long>, std::allocator<std::map<long, long>>> { void *x1; void *x2; struct __compressed_pair<std::map<long, long> *, std::allocator<std::map<long, long>>> { void *x_3_1_1; } x3; })_resampledDrawingPointMap;
