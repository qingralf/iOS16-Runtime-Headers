...
@property (nonatomic, readonly) NSMutableArray *_activeTasks;
@property (nonatomic) unsigned long long _changeCoalescingIndex;
@property (nonatomic, readonly) NSMutableArray *_changeObservers;
@property (nonatomic, readonly) NSMutableDictionary *_correctionRecognizersByLocalesKey;
@property (setter=_setHasUnprocessedChanges:, nonatomic) bool _hasUnprocessedChanges;
@property (nonatomic, readonly) NSObject<OS_dispatch_queue> *_highResponsivenessQueue;
@property (nonatomic, readonly) NSMutableArray *_inputDrawingClients;
@property (setter=_setLatestTextInputTargets:, retain) NSArray *_latestTextInputTargets;
@property (nonatomic, readonly) NSMutableDictionary *_recognizersByLocaleID;
@property (nonatomic, readonly) NSObject<OS_dispatch_queue> *_sessionQueue;
...
@property (nonatomic, readonly) NSObject<OS_dispatch_queue> *_tasksWorkQueue;
...
@property (nonatomic, readonly) CHStrokeClassificationModel *strokeClassificationModel;
...
- (id)_contextResultForContextStrokes:(id)arg1 outStrokeGroupingResult:(id*)arg2 outStrokeClassificationResult:(id*)arg3 shouldCancel:(id /* block */)arg4;
