...
- (void)editMessage:(id)arg1 atPartIndex:(long long)arg2 withNewPartText:(id)arg3 backwardCompatabilityText:(id)arg4;
...
- (void)hasKnownParticipantsWithCompletion:(id /* block */)arg1;
...
- (void)resendEditedMessage:(id)arg1 forPartIndex:(long long)arg2 withBackwardCompatabilityText:(id)arg3;
...
- (void)validatePeerStatus:(id /* block */)arg1;
