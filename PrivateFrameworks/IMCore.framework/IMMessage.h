...
+ (id)editedMessageWithOriginalMessage:(id)arg1 editedPartIndex:(long long)arg2 newPartText:(id)arg3;
+ (id)editedMessageWithOriginalMessage:(id)arg1 originalPrefixedGUID:(id)arg2 newBody:(id)arg3;
+ (id)editedMessageWithOriginalMessage:(id)arg1 retractedPartIndex:(long long)arg2 shouldRetractSubject:(bool)arg3;
...
- (id)_imMessageItem;
- (id)_initWithSender:(id)arg1 time:(id)arg2 timeRead:(id)arg3 timeDelivered:(id)arg4 timePlayed:(id)arg5 plainText:(id)arg6 text:(id)arg7 messageSubject:(id)arg8 fileTransferGUIDs:(id)arg9 flags:(unsigned long long)arg10 error:(id)arg11 guid:(id)arg12 messageID:(long long)arg13 subject:(id)arg14 balloonBundleID:(id)arg15 payloadData:(id)arg16 expressiveSendStyleID:(id)arg17 timeExpressiveSendPlayed:(id)arg18 associatedMessageGUID:(id)arg19 associatedMessageType:(long long)arg20 associatedMessageRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg21 messageSummaryInfo:(id)arg22 threadIdentifier:(id)arg23 dateEdited:(id)arg24;
