...
@property (nonatomic, retain) NSMutableDictionary *queryCompletionBlocks;
...
@property (nonatomic, retain) NSMutableArray *waitingForQueries;
...
- (void)_chat:(id)arg1 resendEditedMessage:(id)arg2 partIndex:(long long)arg3 withBackwardCompatabilityText:(id)arg4;
- (void)_chat:(id)arg1 retryGroupPhotoUpload:(id)arg2;
- (void)_chat:(id)arg1 sendEditedMessage:(id)arg2 previousMessage:(id)arg3 partIndex:(long long)arg4 editType:(unsigned long long)arg5 backwardCompatabilityText:(id)arg6;
...
- (void)setQueryCompletionBlocks:(id)arg1;
...
- (void)setWaitingForQueries:(id)arg1;
