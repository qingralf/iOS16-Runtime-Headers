...
@interface _TtC11ActivityKitP33_53EEA475F928A92791709C064B1A8B959Singleton : NSObject <ActivityKit.ActivityProminenceObservationServiceXPCClient> {
...
- (void).cxx_destruct;
- (void)activityProminenceDidChangeWithProminences:(id)arg1 completion:(id /* block */)arg2;
- (id)init;
