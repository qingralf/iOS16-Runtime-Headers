...
@interface _TtC11ActivityKitP33_37102ADAD4FB4DA90D1EB342A548B6909Singleton : NSObject <ActivityKit.ActivityPresentationObservationServiceXPCClient> {
...
- (void).cxx_destruct;
- (void)activityPresentationsDidChangeWithPresentations:(id)arg1 completion:(id /* block */)arg2;
- (id)init;
