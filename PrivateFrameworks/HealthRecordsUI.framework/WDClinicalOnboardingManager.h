...
@property (nonatomic) UINavigationController *inFlightClinicalSharingLoginViewController;
@property (nonatomic) WDClinicalOnboardingOAuthNavigationViewController *inFlightLoginViewController;
@property (nonatomic) UINavigationController *onboardingTileNavigationController;
