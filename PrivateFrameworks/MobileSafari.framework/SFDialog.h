...
+ (id)webExtensionAlwaysAllowDialogWithExtensionName:(id)arg1 domains:(id)arg2 includeDenyButton:(bool)arg3 completionHandler:(id /* block */)arg4;
+ (id)webExtensionPermissionDialogWithExtensionName:(id)arg1 domains:(id)arg2 callingAPIName:(id)arg3 showMoreOptionsForAlwaysAllow:(bool)arg4 includeDenyButton:(bool)arg5 completionHandler:(id /* block */)arg6;
