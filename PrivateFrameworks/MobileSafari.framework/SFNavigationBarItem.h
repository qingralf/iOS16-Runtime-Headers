...
@property (nonatomic, retain) NSString *extensionsAvailabilityText;
...
@property (nonatomic, readonly) bool showsExtensionsAvailabilityText;
...
- (void)setExtensionsAvailabilityText:(id)arg1;
