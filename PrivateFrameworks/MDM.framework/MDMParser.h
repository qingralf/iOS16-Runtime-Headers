...
- (void)_checkBackupManagers:(id)arg1 withCompletion:(id /* block */)arg2;
...
- (void)_installApplicationAfterRestoreCheck:(id)arg1 assertion:(id)arg2 completionBlock:(id /* block */)arg3;
...
- (void)_isCloudBackupInProgressWithCompletion:(id /* block */)arg1;
