...
@interface QLThumbnailUTICache : NSObject {
    ...
    NSMutableDictionary * _dataItemUseExtensionCache;
    NSMutableDictionary * _itemTypeCache;
    NSObject<OS_dispatch_queue> * _synchronizationQueue;
    NSMutableDictionary * _useExtensionCache;
}

@property (nonatomic, retain) NSMutableDictionary *dataItemTypeCache;
@property (nonatomic, retain) NSMutableDictionary *dataItemUseExtensionCache;
...
- (unsigned long long)_itemTypeByUTIResolutionForContentType:(id)arg1 isDataItem:(bool)arg2;
- (id)dataItemTypeCache;
- (id)dataItemUseExtensionCache;
- (id)init;
- (id)itemTypeCache;
- (unsigned long long)itemTypeForContentType:(id)arg1;
- (unsigned long long)itemTypeForContentType:(id)arg1 isDataItem:(bool)arg2;
- (unsigned long long)itemTypeForItem:(id)arg1;
- (bool)requestedBadgeType:(unsigned long long)arg1 isValidForContentType:(id)arg2;
- (void)setDataItemTypeCache:(id)arg1;
- (void)setDataItemUseExtensionCache:(id)arg1;
- (void)setItemTypeCache:(id)arg1;
- (void)setUseExtensionCache:(id)arg1;
- (id)useExtensionCache;
- (bool)useExtensionForContentType:(id)arg1 isDataItem:(bool)arg2;
- (bool)useExtensionForItem:(id)arg1;
- (bool)useExtensionUncachedForContentType:(id)arg1 isDataItem:(bool)arg2;
