...
- (id)description;
- (id)initFromMinAperture:(float)arg1 maxAperture:(float)arg2 aperture:(float)arg3 portraitStrength:(float)arg4 SDOFRenderingVersion:(unsigned long long)arg5 depthVersionInfo:(struct { int x1; int x2; })arg6;
- (id)maximumAperture;
- (id)minimumAperture;
