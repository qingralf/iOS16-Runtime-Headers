...
- (int)_measurePVPersonClusters:(id)arg1 groundTruthFaceCountPerPerson:(id)arg2 groundTruthPersonInformation:(id)arg3 groundTruthFaceToPerson:(id)arg4 groundTruthAssetToFaces:(id)arg5 measures:(id*)arg6 extendTimeoutBlock:(id /* block */)arg7 cancelBlock:(id /* block */)arg8;
...
- (bool)optInPerson:(id)arg1 error:(id*)arg2 extendTimeoutBlock:(id /* block */)arg3 cancelBlock:(id /* block */)arg4;
