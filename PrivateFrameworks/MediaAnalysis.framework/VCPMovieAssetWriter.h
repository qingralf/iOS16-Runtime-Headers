...
+ (id)assetWriterWithURL:(id)arg1 andTrack:(id)arg2 andBitrate:(long long)arg3;
...
- (int)finish;
- (id)initWithURL:(id)arg1 andTrack:(id)arg2 andBitrate:(long long)arg3;
...
- (int)setupVideoTrack:(long long)arg1;
- (long long)status;
