...
- (void)fetchPinningStatusForModelObject:(id)arg1 queue:(id)arg2 completionHandler:(id /* block */)arg3;
- (id)init;
...
- (bool)modelObjectIsManuallyPinned:(id)arg1;
- (void)pinAlbum:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)pinAudiobook:(id)arg1;
- (void)pinModelObject:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)unpinModelObject:(id)arg1 completionHandler:(id /* block */)arg2;
