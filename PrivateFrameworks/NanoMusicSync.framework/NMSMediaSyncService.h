...
- (void).cxx_destruct;
- (void)_callAndRemoveCompletionWithResult:(unsigned long long)arg1 idsMessageID:(id)arg2;
- (void)_cleanupCompletionWithID:(id)arg1;
...
- (id)_sendMessage:(id)arg1 messageType:(long long)arg2 timeout:(double)arg3 completion:(id /* block */)arg4;
- (id)_sendProtoBufForMessage:(id)arg1 messageType:(long long)arg2 timeout:(double)arg3;
- (bool)_sendServiceResponse:(unsigned long long)arg1 idsMessageID:(id)arg2 timeout:(double)arg3;
- (bool)_sendServiceResultMessage:(id)arg1 idsMessageID:(id)arg2 timeout:(double)arg3;
