...
@interface SignpostSupportObjectExtractor : NSObject {
    ...
    SignpostSupportSubsystemCategoryFilter * _metalSubsystemCategoryFilter;
...
@property (nonatomic, retain) SignpostSupportSubsystemCategoryFilter *metalSubsystemCategoryFilter;
...
- (void)setMetalSubsystemCategoryFilter:(id)arg1;
