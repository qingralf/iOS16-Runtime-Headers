...
- (struct opaqueCMSampleBuffer { }*)_sampleBufferFromVideo:(id)arg1 timestamp:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 size:(struct CGSize { double x1; double x2; })arg3 error:(id*)arg4;
