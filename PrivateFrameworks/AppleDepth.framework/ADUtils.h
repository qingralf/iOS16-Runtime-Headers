...
+ (long long)convertToLevelsConfidence:(struct __CVBuffer { }*)arg1 confidenceOutput:(struct __CVBuffer { }*)arg2 confidenceLowThreshold:(float)arg3 confidenceHighThreshold:(float)arg4 inverseThresholds:(bool)arg5;
...
+ (long long)postProcessConfidence:(struct __CVBuffer { }*)arg1 confidenceOutput:(struct __CVBuffer { }*)arg2 rawConfidenceUnits:(unsigned long long)arg3 outConfidenceUnits:(unsigned long long)arg4 confidenceLowThreshold:(float)arg5 confidenceHighThreshold:(float)arg6;
