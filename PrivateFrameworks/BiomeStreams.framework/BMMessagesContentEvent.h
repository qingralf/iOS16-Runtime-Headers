...
@interface BMMessagesContentEvent : NSObject <BMCommunicationsAccountContentEvent, BMIdentifiableContentEvent, BMProtoBufWrapper, BMStoreData, BMStreamValidating, BMStringContentContentEvent, NSSecureCoding> {
    NSURL * _URL;
