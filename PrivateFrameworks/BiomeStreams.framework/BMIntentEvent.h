...
@interface BMIntentEvent : BMEventBase <ATXShadowEventProtocol, BMEventAppAssociating, BMIdentifiable, BMProtoBufWrapper, BMPublicStreamEvent, BMStoreData, NSSecureCoding> {
