...
@interface BMMailContentEvent : NSObject <BMCommunicationsAccountContentEvent, BMIdentifiableContentEvent, BMProtoBufWrapper, BMStoreData, BMStreamValidating, NSSecureCoding> {
