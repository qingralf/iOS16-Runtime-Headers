...
- (void)computeTreatmentAssetIndexes:(id*)arg1 withAssociatedExperimentIds:(id*)arg2 andFactorPackAssetIds:(id*)arg3 withAssociatedRolloutDeployments:(id*)arg4 withExperimentFactorNames:(id*)arg5 andRolloutFactorNames:(id*)arg6 forFactors:(id)arg7 alwaysIncludingRolloutLayer:(bool)arg8 usingFilter:(id /* block */)arg9;
- (int)deploymentId;
- (void)dispose;
- (id)experimentId;
- (id)factorLevels;
