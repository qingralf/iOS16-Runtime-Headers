...
+ (id)detailTextForSuccessfulEnrollmentWithLocalizedDeviceClass:(id)arg1 organizationName:(id)arg2 organizationType:(long long)arg3;
+ (id)linkButtonTitle;
...
- (id)initSuccessfulEnrollmentInOrganizationName:(id)arg1 organizationType:(long long)arg2 localizedDeviceClass:(id)arg3;
