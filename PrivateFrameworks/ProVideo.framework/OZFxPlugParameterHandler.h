...
@interface OZFxPlugParameterHandler : NSObject <FxMixingAPI, FxOptionalParameterCreationAPI, FxOptionalParameterRetrievalAPI, FxOptionalParameterSettingAPI, FxParameterAPIPrivate, FxParameterCreationAPI, FxParameterCreationAPI_v2, FxParameterCreationAPI_v3, FxParameterRetrievalAPI, FxParameterRetrievalAPIPrivate, FxParameterRetrievalAPI_v2, FxParameterRetrievalAPI_v3, FxParameterSettingAPI, FxParameterSettingAPIPrivate, FxParameterSettingAPI_v2, FxParameterSettingAPI_v3, FxPlugAPIDelegate, FxRenderNotificationAPI, FxUndoAPI, OZFxPlugInternalParamAPI, PROAPIObject> {
    ...
    struct map<unsigned int, ParameterTransactionHelpers, std::less<unsigned int>, std::allocator<std::pair<const unsigned int, ParameterTransactionHelpers>>> { 
        struct __tree<std::__value_type<unsigned int, ParameterTransactionHelpers>, std::__map_value_compare<unsigned int, std::__value_type<unsigned int, ParameterTransactionHelpers>, std::less<unsigned int>, true>, std::allocator<std::__value_type<unsigned int, ParameterTransactionHelpers>>> { 
            void *__begin_node_; 
            ...
            struct __compressed_pair<unsigned long, std::__map_value_compare<unsigned int, std::__value_type<unsigned int, ParameterTransactionHelpers>, std::less<unsigned int>, true>> { 
    ...
    struct OZFxPlugRenderContextManager { 
        ...
        struct map<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>, std::less<_opaque_pthread_t *>, std::allocator<std::pair<_opaque_pthread_t *const, std::stack<OZFxPlugRenderContext *>>>> { 
            struct __tree<std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>, std::__map_value_compare<_opaque_pthread_t *, std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>, std::less<_opaque_pthread_t *>, true>, std::allocator<std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>>> { 
                ...
                struct __compressed_pair<unsigned long, std::__map_value_compare<_opaque_pthread_t *, std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>, std::less<_opaque_pthread_t *>, true>> { 
                    unsigned long long __value_; 
                } __pair3_; 
            } __tree_; 
        } _contexts; 
...
- (id)initWithBaseChannel:(void*)arg1;
- (id)initWithBaseChannel:(void*)arg1 andCopy:(id)arg2;
- (id)initWithBaseChannel:(void*)arg1 andCopy:(id)arg2 Skip:(int)arg3;
