...
- (id).cxx_construct;
- (void).cxx_destruct;
- (struct duration<long double, std::ratio<1, 1>> { long doublex1; })debounceInterval;
- (id)disabledVenues;
...
- (void)setDebounceInterval:(struct duration<long double, std::ratio<1, 1>> { long doublex1; })arg1;
...
- (void)setTilePrefetchActivityInterval:(struct duration<long long, std::ratio<1, 1>> { long long x1; })arg1;
...
- (void)setTilePrefetchRelevancyWindow:(struct duration<long long, std::ratio<1, 1>> { long long x1; })arg1;
- (void)setVenueGroupDistance:(double)arg1;
- (struct duration<long long, std::ratio<1, 1>> { long long x1; })tilePrefetchActivityInterval;
...
- (struct duration<long long, std::ratio<1, 1>> { long long x1; })tilePrefetchRelevancyWindow;
