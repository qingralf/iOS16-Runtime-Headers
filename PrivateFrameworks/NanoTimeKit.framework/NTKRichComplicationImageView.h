...
@interface NTKRichComplicationImageView : UIView <CLKMonochromeComplicationView, CLKMonochromeFilterProvider, NTKRichComplicationTintedPlatterColorOverridable> {
    CLKDevice * _device;
