...
@interface NTKDualTimeView : UIView <NTKTimeView> {
    ...
    UIView * _digitalTicksContainerView;
...
@property (nonatomic, readonly) CALayer *digitalTicksContainer;
@property (nonatomic, readonly) UIView *digitalTicksContainerView;
