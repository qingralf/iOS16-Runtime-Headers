...
- (id)initWithValue:(id)arg1 valueProvider:(id /* block */)arg2 valueUpdater:(id /* block */)arg3 generation:(id)arg4 deviceIdentifier:(id)arg5;
- (id)initWithValueProvider:(id /* block */)arg1 valueUpdater:(id /* block */)arg2 generation:(id)arg3 deviceIdentifier:(id)arg4;
