...
- (id)_knownUsernamesWithPasswordsForURL:(id)arg1;
...
- (id)exactFQDNAndHighLevelDomainSavedAccountMatchesForForm:(id)arg1 atURL:(id)arg2 webFrameIdentifier:(id)arg3;
...
- (id)lastUsedUsernameWithPasswordForURL:(id)arg1;
...
- (void)savedAccountMatchesWithCriteria:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)bestUsernameSuggestionForUsernamePromptOnURL:(id)arg1 completionHandler:(id /* block */)arg2;
