...
+ (id)_collectDeadSymlinksForManagedDir:(id)arg1 withLockWitness:(const struct TRIFlockWitness_ { int x1; }*)arg2 liveSymlinkCount:(unsigned int*)arg3;
...
+ (bool)_removePaths:(id)arg1 withLockWitness:(const struct TRIFlockWitness_ { int x1; }*)arg2 numRemoved:(unsigned int*)arg3;
+ (id)_reverseLinksDirForManagedDir:(id)arg1;
+ (bool)_testDeletionEligibilityForManagedDir:(id)arg1 withExternalReferenceStore:(id)arg2 flockWitness:(const struct TRIFlockWitness_ { int x1; }*)arg3 logPrefix:(id)arg4 isEligible:(bool*)arg5;
