...
- (void).cxx_destruct;
- (bool)_cleanupWithLinksDirLockWitness:(const struct TRIFlockWitness_ { int x1; }*)arg1 externalReferenceStore:(id)arg2;
- (id)_collectRelativeLinkPathsWithLinksDirLockWitness:(const struct TRIFlockWitness_ { int x1; }*)arg1;
- (id)_deferredDeletedLinksDir;
- (id)_linkPathForDeferredDeletedItemAtPath:(id)arg1;
- (bool)collectGarbageWithRootDirLockWitness:(const struct TRIFlockWitness_ { int x1; }*)arg1 externalReferenceStore:(id)arg2;
