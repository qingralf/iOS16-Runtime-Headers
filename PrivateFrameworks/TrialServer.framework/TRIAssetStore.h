...
- (bool)_linkDirectoryAssetWithIdentifier:(id)arg1 toCurrentPath:(id)arg2 futurePath:(id)arg3 flockWitness:(const struct TRIFlockWitness_ { int x1; }*)arg4;
- (bool)_linkFileAssetWithIdentifier:(id)arg1 toCurrentPath:(id)arg2 futurePath:(id)arg3 flockWitness:(const struct TRIFlockWitness_ { int x1; }*)arg4;
...
- (struct { unsigned char x1; })_saveDirectoryAssetWithIdentifier:(id)arg1 assetFilename:(id)arg2 metadata:(id)arg3 flockWitness:(const struct TRIFlockWitness_ { int x1; }*)arg4 error:(id*)arg5;
- (bool)_saveFileAssetWithIdentifier:(id)arg1 assetFilename:(id)arg2 flockWitness:(const struct TRIFlockWitness_ { int x1; }*)arg3;
- (bool)_saveFileAssetWithIdentifier:(id)arg1 assetFilename:(id)arg2 workingTempDirectory:(id)arg3 flockWitness:(const struct TRIFlockWitness_ { int x1; }*)arg4;
- (id)assetOperator;
...
- (unsigned long long)removableAssetsSizeOlderThanNumScans:(unsigned int)arg1 ignoreRecentlyCreatedAssets:(bool)arg2 linkTargetsToIgnoreByAssetId:(id)arg3 deleteableAssetIds:(id*)arg4;
