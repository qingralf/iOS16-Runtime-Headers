...
+ (id)recordWithParentId:(id)arg1 factorPackSetId:(id)arg2 deploymentId:(int)arg3 osBuild:(id)arg4 languageCode:(id)arg5 regionCode:(id)arg6 carrierBundleIdentifier:(id)arg7 carrierCountryIsoCode:(id)arg8;
...
- (id)init;
- (id)initWithParentId:(id)arg1 factorPackSetId:(id)arg2 deploymentId:(int)arg3 osBuild:(id)arg4 languageCode:(id)arg5 regionCode:(id)arg6 carrierBundleIdentifier:(id)arg7 carrierCountryIsoCode:(id)arg8;
