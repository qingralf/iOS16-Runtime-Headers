...
- (bool)_deleteOnDemandAssetsWithIndexes:(id)arg1 treatment:(id)arg2 forRollouts:(bool)arg3;
- (id)_linkAssetWithId:(id)arg1 treatmentId:(id)arg2 assetStore:(id)arg3 factor:(id)arg4 forRollouts:(bool)arg5;
- (bool)_linkAssetsUpdatingTreatment:(id)arg1 forRollouts:(bool)arg2;
...
- (id)updateSavedTreatmentWithTreatmentId:(id)arg1 deletingAssetsIndexes:(id)arg2 forNamespaceNames:(id)arg3 forRollouts:(bool)arg4;
