...
+ (id)taskWithExperimentId:(id)arg1 deploymentId:(int)arg2 failOnUnrecognizedExperiment:(bool)arg3 triggerEvent:(unsigned long long)arg4;
+ (id)taskWithExperimentId:(id)arg1 deploymentId:(int)arg2 startTime:(id)arg3 failOnUnrecognizedExperiment:(bool)arg4 triggerEvent:(unsigned long long)arg5;
