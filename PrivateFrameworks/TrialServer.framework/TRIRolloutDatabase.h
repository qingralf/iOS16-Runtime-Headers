...
- (bool)activateDeployment:(id)arg1 withFactorPackSetId:(id)arg2 targetingRuleIndex:(id)arg3 deactivatedDeployments:(id)arg4 deactivatedFactorPackSetIds:(id)arg5 usingTransaction:(id)arg6;
- (bool)addNewRolloutWithRecord:(id)arg1;
- (bool)deactivateDeployment:(id)arg1 usingTransaction:(id)arg2;
- (bool)deactivateDeploymentsWithRolloutId:(id)arg1 deactivatedDeployment:(id*)arg2 deactivatedFactorPackSetId:(id*)arg3 usingTransaction:(id)arg4;
...
- (bool)targetDeployment:(id)arg1 toFactorPackSetId:(id)arg2 targetingRuleIndex:(id)arg3 usingTransaction:(id)arg4;
