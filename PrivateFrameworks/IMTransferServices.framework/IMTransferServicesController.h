...
- (void)generatePreviewForTransfer:(id)arg1 attachmentPath:(id)arg2 balloonBundleID:(id)arg3 isFromMe:(bool)arg4 completionBlock:(id /* block */)arg5;
- (void)receiveFileTransfer:(id)arg1 transferGUID:(id)arg2 topic:(id)arg3 path:(id)arg4 requestURLString:(id)arg5 ownerID:(id)arg6 signature:(id)arg7 decryptionKey:(id)arg8 fileSize:(unsigned long long)arg9 generatePreview:(bool)arg10 balloonBundleID:(id)arg11 isFromMe:(bool)arg12 progressBlock:(id /* block */)arg13 completionBlock:(id /* block */)arg14;
