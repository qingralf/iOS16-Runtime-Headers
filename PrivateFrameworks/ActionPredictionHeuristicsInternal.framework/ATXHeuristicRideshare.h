...
- (id)rideShareSuggestionActionForDestination:(id)arg1 heuristicDevice:(id)arg2 flightInformationSchema:(id)arg3 predictionReasons:(unsigned long long)arg4 score:(double)arg5 validFromStartDate:(id)arg6 validToEndDate:(id)arg7;
