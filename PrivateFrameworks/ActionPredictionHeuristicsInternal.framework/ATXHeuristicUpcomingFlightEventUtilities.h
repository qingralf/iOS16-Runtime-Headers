...
+ (id)weatherAtTravelDestinationSpotlightEntry:(id)arg1 schemaForFlight:(id)arg2 predictionReasons:(unsigned long long)arg3 score:(double)arg4 validStartDate:(id)arg5 validEndDate:(id)arg6;
