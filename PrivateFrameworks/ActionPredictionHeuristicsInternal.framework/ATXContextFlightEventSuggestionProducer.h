...
- (id)_suggestionForAirplaneModeWithStatus:(bool)arg1 predictionReasons:(unsigned long long)arg2 score:(double)arg3;
- (id)disableAirplaneModeWithPredictionReasons:(unsigned long long)arg1 score:(double)arg2;
- (id)enableAirplaneModeWithPredictionReasons:(unsigned long long)arg1 score:(double)arg2;
- (id)initWithTitle:(id)arg1 flightInformationSchema:(id)arg2 urlString:(id)arg3 teamIdentifier:(id)arg4 validFromStartDate:(id)arg5 validToEndDate:(id)arg6 alternateDestinationTitle:(id)arg7;
