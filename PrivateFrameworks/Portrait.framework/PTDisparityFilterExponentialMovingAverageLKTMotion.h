...
@interface PTDisparityFilterExponentialMovingAverageLKTMotion : NSObject <PTAbstractDisparityFilter> {
    ...
    <MTLComputePipelineState> * _temporalFilterExponentialMovingAverageLKTMotion;
    <MTLComputePipelineState> * _temporalFilterExponentialMovingAverageLKTMotionNormal;
    PTUtil * _util;
}
...
- (int)exponentialMovingAverageFilterNormal:(id)arg1 inDisplacement:(id)arg2 inNormalPrev:(id)arg3 inNormal:(id)arg4 outNormal:(id)arg5 updateCoefficient:(/* Warning: Unrecognized filer type: ' ' using 'void*' */ void*)arg6;
- (id)initFilter:(id)arg1;
- (id)initWithCommandQueue:(id)arg1 disparitySize:(struct { unsigned long long x1; unsigned long long x2; unsigned long long x3; })arg2 disparityFilteredSize:(struct { unsigned long long x1; unsigned long long x2; unsigned long long x3; })arg3 disparityPixelFormat:(unsigned long long)arg4 colorSize:(struct { unsigned long long x1; unsigned long long x2; unsigned long long x3; })arg5 colorPixelFormat:(unsigned long long)arg6 sensorPort:(id)arg7;
