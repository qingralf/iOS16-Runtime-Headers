...
@interface PTQualitySettings : NSObject {
    ...
    bool  _usePrecomputedGaussianNoise;
}
...
- (void)setDisableForegroundBlur:(bool)arg1;
...
- (void)setUsePrecomputedGaussianNoise:(bool)arg1;
- (void)updateDescription;
- (bool)useExportQualityNoise;
- (bool)usePrecomputedGaussianNoise;
