...
- (id)initWithDevice:(id)arg1 commandQueue:(id)arg2 inputSize:(struct { unsigned long long x1; unsigned long long x2; unsigned long long x3; })arg3 target:(id)arg4 rotateTargetPixelBuffer:(bool)arg5 sharedResources:(id)arg6;
- (id)pyramidRGBA;
