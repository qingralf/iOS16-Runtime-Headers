...
- (bool)bicubic;
- (id)dropHints;
- (id)initWithDevice:(id)arg1 library:(id)arg2 pipelineLibrary:(id)arg3 colorSize:(struct CGSize { double x1; double x2; })arg4 pixelFormat:(unsigned long long)arg5 skipFullSizeLayer:(bool)arg6 doFirstLevelGaussianDownsample:(bool)arg7 mipmapLevelCount:(int)arg8;
- (id)rgbaPyramid;
- (id)rgbaPyramidArray;
