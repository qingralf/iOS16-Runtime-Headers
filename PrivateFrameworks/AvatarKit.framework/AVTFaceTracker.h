...
- (void)stop;
- (void)stopRecording;
- (void)updateWithARFrame:(id)arg1 captureOrientation:(long long)arg2 interfaceOrientation:(long long)arg3 mirroredDepthData:(bool)arg4;
- (void)updateWithARFrame:(id)arg1 worldAlignment:(long long)arg2 fallBackDepthData:(id)arg3 captureOrientation:(long long)arg4 interfaceOrientation:(long long)arg5 mirroredDepthData:(bool)arg6;
