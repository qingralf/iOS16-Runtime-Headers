...
@interface AVTARMaskRenderer : NSObject {
    ...
    <SCNTechniqueSupport><SCNSceneRenderer> * _owner;
    bool  _ownerIsView;
...
- (bool)flipDepth;
- (id)init;
- (id)initWithOwner:(id)arg1 techniqueDidChangeHandler:(id /* block */)arg2;
...
- (void)updateMaskParametersWithNeckPivotNode:(id)arg1;
