...
- (void)_applyHeadPoseWithTrackingInfo:(const struct { double x1; bool x2; float x3[51]; float x4[51]; float x5[1]; float x6[1]; }*)arg1 gazeCorrection:(bool)arg2 pointOfView:(id)arg3;
