...
@interface WDElectrocardiogramOverviewViewController : HKTableViewController <HKFeatureStatusProvidingObserver, HKOnboardingSetupViewDelegate, HRElectrocardiogramOnboardingManagerDelegate, HRFeatureRegulatoryReenableFeatureActionDelegate, WDElectrocardiogramFilterDataProviderDelegate> {
