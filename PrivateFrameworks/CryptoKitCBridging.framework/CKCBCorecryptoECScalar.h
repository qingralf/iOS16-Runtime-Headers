...
@interface CKCBCorecryptoECScalar : NSObject {
    ...
    const struct ccec_cp { unsigned long long x1; unsigned long long x2; struct cczp_funcs {} *x3; unsigned long long x4[0]; } * _group;
}

@property (nonatomic, readonly) const unsigned long long*corecryptoScalar;
@property (nonatomic, readonly) const struct ccec_cp { unsigned long long x1; unsigned long long x2; struct cczp_funcs {} *x3; unsigned long long x4[0]; }*group;

- (id)add:(id)arg1 corecryptoError:(int*)arg2;
- (const unsigned long long*)corecryptoScalar;
- (void)dealloc;
- (const struct ccec_cp { unsigned long long x1; unsigned long long x2; struct cczp_funcs {} *x3; unsigned long long x4[0]; }*)group;
