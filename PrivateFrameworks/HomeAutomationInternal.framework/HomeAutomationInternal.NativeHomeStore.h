...
@interface HomeAutomationInternal.NativeHomeStore : NSObject <HMAccessoryDelegatePrivate, HMHomeDelegatePrivate, HMHomeManagerDelegatePrivate, HMMediaSystemDelegate> {
    void _homeManager;
