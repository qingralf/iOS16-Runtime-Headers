...
@interface MFMessageContentView : UIView <EFSignpostable, MFBlockedSenderBannerViewDelegate, MFHasMoreContentBannerViewDelegate, MFHideMyEmailBannerViewDelegate, MFLoadBlockedContentBannerViewDelegate, MFLoadFailedProxyContentBannerViewDelegate, MFMailDropBannerDelegate, MFMailWebProcessDelegate, MFMessageFooterViewDelegate, MFMessageHeaderViewDelegate, MFPresentationSource, MFReusable, UIPopoverPresentationControllerDelegate, UIScrollViewDelegate, WKNavigationDelegatePrivate, WKUIDelegatePrivate, _WKInputDelegate> {
    struct CGRect { 
        struct CGPoint { 
            double x; 
            double y; 
    ...
    <EFCancelable> * _bucketPreferenceToken;
...
@property (nonatomic, retain) <EFCancelable> *bucketPreferenceToken;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_convertDictionaryToRect:(id)arg1;
...
- (void)getCachedMetadataBoolForKey:(id)arg1 handler:(id /* block */)arg2;
...
- (void)setBucketPreferenceToken:(id)arg1;
