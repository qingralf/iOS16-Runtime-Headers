...
@interface FigCaptureStillImageSettings : NSObject <NSCopying, NSSecureCoding> {
    ...
    unsigned int  _downgradeOutputHeight;
    unsigned int  _downgradeOutputWidth;
...
- (void)setDowngradeOutputHeight:(unsigned int)arg1;
- (void)setDowngradeOutputWidth:(unsigned int)arg1;
