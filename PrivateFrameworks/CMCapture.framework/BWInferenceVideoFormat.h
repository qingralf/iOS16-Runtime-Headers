...
- (id)initWithUnderlyingFormat:(id)arg1 isDeviceOriented:(bool)arg2 videoContentMode:(long long)arg3 includesInvalidContent:(bool)arg4 cropDescriptor:(id)arg5 rotationDegrees:(int)arg6;
