...
- (void)processorController:(id)arg1 didFinishProcessingBuffer:(struct __CVBuffer { }*)arg2 metadata:(id)arg3 type:(unsigned long long)arg4 captureFrameFlags:(unsigned long long)arg5 rawThumbnailsBuffer:(struct __CVBuffer { }*)arg6 rawThumbnailsMetadata:(id)arg7 processorInput:(id)arg8 err:(int)arg9;
...
- (void)processorController:(id)arg1 didFinshProcessingInference:(id)arg2 inferenceAttachmentKey:(id)arg3 processorInput:(id)arg4 err:(int)arg5;
- (void)processorController:(id)arg1 didFinshProcessingInferenceBuffer:(struct __CVBuffer { }*)arg2 inferenceAttachedMediaKey:(id)arg3 processorInput:(id)arg4 err:(int)arg5;
