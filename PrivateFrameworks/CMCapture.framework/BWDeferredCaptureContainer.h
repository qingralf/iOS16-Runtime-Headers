...
- (int)commitBuffer:(struct __CVBuffer { }*)arg1 tag:(id)arg2 bufferType:(unsigned long long)arg3 captureFrameFlags:(unsigned long long)arg4 compressionProfile:(int)arg5 metadataTag:(id)arg6 rawThumbnailsBufferTag:(id)arg7 rawThumbnailsMetadataTag:(id)arg8 portType:(id)arg9;
