...
- (id)initWithDepthEnabled:(bool)arg1 numberOfInputs:(int)arg2 bufferSize:(int)arg3 numberOfSlaveFramesToSkip:(int)arg4 startEmittingMasterFramesBeforeSlaveStreamStarts:(bool)arg5;
- (id)nodeSubType;
- (id)nodeType;
