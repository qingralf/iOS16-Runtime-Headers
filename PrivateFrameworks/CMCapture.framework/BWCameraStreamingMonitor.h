...
- (void)setStreaming:(bool)arg1 deviceType:(int)arg2 portType:(id)arg3 clientAuditToken:(struct { unsigned int x1[8]; })arg4 tccIdentity:(id)arg5 completionHandler:(id /* block */)arg6;
