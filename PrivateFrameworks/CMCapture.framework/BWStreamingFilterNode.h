...
- (id)filters;
- (id)initWithCaptureDevice:(id)arg1 maxLossyCompressionLevel:(int)arg2 semanticStyleRenderingEnabled:(bool)arg3 cinematicVideoEnabled:(bool)arg4 portraitPreviewForegroundBlurEnabled:(bool)arg5;
