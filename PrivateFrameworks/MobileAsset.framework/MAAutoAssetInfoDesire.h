...
@property (nonatomic, readonly) MAAutoAssetPolicy *clientAssetPolicy;
@property (nonatomic, readonly) NSString *desireReason;
@property (nonatomic, readonly) bool downloadProgressDesired;
@property (nonatomic, readonly) long long lockWaitTimeoutSecs;
@property (nonatomic, readonly) NSString *updateCategoryDesiredByClient;
