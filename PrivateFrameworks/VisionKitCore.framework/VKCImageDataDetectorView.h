...
@property (nonatomic, retain) NSMutableSet *displayedMRCPills;
...
- (bool)highlightView:(id)arg1 needsToAdjustQuad:(id)arg2;
...
- (void)setDisplayedMRCPills:(id)arg1;
...
- (void)showMRCPills:(bool)arg1 animated:(bool)arg2;
