...
@interface VKCDataDetectorElementView : VKPlatformView <BCSActionDelegate, UIContextMenuInteractionDelegate, UIGestureRecognizerDelegate> {
...
- (bool)_axIsDataDetectorOfType:(unsigned long long)arg1;
