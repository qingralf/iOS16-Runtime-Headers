...
@interface VKCImageTextSelectionView_iOS : VKCImageTextSelectionView <UIDragInteractionDelegate, UIKeyInput, UIScribbleInteractionDelegatePrivate, UITextInput, UITextInputTraits_Private, UITextInteractionDelegate, VKCTextRecognitionResultTextDelegate, VKCTextSelectionLongPressHandlerDelegate, _UITextInputRevealItemProvider, _UITextInputTranslationSupport> {
...
@property (nonatomic) struct _NSRange { unsigned long long x1; unsigned long long x2; } preSelectionChangeSelectedRange;
...
- (id)markedTextRange;
- (id)markedTextStyle;
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })preSelectionChangeSelectedRange;
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })preSelectionChangeSelectedRangeForTextRecognitionResult:(id)arg1;
- (void)replaceRange:(id)arg1 withText:(id)arg2;
- (bool)scribbleInteraction:(id)arg1 shouldBeginAtLocation:(struct CGPoint { double x1; double x2; })arg2;
- (void)selectAll:(id)arg1;
- (bool)selectable;
- (id)selectedRange;
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })selectedRangeForTextRecognitionResult:(id)arg1;
...
- (void)setPreSelectionChangeSelectedRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
