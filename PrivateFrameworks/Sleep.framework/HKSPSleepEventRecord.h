...
@interface HKSPSleepEventRecord : NSObject <BSDescriptionProviding, HKSPDictionarySerializable, HKSPObject, HKSPOnboardingModel, HKSPXPCObject, NAEquatable, NAHashable, NSMutableCopying> {
