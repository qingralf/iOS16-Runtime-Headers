...
@interface HKSPSleepSchedule : NSObject <BSDescriptionProviding, HKSPDictionarySerializable, HKSPObject, HKSPXPCObject, NAEquatable, NAHashable, NSMutableCopying> {
    bool  _enabled;
