...
- (void).cxx_destruct;
- (id)_cachedFeatureSettingsModelWithError:(id*)arg1;
- (void)_cachedOnboardingModelWithCompletion:(id /* block */)arg1;
...
- (bool)_lock_updatedCachedFeatureSettingsModelWithError:(id*)arg1 didChange:(bool*)arg2;
- (bool)_lock_updatedCachedOnboardingModelWithError:(id*)arg1 didChange:(bool*)arg2;
...
- (void)_updatedCachedOnboardingModelWithCompletion:(id /* block */)arg1;
