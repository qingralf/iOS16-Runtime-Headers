...
@interface FASettingsSpecifierProvider : NSObject <AAUISpecifierProvider, FAFamilySettingsViewControllerDelegate, FASetupDelegate, FamilyCircleUI.FAFamilySettingsViewControllerV2Delegate, RemoteUIControllerDelegate> {
