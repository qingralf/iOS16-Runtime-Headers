...
- (id)initWithTableView:(id)arg1 ruiTableView:(id)arg2 pictureStore:(id)arg3 recommendations:(id)arg4 emergencyContacts:(id)arg5 context:(id)arg6 viewController:(id)arg7 suggester:(id)arg8;
