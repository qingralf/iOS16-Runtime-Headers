...
// Image: /System/Library/AccessibilityBundles/CoreIDVRGBLiveness.axbundle/CoreIDVRGBLiveness

+ (Class)safeCategoryBaseClass;

- (void)_axHandleAnnouncementMachine:(id)arg1 polite:(bool)arg2 moveToView:(bool)arg3;
