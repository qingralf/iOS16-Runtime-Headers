...
@interface HFHomeKitDispatcher : NSObject <HFHomeAppInstallStateArbiterObserver, HFHomeManagerCreatorDelegate, HFLocationSensingCoordinatorDelegate, HFStateRestorationSettingsObserver> {
    ...
    NADelegateDispatcher * _accessorySoftwareUpdateControllerV2ObserverDispatcher;
    ...
    HFHomeKitMediaGroupsController * _mediaGroupsController;
...
@property (nonatomic, retain) NADelegateDispatcher *accessorySoftwareUpdateControllerV2ObserverDispatcher;
...
@property (nonatomic, readonly) HFHomeKitMediaGroupsController *mediaGroupsController;
...
- (void)_setSoftwareUpateControllerV2ObservationEnabled:(bool)arg1;
...
- (id)accessorySoftwareUpdateControllerV2ObserverDispatcher;
- (void)addAccessoryObserver:(id)arg1;
- (void)addAccessorySoftwareUpdateControllerV2Observer:(id)arg1;
...
- (void)dispatchAccessorySoftwareUpdateControllerV2Message:(id /* block */)arg1 sender:(id)arg2;
...
- (void)removeAccessorySoftwareUpdateControllerV2Observer:(id)arg1;
...
- (void)setAccessorySoftwareUpdateControllerV2ObserverDispatcher:(id)arg1;
