...
@interface HFMediaAccessoryItem : HFItem <HFAccessoryRepresentableItem, HFActionBuilderFactory, HFHomeKitMediaGroupsControllerDelegate, HFMediaAccessoryLikeItem, HFMediaAccessoryProtocol, HUTintColorProviding> {
...
- (id)description;
- (void)didReceiveMediaGroup:(id)arg1;
