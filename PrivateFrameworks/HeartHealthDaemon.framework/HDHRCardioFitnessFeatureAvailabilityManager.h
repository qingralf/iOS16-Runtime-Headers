...
+ (id)makeRegionAvailabilityProviderWithProfile:(id)arg1 pairedDeviceCapabilityProvider:(id)arg2;
...
- (id)initWithProfile:(id)arg1 pairedDeviceCapabilityProvider:(id)arg2 regionAvailabilityProvider:(id)arg3 heartRateSettingsDefaults:(id)arg4;
- (id)initWithProfile:(id)arg1 pairedDeviceCapabilityProvider:(id)arg2 regionAvailabilityProvider:(id)arg3 heartRateSettingsDefaults:(id)arg4 featureAvailabilityManager:(id)arg5;
