...
- (void).cxx_destruct;
- (void)_setupElectrocardiogramRecordingWithProfile:(id)arg1 pairedDeviceCapabilityProvider:(id)arg2;
...
- (id)initWithProfile:(id)arg1 heartNotificationsUserDefaults:(id)arg2 capabilityProvider:(id)arg3;
