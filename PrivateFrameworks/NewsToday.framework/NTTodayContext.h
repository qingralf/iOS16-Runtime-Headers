...
@property (nonatomic, retain) <FCReadablePrivateDataStorage> *readablePrivateDataStorage;
...
@property (nonatomic, retain) <FCWritablePrivateDataStorage> *writablePrivateDataStorage;
