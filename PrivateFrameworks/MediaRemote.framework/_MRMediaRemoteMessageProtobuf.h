...
@interface _MRMediaRemoteMessageProtobuf : PBCodable <NSCopying> {
    ...
    _MRGetIsMutedMessageProtobuf * _getIsMutedMessage;
    _MRGetIsMutedResultMessageProtobuf * _getIsMutedResultMessage;
    ...
    _MRIsMutedDidChangeMessageProtobuf * _isMutedDidChangeMessage;
    ...
    _MRSetIsMutedMessageProtobuf * _setIsMutedMessage;
...
@property (nonatomic, retain) _MRGetIsMutedMessageProtobuf *getIsMutedMessage;
@property (nonatomic, retain) _MRGetIsMutedResultMessageProtobuf *getIsMutedResultMessage;
...
@property (nonatomic, readonly) bool hasGetIsMutedMessage;
@property (nonatomic, readonly) bool hasGetIsMutedResultMessage;
...
@property (nonatomic, readonly) bool hasIsMutedDidChangeMessage;
...
@property (nonatomic, readonly) bool hasSetIsMutedMessage;
...
@property (nonatomic, retain) _MRIsMutedDidChangeMessageProtobuf *isMutedDidChangeMessage;
...
@property (nonatomic, retain) _MRSetIsMutedMessageProtobuf *setIsMutedMessage;
...
- (id)genericMessage;
- (id)getIsMutedMessage;
- (id)getIsMutedResultMessage;
...
- (bool)hasGetIsMutedMessage;
- (bool)hasGetIsMutedResultMessage;
...
- (bool)hasIdentifier;
- (bool)hasIsMutedDidChangeMessage;
...
- (void)setGetIsMutedMessage:(id)arg1;
- (void)setGetIsMutedResultMessage:(id)arg1;
...
- (void)setIsMutedDidChangeMessage:(id)arg1;
- (id)setIsMutedMessage;
...
- (void)setSetIsMutedMessage:(id)arg1;
