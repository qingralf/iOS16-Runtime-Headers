...
@interface NPTResults : NSObject <NSCopying, NSSecureCoding> {
    ...
    NSDictionary * _networkQualityResults;
...
@property (nonatomic, retain) NSDictionary *networkQualityResults;
...
- (id)metadata;
- (id)networkQualityResults;
- (id)pingResults;
- (void)setDownloadResults:(id)arg1;
- (void)setMetadata:(id)arg1;
- (void)setNetworkQualityResults:(id)arg1;
