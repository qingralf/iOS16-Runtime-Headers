...
@property (getter=hasHitMaxLargeViewCount, nonatomic) bool hitMaxLargeViewCount;
@property (getter=hasHitMaxViewCount, nonatomic) bool hitMaxViewCount;
...
- (void)setHitMaxLargeViewCount:(bool)arg1;
- (void)setHitMaxViewCount:(bool)arg1;
