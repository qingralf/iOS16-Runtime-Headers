...
- (void)_performSendClientUpdateWithShippingMethods:(id)arg1 paymentSummaryItems:(id)arg2 multiTokenContexts:(id)arg3 recurringPaymentRequest:(id)arg4 automaticReloadPaymentRequest:(id)arg5 paymentApplication:(id)arg6 status:(long long)arg7;
...
- (void)_updateModelWithShippingMethods:(id)arg1 paymentSummaryItems:(id)arg2 multiTokenContexts:(id)arg3 recurringPaymentRequest:(id)arg4 automaticReloadPaymentRequest:(id)arg5 contentItems:(id)arg6;
