...
- (void)_forceFetchWebServiceContextWithCompletion:(id /* block */)arg1;
...
- (void)_updateSharedWebServiceContextWithCompletion:(id /* block */)arg1;
...
- (void)fetchWebServiceContextWithCompletion:(id /* block */)arg1;
