...
- (void)receivedAuthenticationResult:(unsigned long long)arg1 selectedOptionIdentifier:(id)arg2 error:(id)arg3;
...
- (void)startedAuthenticatingFinancingOptionIdentifier:(id)arg1;
