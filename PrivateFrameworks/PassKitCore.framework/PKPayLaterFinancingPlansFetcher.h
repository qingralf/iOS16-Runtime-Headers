...
+ (id)amountDueOverNext30DaysForFinancingPlans:(id)arg1 payLaterAccount:(id)arg2 totalPending:(id*)arg3 upcomingInstallments:(id*)arg4 upcomingInstallmentsIdentifierToFinancingPlan:(id*)arg5;
...
- (id)_sortedFinancingPlans:(id)arg1;
...
- (void)dealloc;
- (void)financingPlansWithStates:(id)arg1 completion:(id /* block */)arg2;
