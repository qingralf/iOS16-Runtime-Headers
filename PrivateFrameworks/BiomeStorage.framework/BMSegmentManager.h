...
- (id)fileHandleForFile:(id)arg1 createNewFile:(bool)arg2 error:(id*)arg3;
...
- (id)segmentWithFilename:(id)arg1 segmentNames:(id)arg2 segmentFileHandles:(id)arg3 createNewFile:(bool)arg4 error:(id*)arg5;
