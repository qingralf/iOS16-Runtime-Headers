...
- (void).cxx_destruct;
- (id)calculateDigestFromCHIPAccessoriesRecord:(id)arg1;
...
- (void)handleRemoteFetchRequestForCHIPAttestationCertificates:(id*)arg1 subjectKeyIdentifier:(id)arg2;
...
- (bool)processCHIPAccessoriesRecord:(id)arg1 productGroup:(id)arg2;
