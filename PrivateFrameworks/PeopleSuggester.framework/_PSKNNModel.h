...
@property (nonatomic, retain) NSArray *groupActivityInteractionCache;
...
- (id)filterBundleIds;
- (id)filterGroupActivityInteractionsWithMinimumOccurences:(unsigned long long)arg1 contextBundleId:(id)arg2 filterOutNonMatchingSourceBundleIDs:(bool)arg3;
...
- (id)groupActivityInteractionCache;
...
- (void)setGroupActivityInteractionCache:(id)arg1;
...
- (id)suggestionProxiesBasedOnExpanseInteractionsWithPredictionContext:(id)arg1 withOnlyTopCandidates:(bool)arg2 withFilterOutNonMatchingSourceBundleIDs:(bool)arg3;
