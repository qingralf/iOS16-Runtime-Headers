...
- (id)initWithConnectionInterface:(id)arg1 entityMangledTypeName:(id)arg2 completionHandler:(id /* block */)arg3;
- (id)initWithConnectionInterface:(id)arg1 entityType:(id)arg2 completionHandler:(id /* block */)arg3;
- (id)output;
