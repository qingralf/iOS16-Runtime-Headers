...
+ (bool)updateLovedPlaylistByAddingTrackWithPersistentID:(id)arg1 inLibrary:(id)arg2;
+ (bool)updateLovedPlaylistByRemovingTrackWithPersistentID:(id)arg1 inLibrary:(id)arg2;
