...
@property (nonatomic, retain) NSMutableSet *allDeviceContexts;
...
- (void)getLogicalDeviceScopedDaemonProxyCreatorForTestDeviceReference:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)getTestAdminDaemonProxyCreatorWithCompletionHandler:(id /* block */)arg1;
...
- (void)setAllDeviceContexts:(id)arg1;
