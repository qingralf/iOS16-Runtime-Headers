...
- (id)_copyStingrayIdentitiesForBackingMockAccount:(id)arg1 withError:(id*)arg2;
...
- (bool)_setStingrayIdentitySet:(struct _PCSIdentitySetData { }*)arg1 forServiceName:(id)arg2 backingMockAccount:(id)arg3 withError:(id*)arg4;
- (id)account;
