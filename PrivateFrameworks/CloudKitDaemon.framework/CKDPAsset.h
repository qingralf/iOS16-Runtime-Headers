...
@property (nonatomic, readonly) bool hasReservedVoucher;
...
@property (nonatomic, retain) CKDPReservedVoucher *reservedVoucher;
...
- (void)setReservedVoucher:(id)arg1;
