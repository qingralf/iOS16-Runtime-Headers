...
@property (nonatomic, retain) CKDContainer *strongContainer;
...
@property (nonatomic) CKDContainer *weakContainer;
...
- (void)updateMetric:(unsigned long long)arg1 withBlock:(id /* block */)arg2;
