...
@property (nonatomic, retain) NSRecursiveLock *deviceContextLock;
...
@property (nonatomic, readonly) CKDLogicalDeviceScopedClientProxy *logicalDeviceScopedClientProxy;
...
@property (nonatomic, readonly) CKDProcessScopedClientProxy *processScopedClientProxy;
...
@property (nonatomic, retain) CKDRecordCache *recordCache;
...
- (void)setDeviceContextLock:(id)arg1;
