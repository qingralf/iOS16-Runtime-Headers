...
- (void)_createPCSFromData:(id)arg1 ofType:(unsigned long long)arg2 usingPCSServiceType:(unsigned long long)arg3 tryDecryptingWithOtherServices:(bool)arg4 withSyncKeyRegistryRetry:(bool)arg5 zonePCSModificationDate:(id)arg6 completionHandler:(id /* block */)arg7;
...
- (void)_locked_checkIdentitiesForService:(unsigned long long)arg1 withSyncKeyRegistryRetry:(bool)arg2 keySyncAnalytics:(id)arg3 completionHandler:(id /* block */)arg4;
- (void)_locked_createPCSFromData:(id)arg1 ofType:(unsigned long long)arg2 usingPCSServiceType:(unsigned long long)arg3 tryDecryptingWithOtherServices:(bool)arg4 withSyncKeyRegistryRetry:(bool)arg5 zonePCSModificationDate:(id)arg6 keySyncAnalytics:(id)arg7 completionHandler:(id /* block */)arg8;
...
- (void)checkIdentitiesForService:(unsigned long long)arg1 withSyncKeyRegistryRetry:(bool)arg2 completionHandler:(id /* block */)arg3;
- (id)containerID;
...
- (id)rollMasterKeyForRecordPCS:(struct _OpaquePCSShareProtection { }*)arg1 bypassAllowlistedContainers:(bool)arg2;
...
- (id)updateZoneIdentityForPCS:(struct _OpaquePCSShareProtection { }*)arg1 usingZonePCS:(struct _OpaquePCSShareProtection { }*)arg2 bypassAllowlistedContainers:(bool)arg3;
- (bool)useZoneWidePCS;
...
- (bool)zonePCSNeedsKeyRolled:(struct _OpaquePCSShareProtection { }*)arg1 bypassAllowlistedContainers:(bool)arg2;
