...
- (bool)contactSatisfiesRelevanceCriteriaForSilenceList:(id)arg1;
- (id)init;
...
- (void)recommendedAllowedAppsForDNDMode:(id)arg1 reply:(id /* block */)arg2;
- (id)recommendedAllowedAppsForDNDModeSemanticType:(long long)arg1;
- (void)recommendedAllowedAppsForDNDModeSemanticType:(long long)arg1 reply:(id /* block */)arg2;
- (id)recommendedAllowedAppsForMode:(unsigned long long)arg1;
- (void)recommendedAllowedAppsForMode:(unsigned long long)arg1 reply:(id /* block */)arg2;
...
- (void)recommendedDeniedAppsForDNDMode:(id)arg1 reply:(id /* block */)arg2;
- (void)recommendedDeniedAppsForDNDModeSemanticType:(long long)arg1 reply:(id /* block */)arg2;
- (id)recommendedDeniedAppsForMode:(unsigned long long)arg1;
- (void)recommendedDeniedAppsForMode:(unsigned long long)arg1 reply:(id /* block */)arg2;
