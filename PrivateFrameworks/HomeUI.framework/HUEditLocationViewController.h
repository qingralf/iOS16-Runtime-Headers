...
@interface HUEditLocationViewController : HUItemTableViewController <HFHomeManagerObserver, HUAddPeopleViewControllerDelegate, HUPresentationDelegateHost, HUSwitchCellDelegate, HUWallpaperEditingViewControllerDelegate, HUWallpaperPickerInlineViewControllerDelegate, HUWallpaperPickerViewControllerDelegate, HUWallpaperThumbnailCellDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate, UITextViewDelegate> {
