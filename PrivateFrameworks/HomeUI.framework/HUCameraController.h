...
@interface HUCameraController : NSObject <AVPlayerViewControllerDelegate, AVPlayerViewControllerDelegatePrivate, HFCameraPlaybackEngineObserver, HFExecutionEnvironmentObserver, HFItemManagerDelegate, HUCameraPlayerAVBehaviorDelegate, HUItemPresentationContainer, HUPresentationDelegate, HUPresentationDelegateHost> {
...
@property (nonatomic, readonly) UICollectionView *ppt_clipCollectionView;
