...
- (void)legacyServiceGroupEditor:(id)arg1 didCreateServiceGroup:(id)arg2;
- (id)longPressRecognizer;
- (void)mediaGroupEditor:(id)arg1 didCreate:(id)arg2;
