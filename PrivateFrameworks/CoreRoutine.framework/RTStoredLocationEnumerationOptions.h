...
- (id)initWithDateInterval:(id)arg1 horizontalAccuracy:(double)arg2 batchSize:(unsigned long long)arg3 boundingBoxLocation:(id)arg4 type:(int)arg5 smoothingRequired:(bool)arg6 downsampleRequired:(bool)arg7 smoothingErrorThreshold:(double)arg8;
