...
@interface ICTableColumnTextView : ICBaseTextView <ICHashtagKeyboardDelegate, ICHashtagViewControllerDelegate, ICMentionsKeyboardDelegate, UIIndirectScribbleInteractionDelegate, UIScribbleInteractionDelegate> {
