...
@interface ICTableAttachmentViewController : ICAttachmentViewController <ICAttachmentFindable, ICAuxiliaryStyling, ICAvailableTableWidthProviding, ICBaseTextViewDelegate, ICTableAttachmentProviderDelegate, ICTableAutoScrollerDelegate, ICTableCellChangeObserving, ICTableColumnTextViewDelegate, ICTableDelegate, ICTableSelectionDelegate, ICTableTextViewManagerDelegate, ICTableUndoHelping, TTTextStorageDelegate, TTTextUndoTarget> {
...
@property (nonatomic, retain) TTTextStorage *currentlyEditingTextStorage;
...
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })rangeOfTableInNote;
