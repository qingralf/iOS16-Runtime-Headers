...
- (void).cxx_destruct;
- (id)_initWithApplicationConfigurationType:(id)arg1 senderConfigurationType:(id)arg2 suppressionType:(id)arg3 minimumBreakthroughUrgency:(id)arg4 hideApplicationBadges:(id)arg5 compatibilityVersion:(id)arg6;
