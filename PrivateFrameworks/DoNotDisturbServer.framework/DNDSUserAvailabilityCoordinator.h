...
- (void)_publishStatusKitAvailability:(bool)arg1 activityIdentifier:(id)arg2 forced:(bool)arg3 completion:(id /* block */)arg4;
...
- (id)publishStatusKitAvailabilityForced:(bool)arg1 error:(out id*)arg2;
- (id)publishStatusKitAvailabilityForced:(bool)arg1 override:(long long)arg2 error:(out id*)arg3;
