...
- (id)identifiers;
- (id)initWithClientIdentifier:(id)arg1 identifiers:(id)arg2 resolutionContextAssumingDeviceUILocked:(bool)arg3 userInteractionClient:(bool)arg4 persistentAssertionClient:(bool)arg5 syncSuppressedClient:(bool)arg6 iOS14SyncSuppressedClient:(bool)arg7;
