...
- (id)fetchRemindersWithObjectIDs:(id)arg1 includeConcealed:(bool)arg2 error:(id*)arg3;
- (id)fetchRemindersWithParentReminderID:(id)arg1 includeUnsupported:(bool)arg2 error:(id*)arg3;
