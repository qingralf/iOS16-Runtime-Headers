...
@interface DiskImageParamsAppleSparseImage_XPC : DiskImageParamsXPC {
    struct unique_ptr<di_shadow::header, std::default_delete<di_shadow::header>> { 
        struct __compressed_pair<di_shadow::header *, std::default_delete<di_shadow::header>> { 
...
- (id)initWithBackendXPC:(id)arg1 header:(struct unique_ptr<di_shadow::header, std::default_delete<di_shadow::header>> { struct __compressed_pair<di_shadow::header *, std::default_delete<di_shadow::header>> { struct header {} *x_1_1_1; } x1; })arg2;
