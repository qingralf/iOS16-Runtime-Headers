...
@property (nonatomic, retain) NSArray *shadowBackendsXPC;
...
- (id)cacheBackendXPC;
- (id)cacheURL;
- (struct unique_ptr<DiskImage, std::default_delete<DiskImage>> { struct __compressed_pair<DiskImage *, std::default_delete<DiskImage>> { struct DiskImage {} *x_1_1_1; } x1; })createDiskImageWithCache:(bool)arg1;
- (struct shared_ptr<DiskImage> { struct DiskImage {} *x1; struct __shared_weak_count {} *x2; })createShadowDiskImageWithBackend:(struct shared_ptr<Backend> { struct Backend {} *x1; struct __shared_weak_count {} *x2; })arg1 sinkDiskImage:(const struct DiskImage { int (**x1)(); }*)arg2 cache_only:(bool)arg3;
...
- (bool)makeNewImageEncryptedWithPassphrase:(const char *)arg1 error:(id*)arg2;
