...
@property (nonatomic, readonly) const struct __CFBitVector { }*arrayScoreInputsNeeded;
@property (nonatomic, readonly) const struct __CFBitVector { }*objectScoreInputsNeeded;
@property (nonatomic, readonly) const struct __CFBitVector { }*scalarScoreInputsNeeded;
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (const struct __CFBitVector { }*)arrayScoreInputsNeeded;
- (void)dealloc;
- (id)init;
...
- (const struct __CFBitVector { }*)objectScoreInputsNeeded;
- (const struct __CFBitVector { }*)scalarScoreInputsNeeded;
