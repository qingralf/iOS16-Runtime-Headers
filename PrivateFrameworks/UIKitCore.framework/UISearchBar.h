...
@interface UISearchBar : UIView <DebugHierarchyObject_Fallback, HUSearchBar, UIBarPositioning, UIScribbleInteractionDelegate, UITextInputTraits, UITextInputTraits_Private, _UIBarPositioningInternal, _UINavigationBarAugmentedTitleView> {
