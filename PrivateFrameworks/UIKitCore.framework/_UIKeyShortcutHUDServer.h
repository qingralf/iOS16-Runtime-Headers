...
@interface _UIKeyShortcutHUDServer : NSObject <_UIKeyShortcutHUDKeyListenerDelegate, _UIKeyShortcutHUDViewControllerDelegate, _UIKeyShortcutHUDWindowDelegate, _UIOServiceConnectionObserver> {
    <BSInvalidatable> * _additionalEventDeferringRulesToken;
    struct { 
    ...
    _UIEventDeferringOwnershipToken * _systemKeyboardShortcutOverlayEnvironmentEventDeferringToken;
}

@property (nonatomic, retain) <BSInvalidatable> *additionalEventDeferringRulesToken;
...
@property (nonatomic, retain) _UIEventDeferringOwnershipToken *systemKeyboardShortcutOverlayEnvironmentEventDeferringToken;
...
- (id)additionalEventDeferringRulesToken;
...
- (void)releaseInitialHeldModifierFlag:(long long)arg1 forConnection:(id)arg2;
- (void)serviceConnectionDidInvalidate:(id)arg1;
- (id)session;
- (void)setAdditionalEventDeferringRulesToken:(id)arg1;
- (void)setHudWindow:(id)arg1;
- (void)setLastKeyboardEvent:(id)arg1;
- (void)setModifierKeyDownForHUDDismissal:(bool)arg1;
- (void)setSession:(id)arg1;
- (void)setSystemKeyboardShortcutOverlayEnvironmentEventDeferringToken:(id)arg1;
- (id)systemKeyboardShortcutOverlayEnvironmentEventDeferringToken;
