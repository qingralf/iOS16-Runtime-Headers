...
@interface UIWindowScene : UIScene <DebugHierarchyObject_Fallback, _UIAssertionControllerSubject, _UIContextBinderContextCreationPolicyHolding, _UIEventDeferringRuleOwning, _UIFallbackEnvironment, _UIOrientationDebugDescriptionProviding, _UISceneUIWindowEventRouting, _UISceneUIWindowHosting> {
...
- (void)_computeMetricsAndCrossFadeInLiveResize:(bool)arg1;
- (void)_computeMetricsAndForceDelegateCallback:(bool)arg1 withAction:(id /* block */)arg2;
...
- (bool)_accessibilitySceneDidBecomeFocused;
- (bool)_accessibilitySetFocusEnabledInApplication:(bool)arg1;
