...
@interface UIImage : NSObject <DebugHierarchyValue_Fallback, EFLoggable, MKArtworkImageSource, NSCopying, NSDiscardableContent, NSItemProviderReading, NSItemProviderWriting, NSSecureCoding, UIImageJSExports, UIItemProviderPresentationSizeProviding, UIItemProviderReading, UIItemProviderWriting, _UIMenuImageOrName> {
    struct UIEdgeInsets { 
        double top; 
        double left; 
        double bottom; 
...
+ (id)__ck_actionImageForSubscriptionShortName:(id)arg1 maxSubscriptionLabelWidth:(double)arg2 isFilled:(bool)arg3;
...
+ (id)mt_resizableShadowTemplateImageWithAttributes:(struct { float x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; double x3; })arg1 maskCornerRadius:(double)arg2 continuousCorners:(bool)arg3 circularAxis:(unsigned long long)arg4;
+ (id)mt_shadowTemplateImageWithAttributes:(struct { float x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; double x3; })arg1 maskCornerRadius:(double)arg2 continuousCorners:(bool)arg3 circularAxis:(unsigned long long)arg4 resizableCapInsets:(struct { double x1; double x2; double x3; double x4; }*)arg5;
...
+ (id)ntk_gossamer_terminatorForDate:(id)arg1 size:(struct CGSize { double x1; double x2; })arg2;
...
+ (id)pbf_galleryHeroSnapshotForExtensionBundleIdentifier:(id)arg1 descriptorIdentifier:(id)arg2 size:(struct CGSize { double x1; double x2; })arg3;
...
- (id)vk_imageFromRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
