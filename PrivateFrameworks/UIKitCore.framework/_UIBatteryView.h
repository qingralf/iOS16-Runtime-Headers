...
@property (nonatomic, retain) CALayer *lowBatteryLayer;
@property (nonatomic, readonly) CAShapeLayer *lowBatteryShapeLayer;
...
- (void)setLowBatteryLayer:(id)arg1;
