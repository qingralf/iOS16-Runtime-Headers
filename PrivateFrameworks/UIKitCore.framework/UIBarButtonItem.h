...
@interface UIBarButtonItem : UIBarItem <DebugHierarchyObject_Fallback, MFPresentationSource, NSCoding, UIMenuForcedAutomaticSelectionDelegate, _UIPopoverPresentationControllerSourceItem_Internal> {
