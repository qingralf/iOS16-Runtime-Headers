...
- (void)_updateForGestureWithState:(long long)arg1 translation:(struct CGPoint { double x1; double x2; })arg2 location:(struct CGPoint { double x1; double x2; })arg3 allowsDragging:(bool)arg4;
