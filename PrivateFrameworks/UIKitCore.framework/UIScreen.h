...
@interface UIScreen : NSObject <BSDebugDescriptionProviding, DebugHierarchyObject_Fallback, INUIImageLoaderDelegate, UICoordinateSpace, UIFocusItemContainer, UITraitEnvironment, _CRKImageLoaderDelegate, _UIFallbackEnvironment, _UIFocusEnvironmentInternal, _UIFocusEnvironmentPrivate, _UIFocusRegionContainer, _UIOrientationDebugDescriptionProviding, _UITraitEnvironmentInternal> {
    ...
    long long  _foregroundSceneCount;
    long long  _gamut;
...
+ (void)_windowHostingSceneWillMoveToScreen:(id)arg1;
...
- (void)_incrementForegroundSceneCountForScene:(id)arg1;
...
- (void)_referenceDisplayModeStatusUpdatedWithApplicationSceneSettings:(id)arg1;
- (double)_refreshRate;
