...
@interface UIViewController : UIResponder <BSTraitEnvironment, CBSInfoButtonPresenter, DOCAppearanceCustomization, DebugHierarchyObject_Fallback, GKContentRefresh, GKURLHandling, HUItemPresentationContainer, IMMetricsDataSource, MKInfoCardThemeListener, NSCoding, NSExtensionRequestHandling, PXAnonymousViewController, PXDiagnosticsEnvironment, PXProgrammaticNavigationParticipant, SXHostable, TSPresenterType, UIAppearanceContainer, UIContentContainer, UIFocusEnvironment, UITraitEnvironment, UIWindowDelegate, VUIControllerPresenter, _UIAlwaysOnEnvironmentObserver, _UIContentContainerInternal, _UIFallbackEnvironment, _UIFocusEnvironmentInternal, _UIOrientationDebugDescriptionProviding, _UIStatusBarAnimationProviding, _UITraitEnvironmentInternal, _UIViewServiceDeputy> {
...
@property (nonatomic, readonly) UIView *deviceInformationView;
...
@property (nonatomic, readonly) long long doc_interfaceOrientation;
...
@property (setter=px_setSelectionActionMenus:, nonatomic, retain) NSArray *px_selectionActionMenus;
...
@property (nonatomic) bool showingDeviceInformation;
...
@property (nonatomic, readonly) UIView *substitutableView;
...
- (long long)doc_interfaceOrientation;
...
- (void)px_setSelectionActionMenus:(id)arg1;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })ppt_scrollableTouchAreaInCoordinateSpace:(id)arg1;
