...
@interface UISearchTextField : UITextField <_UISearchBarTextFieldOrMailReplacement, _UISearchSuggestionControllerDelegate, _UIVisualStyleStylable> {
    ...
    _UISearchSuggestionControllerIOS * _suggestionController;
...
@property (setter=_setSuggestionController:, nonatomic, retain) _UISearchSuggestionControllerIOS *_suggestionController;
