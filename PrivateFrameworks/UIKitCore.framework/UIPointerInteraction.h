...
- (void)_modifiersDidChangeInRegion:(id)arg1 update:(struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; long long x2; long long x3; long long x4; bool x5; })arg2;
- (id)_notifyDelegate_willEnterRegion:(id)arg1;
- (id)_notifyDelegate_willExitRegion:(id)arg1;
- (bool)_pausesPointerUpdatesWhilePanning;
- (void)_pointerDidEnterRegion:(id)arg1 update:(struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; long long x2; long long x3; long long x4; bool x5; })arg2;
...
- (void)_updateCurrentRegionIfNecessary:(id)arg1 update:(struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; long long x2; long long x3; long long x4; bool x5; })arg2;
- (void)_updateDebugUIForRegionIfEnabled:(id)arg1;
- (void)_updateInteractionIsEnabled;
- (void)_updatePointerStyleForRegion:(id)arg1 update:(struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; long long x2; long long x3; long long x4; bool x5; })arg2 animator:(id)arg3;
...
- (void)driver:(id)arg1 didIssueUpdate:(struct { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; long long x2; long long x3; long long x4; bool x5; })arg2;
