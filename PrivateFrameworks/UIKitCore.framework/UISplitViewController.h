...
@interface UISplitViewController : UIViewController <DebugHierarchyObject_Fallback, GKContentRefresh, GKURLHandling, UIViewControllerStatusBarPartStyleProvider> {
