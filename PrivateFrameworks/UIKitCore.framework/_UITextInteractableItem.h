...
+ (id)interactableAttachment:(id)arg1 range:(id)arg2 inTextItemInteractingView:(id)arg3 atLocation:(struct CGPoint { double x1; double x2; })arg4;
+ (id)interactableLink:(id)arg1 range:(id)arg2 inTextItemInteractingView:(id)arg3 atLocation:(struct CGPoint { double x1; double x2; })arg4;
