...
@interface UIButton : UIControl <ABText, CAMAccessibilityHUDItemProvider, DebugHierarchyObject_Fallback, MKActivityObserving, NSCoding, TSDPlatformButtonProtocol, UIAccessibilityContentSizeCategoryImageAdjusting, UIAccessibilityContentSizeCategoryImageAdjustingInternal, UIButtonControl, UIGestureRecognizerDelegate, UIMenuForcedAutomaticSelectionDelegate> {
