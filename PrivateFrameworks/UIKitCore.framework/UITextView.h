...
@interface UITextView : UIScrollView <ABText, DebugHierarchyObject_Fallback, MULabelViewProtocol, PKAppearanceObject, UIContentSizeCategoryAdjusting, UIFindInteractionDelegate, UIKeyboardInput, UITextAutoscrolling, UITextDragSupporting, UITextDraggable, UITextDropSupporting, UITextDroppable, UITextInput, UITextInputControllerDelegate, UITextInputPrivate, UITextPasteConfigurationSupporting, UITextPasteConfigurationSupporting_Internal, UITextSearching, UIViewGhostedRangeSupporting, WFInputViewMutable, _UILayoutBaselineUpdating, _UIMultilineTextContentSizing, _UITextContainerViewDelegate, _UITextContent, _UITextItemInteracting, _UITextSearching, _UITextViewContentPaddingDelegate, _UIViewBaselineSpacing> {
    id /* block */  __dci_editingMenuProvider;
...
@property (setter=_dci_setEditingMenuProvider:, nonatomic, copy) id /* block */ _dci_editingMenuProvider;
...
- (id)_dci_editingMenuForSuggestedActions:(id)arg1 textRange:(id)arg2;
- (id /* block */)_dci_editingMenuProvider;
- (id)_dci_findInteraction;
- (bool)_dci_isFindInteractionEnabled;
- (void)_dci_setEditingMenuProvider:(id /* block */)arg1;
