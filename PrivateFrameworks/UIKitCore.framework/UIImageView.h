...
@interface UIImageView : UIView <CCUIPunchOutCompensating, CCUIPunchOutRendering, DebugHierarchyObject_Fallback, NUCrossFadeViewAnimatable, UIAccessibilityContentSizeCategoryImageAdjusting, UIAccessibilityContentSizeCategoryImageAdjustingInternal, _UIImageContentEffect, _UIImageContentLayoutTarget> {
