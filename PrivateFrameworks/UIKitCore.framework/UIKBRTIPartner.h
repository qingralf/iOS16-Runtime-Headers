...
@interface UIKBRTIPartner : NSObject <RTIInputSystemClientDelegate, RTIInputSystemSessionDelegate, _UIGeometryChangeObserver> {
    ...
    bool  _deactivatedByFullScreenTransientOverlay;
...
- (void)forwardKeyboardSuppressionAndSuppressAssistantBar:(bool)arg1;
...
- (void)setDeactivatedByFullScreenTransientOverlay:(bool)arg1;
...
- (void)updateStateWithCompletion:(id /* block */)arg1;
