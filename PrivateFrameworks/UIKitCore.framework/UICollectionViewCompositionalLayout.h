...
@interface UICollectionViewCompositionalLayout : UICollectionViewLayout <_UICollectionViewLayoutInteractionStateModuleHost> {
    ...
    bool  _deferringInitialSolveUntilPrepare;
...
- (id)_containerFromCollectionViewWithCollectionViewBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
...
- (struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })_contentInsetsForSection:(long long)arg1;
- (void)_createSwipeActionsModuleIfNeeded;
- (id)_customContainerSectionIndexes;
- (id)_dataSourceSnapshotter;
- (void)_didEndSwiping;
- (void)_didPerformUpdateVisibleCellsPassWithLayoutOffset:(struct CGPoint { double x1; double x2; })arg1 logInvalidationReason:(bool)arg2;
...
- (bool)_orthogonalScrollingSectionShouldClipContentToBounds:(long long)arg1;
- (id)_orthogonalScrollingSections;
- (bool)_orthogonalScrollingShouldCenterCustomPagingSizeForSection:(long long)arg1;
- (struct CGPoint { double x1; double x2; })_orthogonalScrollingTargetContentOffsetForOffset:(struct CGPoint { double x1; double x2; })arg1 section:(long long)arg2 itemFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg3;
...
- (id)_sectionContainerDescriptorForSectionIndex:(long long)arg1;
...
- (void)setDeferringInitialSolveUntilPrepare:(bool)arg1;
