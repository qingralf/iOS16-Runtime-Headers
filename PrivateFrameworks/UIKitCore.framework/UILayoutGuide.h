...
@interface UILayoutGuide : NSObject <AVKitLayoutItem, DebugHierarchyObject_Fallback, HULayoutAnchorProviding, MUCompositionalStackLayoutItemInternal, MULayoutItem, NSCoding, NSISVariableDelegate, UILayoutItem_Internal, _UILayoutItem, _UIPopoverPresentationControllerSourceItem_Internal> {
