...
@interface UIScene : UIResponder <BSDebugDescriptionProviding, DebugHierarchyObject_Fallback, FBSSceneDelegate, PBPosterSceneSettings> {
...
// Image: /System/Library/PrivateFrameworks/BacklightUIServices.framework/BacklightUIServices
