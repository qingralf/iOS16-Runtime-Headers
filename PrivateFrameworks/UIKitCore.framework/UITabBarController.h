...
@interface UITabBarController : UIViewController <DebugHierarchyObject_Fallback, GKContentRefresh, GKURLHandling, NSCoding, UIGestureRecognizerDelegate, UILayoutContainerViewDelegate, UITabBarDelegate, _UIScrollViewScrollObserver, _UIScrollViewScrollObserver_Internal, _UITVScrollViewManagerDelegate, _UITabBarDelegateInternal> {
