...
@interface UIAlertController : UIViewController <AAUIAlertControllerProtocol, DebugHierarchyObject_Fallback, HUPreloadableViewController, UIAlertControllerContaining, UIAlertControllerVisualStyleProviding, UIPreviewInteractionControllerDelegate, WFAlertPresenter, _UIAlertControllerTextFieldViewControllerContaining> {
