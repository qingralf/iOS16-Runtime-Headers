...
- (void)_rebaseFocusedViewWithUpdateItems:(id)arg1 updateSupport:(id)arg2 indexPathMapping:(id /* block */)arg3;
...
- (void)_resignOrRebaseFirstResponderViewWithUpdateItems:(id)arg1 updateSupport:(id)arg2 indexPathMapping:(id /* block */)arg3;
