...
@interface _UIContextMenuInteractionBasedTextContextInteraction : UITextContextMenuInteraction <UIContextMenuInteractionDelegate_ForWebKitOnly, UIContextMenuInteractionDelegate_Private, _UIContextMenuInteractionDelegateInternal, _UIEditMenuInteractionDelegateInternal> {
