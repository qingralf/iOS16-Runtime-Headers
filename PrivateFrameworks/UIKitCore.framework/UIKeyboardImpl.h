...
@interface UIKeyboardImpl : UIView <TIKeyboardInputManagerToImplProtocol, UIKBRTIPartnerDelegate, UIKeyboardCandidateControllerDelegate, UIKeyboardCandidateListDelegate, UIKeyboardImplStateProtocol, UIKeyboardInputModeIndicatorControllerDelegate, UIKeyboardLayoutSizeDelegate, UIPopoverPresentationControllerDelegate, UITextInputDelegatePrivate, _UIIVCResponseDelegateImpl, _UIKeyboardTextSelectionGestureControllerDelegate> {
...
@property (nonatomic, copy) id /* block */ waitingOnPerformAutocorrect;
...
- (void)deleteBackward;
- (void)deleteBackwardAndNotify:(bool)arg1 reinsertText:(bool)arg2;
...
- (void)keyboardInputModeIndicatorControllerPresentIndicator:(id)arg1;
...
- (void)presentDictationMenu:(id)arg1;
...
- (void)setDelegate:(id)arg1 force:(bool)arg2 fromBecomeFirstResponder:(bool)arg3;
...
- (void)setWaitingOnPerformAutocorrect:(id /* block */)arg1;
...
- (id /* block */)waitingOnPerformAutocorrect;
