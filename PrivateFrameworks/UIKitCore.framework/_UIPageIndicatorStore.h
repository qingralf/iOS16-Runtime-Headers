...
- (void).cxx_destruct;
- (struct CGSize { double x1; double x2; })_contentSizeForIndicatorsInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
...
- (void)_resetStore;
- (struct CGSize { double x1; double x2; })_sizeForMaximumContentSizeFittingLength:(double)arg1;
...
- (struct CGSize { double x1; double x2; })minimumContentSizeForIndicatorsInRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
