...
@interface UICollectionView : UIScrollView <DebugHierarchyObject_Fallback, UIDataSourceTranslating, _UICollectionTableIndexOverlayHost, _UICollectionViewSubviewManagerDelegate, _UIDataSourceBackedView, _UIHorizontalIndexTitleBarDelegate, _UIKeyboardAutoRespondingScrollView, _UIUpdateCycleIdleObserver> {
...
@property (nonatomic, readonly) NSArray *mui_preparedItems;
...
- (void)_computeVisibleBoundsForUpdate:(id)arg1 usingData:(id)arg2;
...
- (id)_containerViewForSectionIndex:(long long)arg1 createIfNecessary:(bool)arg2;
...
- (struct CGPoint { double x1; double x2; })_contentOffsetForRestoringPositionToCurrentRestorationAnchorWithContentInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1 shouldApply:(out bool*)arg2;
...
- (void)_createAndAppendViewAnimationForFocusedItemInCurrentUpdate:(id)arg1 animationsForOnScreenViews:(id)arg2 newAnimatedItemIndexes:(id)arg3;
...
- (void)_populateSubviewManagerWithExistingVisibleViewsForCurrentUpdate:(id)arg1;
- (long long)_preferredDragDestinationVisualStyle;
...
- (void)_rebaseFocusedItemWithUpdateItems:(id)arg1 indexPathMapping:(id /* block */)arg2;
...
- (void)_resignOrRebaseFirstResponderViewWithUpdateItems:(id)arg1 indexPathMapping:(id /* block */)arg2;
- (void)_restoreOrAdjustContentOffsetIfNecessaryWithInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1;
- (void)_resumeReloads;
...
- (bool)_reviseNewVisibleBoundsForUpdate:(id)arg1;
- (void)_safeAreaInsetsDidChangeFromOldInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1;
- (void)_saveContentOffsetRestorationAnchorIfNecessaryUsingModel:(id)arg1;
...
- (bool)_updatePreferredAttributesForReusableViewInCurrentUpdate:(id)arg1 withOriginalAttributes:(id)arg2;
...
// Image: /System/Library/AccessibilityBundles/MusicUI.axbundle/MusicUI
