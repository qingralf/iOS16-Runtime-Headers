...
- (void).cxx_destruct;
- (struct CGVector { double x1; double x2; })_accelerationFactorForCurrentVelocity:(struct CGPoint { double x1; double x2; })arg1 isRotaryGesture:(bool)arg2 isFocusInKeyboard:(bool)arg3 remoteTouchSurfaceType:(unsigned long long)arg4;
...
- (void)_arrowButtonGesturesUpdateForcingRemoval:(bool)arg1 studyLogData:(id)arg2;
...
- (bool)_attemptRotaryFocusMovementWithLinearHeading:(unsigned long long)arg1 directionalHeading:(unsigned long long)arg2 request:(id)arg3 acceleratedVelocity:(struct CGPoint { double x1; double x2; })arg4 studyLogData:(id)arg5;
...
- (void)_joystickGestureRecognizerUpdateForcingRemoval:(bool)arg1 studyLogData:(id)arg2;
...
- (void)_linearDebugGestureRecognizerUpdateForcingRemoval:(bool)arg1 studyLogData:(id)arg2;
...
- (void)_pageButtonGesturesUpdateForcingRemoval:(bool)arg1 studyLogData:(id)arg2;
- (void)_panGestureCancelled:(id)arg1;
- (void)_panGestureEnd:(id)arg1;
- (void)_panGestureRecognizerUpdateForcingRemoval:(bool)arg1 studyLogData:(id)arg2;
- (void)_panGestureStart:(id)arg1;
- (struct CGPoint { double x1; double x2; })_pointForLinearValue:(double)arg1;
...
- (void)_rotaryGestureRecognizerUpdateForcingRemoval:(bool)arg1 studyLogData:(id)arg2;
- (void)_selectGestureRecognizerUpdateForcingRemoval:(bool)arg1 studyLogData:(id)arg2;
- (void)_selectObserverGestureRecognizerUpdateForcingRemoval:(bool)arg1 studyLogData:(id)arg2;
...
- (void)_tabulatorGestureUpdateForcingRemoval:(bool)arg1 studyLogData:(id)arg2;
- (void)_tapGestureRecognizerUpdateForcingRemoval:(bool)arg1 studyLogData:(id)arg2;
