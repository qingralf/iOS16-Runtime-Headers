...
@interface UIView : UIResponder <AVKitLayoutItem, CALayerDelegate, CRKCardSectionView, DOCAppearanceCustomization, DebugHierarchyObject_Fallback, HULayoutAnchorProviding, ICAttachmentPresenterDelegate, ICSupplementalView, MKInfoCardThemeListener, MKStackingViewControllerSizableView, MTVisualStylingProviding, MUCompositionalStackLayoutItemInternal, MULayoutItem, NSCoding, NSISEngineDelegate, NSISVariableDelegate, NTKDialMarkerView, NUIArrangementItem, PXGInternalReusableView, PXLayoutParticipant, PXReusableObject, PXUIViewBasicTile, SharedWithYou.AncestorViewControllerRetrievable, UIAppearance, UIAppearanceContainer, UICoordinateSpace, UIDynamicItem, UIFocusItem, UIFocusItemContainer, UILargeContentViewerItem, UILargeContentViewerItem_Private, UILayoutItem_Internal, UITextEffectsOrdering, UITraitEnvironment, _UIDropInteractionOwning, _UIFallbackEnvironment, _UIFocusEnvironmentPrivate, _UIFocusItemContainerPrivate, _UIFocusItemDebuggable, _UIFocusItemInternal, _UIFocusItemPrivate, _UIFocusRegionContainer, _UIFocusRegionContainerInternal, _UIGeometryChangeObserver, _UIGestureOwning, _UILayoutItem, _UILegacyFocusRegion, _UIMultilineTextContentSizing, _UIPopoverPresentationControllerSourceItem_Internal, _UIScrollViewScrollObserver_Internal, _UITraitEnvironmentInternal, _UIViewSubtreeMonitor> {
...
@property (nonatomic) bool ttr_isEnabled;
...
- (void)_traitCollectionDidChangeInternal:(const struct _UITraitCollectionChangeDescription { id x1; id x2; bool x3; struct _UITraitCollectionTraitChanges { bool x_4_1_1; bool x_4_1_2; bool x_4_1_3; bool x_4_1_4; bool x_4_1_5; bool x_4_1_6; bool x_4_1_7; bool x_4_1_8; bool x_4_1_9; bool x_4_1_10; } x4; }*)arg1;
...
- (bool)pkui_setAlpha:(double)arg1 animated:(bool)arg2;
- (bool)pkui_setAlpha:(double)arg1 animated:(bool)arg2 withCompletion:(id /* block */)arg3;
- (bool)pkui_setBounds:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 animated:(bool)arg2;
- (bool)pkui_setCornerRadius:(double)arg1 animated:(bool)arg2;
...
- (bool)pkui_setPosition:(struct CGPoint { double x1; double x2; })arg1 animated:(bool)arg2;
- (bool)pkui_setTransform:(struct CATransform3D { double x1; double x2; double x3; double x4; double x5; double x6; double x7; double x8; double x9; double x10; double x11; double x12; double x13; double x14; double x15; double x16; })arg1 animated:(bool)arg2;
...
- (void)pxg_configureWithTexture:(id)arg1 geometry:(struct { struct { double x_1_1_1; double x_1_1_2; double x_1_1_3; } x1; }*)arg2 info:(struct { int x1; int x2; float x3; long long x4; unsigned short x5; unsigned char x6; }*)arg3 style:(struct { float x1; struct { union { struct { float x_1_3_1; float x_1_3_2; float x_1_3_3; float x_1_3_4; } x_1_2_1; float x_1_2_2[4]; } x_2_1_1; } x2; float x3; float x4; float x5; float x6; unsigned short x7; unsigned char x8; float x9; struct { /* Warning: Unrecognized filer type: ']' using 'void*' */ void*x_10_1_1[4]; } x10; }*)arg4 textureInfo:(struct { }*)arg5 resizableCapInsets:(struct { float x1; float x2; float x3; float x4; })arg6 reusableViewInfo:(id)arg7 screenScale:(double)arg8;
...
- (void)setTtr_isEnabled:(bool)arg1;
...
- (bool)vui_shouldReuseCachedSizeThatFits:(struct CGSize { double x1; double x2; })arg1 previousTargetSize:(struct CGSize { double x1; double x2; })arg2 newTargetSize:(struct CGSize { double x1; double x2; })arg3;
