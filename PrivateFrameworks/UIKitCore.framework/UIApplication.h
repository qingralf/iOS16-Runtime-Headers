...
- (bool)_isActivatedForKeyboardForNewReason:(int)arg1;
...
- (void)_openURL:(id)arg1 options:(id)arg2 asyncCompletion:(bool)arg3 completionHandler:(id /* block */)arg4;
- (void)_openURL:(id)arg1 options:(id)arg2 openApplicationEndpoint:(id)arg3 asyncCompletion:(bool)arg4 completionHandler:(id /* block */)arg5;
