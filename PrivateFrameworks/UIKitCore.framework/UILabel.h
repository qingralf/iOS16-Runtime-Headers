...
@interface UILabel : UIView <ABText, HUActsAsLabel, MPUAutoupdatingTextContainer, MUWidthMeasurable, NSCoding, NUCrossFadeViewAnimatable, UIContentSizeCategoryAdjusting, _UILabelVisualStyleSubject, _UIMultilineTextContentSizing, _UIViewBaselineSpacing> {
...
@property (setter=_setOverrideTextFont:, nonatomic, retain) UIFont *_overrideTextFont;
...
@property (nonatomic, readonly) unsigned long long ic_numberOfLinesNeededForFullText;
...
- (void)_setOverrideTextFont:(id)arg1;
...
- (unsigned long long)ic_numberOfLinesNeededForFullText;
- (bool)ic_requiresLineBreaks;
- (bool)ic_requiresTruncationWithNumberOfLines:(unsigned long long)arg1;
