...
@property (getter=swiftui_isAvailableWithoutCustomization, setter=swiftui_setAvailableWithoutCustomization:, nonatomic) bool swiftui_availableWithoutCustomization;
...
- (void)swiftui_setAvailableWithoutCustomization:(bool)arg1;
