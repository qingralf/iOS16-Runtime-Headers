...
@property (nonatomic, readonly) const struct CGPath { }*vk_CGPath;
...
+ (id)wk_parallelogramInRect:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 stripeIndex:(long long)arg2 firstStripeBaseY:(double)arg3 stripeAngle:(double)arg4 stripeWidth:(double)arg5 sizeScaleFactor:(double)arg6;
