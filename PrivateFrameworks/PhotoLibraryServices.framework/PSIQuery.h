...
@property (nonatomic, readonly) bool calculateTokenCounts;
...
@property (nonatomic, readonly) bool lastImplicitTokenAllowsWordEmbeddings;
...
@property (nonatomic, readonly) bool usesPrefixBasedWordEmbedding;
...
+ (id)_combineOCRGroups:(id)arg1 usingSearchTokens:(id)arg2;
