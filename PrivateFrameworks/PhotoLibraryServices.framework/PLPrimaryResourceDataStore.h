...
- (void)_generateDeferredAdjustmentForAsset:(id)arg1 imageConversionServiceClient:(id)arg2 videoConversionServiceClient:(id)arg3 reason:(id)arg4 taskIdentifier:(id)arg5 cplResourceType:(unsigned long long)arg6 version:(unsigned int)arg7 completion:(id /* block */)arg8;
- (id)_imageConversionServiceClient;
- (bool)_installFinalizedInternalResourcesIfResourceUrlIsNotPresent:(id)arg1 taskIdentifier:(id)arg2 error:(id*)arg3;
...
- (void)installFinalizedResourcesAndGenerateDeferredAdjustmentIfNecessary:(id)arg1 resourceID:(id)arg2 libraryServicesManager:(id)arg3 imageConversionServiceClient:(id)arg4 videoConversionServiceClient:(id)arg5 needsDeferredAdjustment:(bool)arg6 taskIdentifier:(id)arg7 mediaConversionRequestReason:(id)arg8 completion:(id /* block */)arg9;
