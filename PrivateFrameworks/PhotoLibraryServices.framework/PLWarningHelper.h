...
- (void)_getExpungeWarningMessage:(id*)arg1 buttonTitle:(id*)arg2 forAssetCount:(long long)arg3 assetType:(short)arg4 iCPLEnabled:(bool)arg5 deviceModelName:(id)arg6;
...
- (id)_usedElsewhereWarningTextForAssetCount:(long long)arg1 inLibraryScopeCount:(long long)arg2 inPhotoStreamCount:(long long)arg3 iniPhotoCount:(long long)arg4 inSomeAlbumCount:(long long)arg5 affectedLocalAlbumsCount:(long long)arg6 assetType:(short)arg7 actualDeletionCount:(long long)arg8 syndicationAssetCount:(long long)arg9;
