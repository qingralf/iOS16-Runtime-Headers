...
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_ABORT_4_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_AUTH_23_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_BUSY_5_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_CANTOPEN_14_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_CONSTRAINT_19_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_CORRUPT_11_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_DONE_101_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_EMPTY_16_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_ERROR_1_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_FORMAT_24_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_FULL_13_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_INTERNAL_2_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_INTERRUPT_9_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_IOERR_10_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_LOCKED_6_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_MISMATCH_20_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_MISUSE_21_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_NOLFS_22_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_NOMEM_7_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_NOTADB_26_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_NOTFOUND_12_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_NOTICE_27_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_OTHER_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_PERM_3_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_PROTOCOL_15_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_RANGE_25_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_READONLY_8_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_ROW_100_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_SCHEMA_17_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_TOOBIG_18_withCode:(int)arg1;
+ (void)_abortFromMocSaveFail_NSMOC_SQLITE_WARNING_28_withCode:(int)arg1;
...
+ (void)_contextSaveFailedWithSQLiteResultCode:(int)arg1;
...
- (void)_userApplyTrashedState:(short)arg1 toAssets:(id)arg2 localOnlyDelete:(bool)arg3;
...
- (void)userExpungeAssets:(id)arg1 localOnlyDelete:(bool)arg2;
