...
- (void)_retryWrapperForProcessUniversalSearchJITForAsset:(id)arg1 cssiUniqueIdentifier:(id)arg2 bundleID:(id)arg3 processingTypes:(unsigned long long)arg4 completion:(id /* block */)arg5;
