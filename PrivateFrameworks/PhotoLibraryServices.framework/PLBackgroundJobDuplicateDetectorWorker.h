...
- (id)_managedAssetOIDsFromAdditionalAssetAttributesOIDs:(id)arg1 sceneprintOIDs:(id)arg2 library:(id)arg3;
...
- (void)_setLastDuplicateDetectorProcessingToken:(id)arg1 library:(id)arg2;
