...
+ (id)generateValidatedExternalImageResourceOfType:(unsigned int)arg1 forFilePath:(id)arg2 requireFileToBePresent:(bool)arg3 version:(unsigned int)arg4 basedOnFullSizeWidth:(long long)arg5 andHeight:(long long)arg6 isNativeColorSpace:(bool)arg7 isLosslessEncoding:(bool)arg8 recipe:(id)arg9 assetKind:(short)arg10 error:(id*)arg11;
