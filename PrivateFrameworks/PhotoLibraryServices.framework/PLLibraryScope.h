...
+ (id)_computeCountOfContributedAssetsTrashedByOtherParticipantsInLibraryScope:(id)arg1 outPhotoCount:(unsigned long long*)arg2 outVideoCount:(unsigned long long*)arg3 outItemCount:(unsigned long long*)arg4;
+ (id)_nearestDateSetToHour:(long long)arg1;
...
+ (void)informRapportToRemoveShareParticipantUUIDs:(id)arg1 photoLibrary:(id)arg2;
...
- (id)localID;
- (id)markOnboardingPreviewAssetsByProcessingRulesWithCompletionHandler:(id /* block */)arg1;
