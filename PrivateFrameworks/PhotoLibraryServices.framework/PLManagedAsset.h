...
@property (nonatomic, retain) NSDate *lastSpotlightChangeDate;
...
+ (bool)isPhotoIrisPlaceholderWithPhotoIris:(bool)arg1 isCameraProcessingAdjustment:(bool)arg2 videoCpDuration:(long long)arg3 isCloudShared:(bool)arg4 videoCpFilePath:(id)arg5 cameraProcessingAdjustmentVideoCpFilePath:(id)arg6 deferredProcessingNeedingAdjustment:(bool)arg7;
...
- (void)addSearchIndexContentsToAsset:(id)arg1 graphData:(id)arg2 dateFormatter:(id)arg3 keywords:(id)arg4 synonymsDictionaries:(id)arg5 sceneTaxonomyProvider:(id)arg6 documentObservation:(id)arg7;
...
- (void)setLastSpotlightChangeDate:(id)arg1;
...
- (void)setMonoskiTypeFromMetadata:(id)arg1;
