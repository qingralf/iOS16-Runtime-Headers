...
+ (bool)_determineEnabledStateFromCloudExtensionState:(id)arg1;
...
+ (bool)test_determineEnabledStateFromCloudExtensionState:(id)arg1;
...
- (id)init;
- (bool)isExtensionEnabledInCloudWithComposedIdentifier:(id)arg1;
