...
@interface TIDPRecorder : NSObject {
    ...
    const struct _LXLexicon { } * _lexiconPrimaryInputMode;
    const struct _LXLexicon { } * _lexiconSecondaryInputMode;
...
- (bool)isWordEntryReallyOOV:(id)arg1;
- (const struct _LXLexicon { }*)lexiconPrimaryInputMode;
- (const struct _LXLexicon { }*)lexiconSecondaryInputMode;
