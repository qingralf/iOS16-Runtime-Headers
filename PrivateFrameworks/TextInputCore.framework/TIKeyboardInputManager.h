...
- (void)generateAutofillFormWithKeyboardState:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)handleLMTrialParametersDidChangeNotification:(id)arg1;
...
- (void)registerNegativeEvidence:(id)arg1 tokenID:(struct TITokenID { unsigned int x1; unsigned int x2; })arg2 contextTokens:(id)arg3 intendedTokenID:(struct TITokenID { unsigned int x1; unsigned int x2; }*)arg4 hint:(int)arg5;
