...
@interface TIKeyboardInputManager_mul : TIKeyboardInputManager {
    ...
    bool  _isSuspended;
    TIAutocorrectionList * _pregeneratedAutocorrectionList;
}

@property (nonatomic) bool compositionDisabled;
@property (nonatomic, retain) TIAutocorrectionList *pregeneratedAutocorrectionList;
...
- (id)pregeneratedAutocorrectionList;
- (id)resourceInputModes;
- (void)resume;
- (void)setCompositionDisabled:(bool)arg1;
- (void)setPregeneratedAutocorrectionList:(id)arg1;
