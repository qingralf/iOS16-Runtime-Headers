...
@property (nonatomic, readonly) const struct _LXLexicon { }*activePhraseLexicon;
@property (nonatomic, readonly) const struct _LXLexicon { }*activeWordLexicon;
@property (nonatomic, readonly) int connectionIdentifier;
@property (nonatomic) <TISupplementalLexiconControllerDelegate> *delegate;

- (void).cxx_destruct;
- (id)activeLexicon;
- (const struct _LXLexicon { }*)activePhraseLexicon;
- (const struct _LXLexicon { }*)activeWordLexicon;
