...
- (void)_exchangeMAIDForBearerTokenWithRMAccountIdentifier:(id)arg1 authParams:(id)arg2 machineInfo:(id)arg3 anchorCertificateRefs:(id)arg4;
- (bool)_extractAndVerifyPropertiesFromProfileData:(id)arg1 enrollmentMethod:(unsigned long long)arg2 error:(id*)arg3;
- (id)_fetchAppAttributesWithITunesItemID:(id)arg1 error:(id*)arg2;
- (void)_fetchEnrollmentProfileFromServiceURL:(id)arg1 authTokens:(id)arg2 enrollmentMethod:(unsigned long long)arg3 machineInfo:(id)arg4 anchorCertificateRefs:(id)arg5;
...
- (void)_installEnrollmentProfile:(id)arg1 devicePasscode:(id)arg2 personaID:(id)arg3 rmAccountIdentifier:(id)arg4 essoConfigurationProfile:(id)arg5;
