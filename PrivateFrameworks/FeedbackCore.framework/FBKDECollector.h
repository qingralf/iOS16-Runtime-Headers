...
- (id)identifier;
- (id)initWithRequirements:(id)arg1 forDevice:(id)arg2 filerForm:(id)arg3 extensionsFromURL:(id)arg4 listener:(id)arg5 shouldGetSessionStatus:(bool)arg6 shouldCheckDeferredLogs:(bool)arg7;
