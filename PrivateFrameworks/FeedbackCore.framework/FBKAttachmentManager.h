...
- (id)initWithMatcherPredicates:(id)arg1 pendingFileUrls:(id)arg2 pendingExtensions:(id)arg3 form:(id)arg4 targetDevice:(id)arg5 shouldGetSessionStatus:(bool)arg6 shouldCheckDeferredLogs:(bool)arg7;
