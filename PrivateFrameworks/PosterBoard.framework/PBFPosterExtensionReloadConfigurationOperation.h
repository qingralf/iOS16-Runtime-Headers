...
@interface PBFPosterExtensionReloadConfigurationOperation : NSBlockOperation <PBFBehaviorAssertionObserver, PRUpdatingServiceObserver> {
    ...
    bool  _didTimeout;
    NSError * _error;
    PRSServerPosterPath * _existingConfigurationPath;
    bool  _locationInUse;
    ...
    PRSServerPosterPath * _preRefreshPosterConfiguration;
    long long  _reason;
...
@property (nonatomic, readonly) PRSServerPosterPath *existingConfigurationPath;
@property (readonly) unsigned long long hash;
@property (readonly) PRSPosterPath *postRefreshPosterConfiguration;
@property (retain) PRSServerPosterPath *preRefreshPosterConfiguration;
