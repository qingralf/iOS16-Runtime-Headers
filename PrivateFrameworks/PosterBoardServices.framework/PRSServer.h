...
- (oneway void)createPosterConfigurationForProviderIdentifier:(id)arg1 posterDescriptorIdentifier:(id)arg2 completion:(id /* block */)arg3;
- (id)delegate;
...
- (oneway void)fetchActiveConfiguration:(id /* block */)arg1;
...
- (oneway void)fetchPosterConfigurations:(id /* block */)arg1;
...
- (oneway void)fetchSelectedConfiguration:(id /* block */)arg1;
...
- (oneway void)updateToSelectedConfigurationMatchingUUID:(id)arg1 completion:(id /* block */)arg2;
