...
@interface STAllowancesConfigurationGroupSpecifierProvider : STRootGroupSpecifierProvider <STAlwaysAllowListControllerDelegate, STDeviceBedtimeListControllerDelegate> {
    ...
    bool  _isCommunicationSafetyRegionSupported;
}
...
@property (nonatomic, readonly) bool isCommunicationSafetyRegionSupported;
...
- (void)_isManagedDidChangeTo:(bool)arg1;
...
- (id)init;
- (bool)isCommunicationSafetyRegionSupported;
