...
- (id)initWithInterfaceName:(id)arg1 supportsSoloMode:(bool)arg2 channelSequence:(id)arg3 isEnabled:(bool)arg4 substate:(unsigned int)arg5 macAddress:(id)arg6 peerMasterChannel:(id)arg7 peerPrimaryPreferredChannel:(id)arg8 peerSecondaryPreferredChannel:(id)arg9;
- (id)interfaceName;
- (bool)isEnabled;
