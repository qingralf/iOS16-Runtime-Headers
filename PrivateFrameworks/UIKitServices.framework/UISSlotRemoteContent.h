...
- (bool)isRemote;
- (id)newTouchAuthenticationSpecificationWithAuthenticationMessageContext:(unsigned long long)arg1 hitTestInformationMask:(unsigned long long)arg2 secureName:(unsigned int)arg3;
