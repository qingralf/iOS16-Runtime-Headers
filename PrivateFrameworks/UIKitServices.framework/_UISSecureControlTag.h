...
- (id)initWithCategory:(id)arg1 cornerStyle:(long long)arg2 cornerRadius:(double)arg3 baseForegroundColor:(struct CGColor { }*)arg4 baseBackgroundColor:(struct CGColor { }*)arg5 size:(struct CGSize { double x1; double x2; })arg6;
