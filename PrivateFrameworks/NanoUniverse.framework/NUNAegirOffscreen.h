...
- (void).cxx_destruct;
- (int)height;
- (id)initWithDevice:(id)arg1 width:(int)arg2 height:(int)arg3 pixelFormat0:(unsigned long long)arg4 pixelFormat1:(unsigned long long)arg5 mipmaps:(bool)arg6 loadAction:(unsigned long long)arg7 clearColor0:(struct { double x1; double x2; double x3; double x4; })arg8 clearColor1:(struct { double x1; double x2; double x3; double x4; })arg9;
