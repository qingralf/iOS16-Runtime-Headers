...
- (id)_precomputedMailboxScopeForFilterPredicate:(id)arg1 mailboxProvider:(id)arg2 hasFollowUpPredicate:(bool*)arg3;
...
- (id)precomputedMailboxScopeForThreadScope:(id)arg1 mailboxProvider:(id)arg2 hasFollowUpPredicate:(bool*)arg3;
...
- (id)threadScopeFromPrecomputedMailboxScope:(id)arg1 hasFollowUpPredicate:(bool)arg2 mailboxProvider:(id)arg3;
- (id)threadScopes;
