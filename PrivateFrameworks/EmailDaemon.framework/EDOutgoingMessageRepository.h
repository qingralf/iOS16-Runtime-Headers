...
@property (nonatomic, retain) EDSendLaterPersistence *sendLaterPersistence;
...
- (id)initWithMessagePersistence:(id)arg1 messageChangeManager:(id)arg2 sendLaterPersistence:(id)arg3;
...
- (void)setSendLaterPersistence:(id)arg1;
