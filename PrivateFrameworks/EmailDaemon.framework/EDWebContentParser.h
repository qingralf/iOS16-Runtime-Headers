...
- (void)_setContentRuleLists:(id)arg1;
...
- (void)parseHTMLData:(id)arg1 withOptions:(unsigned long long)arg2 characterEncodingName:(id)arg3 forMessage:(id)arg4 completionHandler:(id /* block */)arg5;
