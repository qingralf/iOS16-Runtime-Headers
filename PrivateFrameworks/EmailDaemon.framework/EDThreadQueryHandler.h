...
@interface EDThreadQueryHandler : NSObject <EDMessageRepositoryQueryHandler, EDThreadChangeHookResponder, EDThreadMigratorDelegate, EFLoggable, EMMessageListItemQueryResultsObserver> {
