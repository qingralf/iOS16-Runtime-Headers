...
- (const struct __CTLine { }*)_createLineRefForParentLineRef:(inout const struct __CTLine {}**)arg1 range:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 availableWidth:(double)arg3 offset:(double)arg4 paragraphArbitrator:(id)arg5 lineBreakMode:(long long)arg6 hyphenated:(out bool*)arg7 forcedClusterBreak:(out bool*)arg8;
