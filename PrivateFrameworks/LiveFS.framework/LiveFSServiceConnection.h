...
- (void)createIn:(id)arg1 named:(id)arg2 attributes:(id)arg3 forPID:(int)arg4 requestID:(unsigned long long)arg5 reply:(id /* block */)arg6;
- (void)dealloc;
...
- (void)makeCloneOf:(id)arg1 named:(id)arg2 inDirectory:(id)arg3 attributes:(id)arg4 usingFlags:(unsigned int)arg5 forPID:(int)arg6 requestID:(unsigned long long)arg7 reply:(id /* block */)arg8;
- (void)makeDirectoryIn:(id)arg1 named:(id)arg2 attributes:(id)arg3 forPID:(int)arg4 requestID:(unsigned long long)arg5 reply:(id /* block */)arg6;
- (void)makeLinkOf:(id)arg1 named:(id)arg2 inDirectory:(id)arg3 forPID:(int)arg4 requestID:(unsigned long long)arg5 reply:(id /* block */)arg6;
- (void)makeSymLinkIn:(id)arg1 named:(id)arg2 contents:(id)arg3 attributes:(id)arg4 forPID:(int)arg5 requestID:(unsigned long long)arg6 reply:(id /* block */)arg7;
...
- (void)writeTo:(id)arg1 atOffset:(unsigned long long)arg2 sharedBuffer:(id)arg3 forPID:(int)arg4 requestID:(unsigned long long)arg5 reply:(id /* block */)arg6;
