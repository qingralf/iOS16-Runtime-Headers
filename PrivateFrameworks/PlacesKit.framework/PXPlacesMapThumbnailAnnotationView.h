...
- (void)_processGeotaggable:(id)arg1 withImage:(struct CGImage { }*)arg2 popoverImageType:(unsigned long long)arg3 imageOptions:(unsigned long long)arg4 shouldCache:(bool)arg5;
