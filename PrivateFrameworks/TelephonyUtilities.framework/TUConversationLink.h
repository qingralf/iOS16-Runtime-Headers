...
- (id)initWithPseudonym:(id)arg1 publicKey:(id)arg2 groupUUID:(id)arg3 originatorHandle:(id)arg4 creationDate:(id)arg5 expirationDate:(id)arg6 invitedMemberHandles:(id)arg7 locallyCreated:(bool)arg8 linkName:(id)arg9 linkLifetimeScope:(long long)arg10;
