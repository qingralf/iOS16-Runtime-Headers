...
- (id)initWithContext:(id)arg1 linkMetadata:(id)arg2 fallbackURL:(id)arg3 invitationURL:(id)arg4 supportsContinuationOnTV:(bool)arg5 title:(id)arg6 subTitle:(id)arg7 imageData:(id)arg8 preferredBroadcastingAttributes:(long long)arg9 sceneAssociationBehavior:(id)arg10;
- (id)invitationURL;
