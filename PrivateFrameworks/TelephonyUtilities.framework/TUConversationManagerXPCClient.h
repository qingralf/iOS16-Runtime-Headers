...
- (oneway void)conversation:(id)arg1 remoteParticipantWithIdentifier:(unsigned long long)arg2 updatedAudioEnabled:(bool)arg3;
- (oneway void)conversation:(id)arg1 remoteParticipantWithIdentifier:(unsigned long long)arg2 updatedVideoEnabled:(bool)arg3;
...
- (void)setAudioEnabled:(bool)arg1 forRemoteParticipantWithIdentifier:(unsigned long long)arg2 conversation:(id)arg3;
...
- (void)setVideoEnabled:(bool)arg1 forRemoteParticipantWithIdentifier:(unsigned long long)arg2 conversation:(id)arg3;
