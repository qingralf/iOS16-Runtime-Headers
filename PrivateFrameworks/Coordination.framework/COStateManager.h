...
@property (nonatomic, copy) NSArray *mediaStateObservers;
...
- (void)_onqueue_removeObjectsForKeyPaths:(id)arg1 clusters:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)_onqueue_setDictionary:(id)arg1 clusters:(id)arg2 completionHandler:(id /* block */)arg3;
...
- (void)setMediaStateObservers:(id)arg1;
