...
@interface UIDocumentBrowserViewController : UIViewController <DOCAppearanceCustomization, DOCHostDocumentBrowserViewControllerInterface, DOCRemoteViewControllerDelegate, DOCViewServiceErrorViewControllerDelegate, NSCoding, UIAdaptivePresentationControllerDelegate, _UIRemoteViewControllerContaining> {
...
+ (struct CGSize { double x1; double x2; })preferredPickerContentSizeForWindow:(id)arg1;
