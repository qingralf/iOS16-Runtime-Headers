...
- (unsigned int)__flagsForChannelBand:(int)arg1 width:(int)arg2;
- (void)activate;
- (id)activities;
...
- (id)supportedChannel:(unsigned long long)arg1 band:(int)arg2 width:(int)arg3 countryCode:(id)arg4;
