...
@interface PUPortraitWallpaperCandidateDebugViewController : UICollectionViewController <PUWallpaperClassDataSourceDelegate, PXOneUpPresentationDelegate> {
...
- (void)setFallbackCase:(bool)arg1;
