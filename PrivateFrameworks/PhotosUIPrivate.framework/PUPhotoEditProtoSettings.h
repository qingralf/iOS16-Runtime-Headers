...
@interface PUPhotoEditProtoSettings : PXSettings <PEValuesCalculatorSettings> {
    ...
    bool  _crossPlatformRevertEnabled;
...
- (bool)crossPlatformRevertEnabled;
...
- (void)setCrossPlatformRevertEnabled:(bool)arg1;
...
- (void)setShowCopyAndPaste:(bool)arg1;
...
- (void)setShowRevertEdits:(bool)arg1;
