...
+ (id)visualDiagnosticsActionForAsset:(id)arg1 layerStack:(id)arg2 segmentationItem:(id)arg3 fromViewController:(id)arg4 actionBeingHandler:(id /* block */)arg5 actionEndHandler:(id /* block */)arg6;
