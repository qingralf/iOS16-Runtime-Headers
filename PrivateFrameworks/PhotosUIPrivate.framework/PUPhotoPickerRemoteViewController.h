...
@interface PUPhotoPickerRemoteViewController : UIViewController <NSExtensionRequestHandling, PUPhotoPicker, PUPhotoPickerTestSupportHandler, _UIAppearanceRestriction> {
