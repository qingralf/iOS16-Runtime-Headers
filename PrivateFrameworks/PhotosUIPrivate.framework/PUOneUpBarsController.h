...
@interface PUOneUpBarsController : PUBarsController <PUAssetActionPerformerDelegate, PUBarButtonItemCollectionDataSource, PUBrowsingViewModelChangeObserver, PUOverOneUpPresentationSessionBarsDelegate, PUPhotoBrowserTitleViewControllerDelegate, PUPlayPauseBarItemsControllerChangeObserver, PUScrubberViewDelegate, PXActionPerformerDelegate, PXChangeObserver, PXInfoProvider, PXInfoUpdaterObserver, UIPopoverPresentationControllerDelegate> {
    ...
    bool  _actionStartedFromActionsMenu;
    ...
    bool  _wantsMessagesStyling;
    bool  _wantsShowInLibraryButton;
    bool  _wantsSpotlightStyling;
}
...
@property (nonatomic) bool actionStartedFromActionsMenu;
...
- (void)_handlePresentActionsMenu:(id /* block */)arg1;
...
- (void)_performPasteAdjustmentsActivityWithAssetsByAssetCollection:(id)arg1;
...
- (void)_performRevertAdjustmentsActivityWithAssetsByAssetCollection:(id)arg1;
...
- (bool)actionStartedFromActionsMenu;
...
- (void)setActionStartedFromActionsMenu:(bool)arg1;
...
- (void)setWantsMessagesStyling:(bool)arg1;
- (void)setWantsShowInLibraryButton:(bool)arg1;
- (void)setWantsSpotlightStyling:(bool)arg1;
