...
@interface PUAssetViewModelChange : PUViewModelChange {
    ...
    bool  _shouldHideVisualIntelligenceOverlayChanged;
...
@property (setter=_setShouldHideVisualIntelligenceOverlayChanged:, nonatomic) bool shouldHideVisualIntelligenceOverlayChanged;
...
- (void)_setShouldHideVisualIntelligenceOverlayChanged:(bool)arg1;
...
- (bool)shouldHideVisualIntelligenceOverlayChanged;
