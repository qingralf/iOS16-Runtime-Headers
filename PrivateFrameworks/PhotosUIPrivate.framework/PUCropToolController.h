...
@property (nonatomic, retain) PXUIButton *aspectButton;
@property (nonatomic, retain) UIButton *aspectRatioLockButton;
@property (nonatomic, retain) PXUIButton *autoButton;
...
@property (nonatomic, retain) PXUIButton *flipButton;
...
@property (nonatomic, retain) PXUIButton *rotateButton;
