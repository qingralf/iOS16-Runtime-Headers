...
@interface PUWallpaperClassDebugViewController : UICollectionViewController <PUWallpaperClassDataSourceDelegate, PXOneUpPresentationDelegate> {
    PHSuggestion * _currentSuggestion;
    PUWallpaperClassDataSource * _dataSource;
...
@property (nonatomic, retain) PUWallpaperClassDataSource *dataSource;
