...
@interface PUPickerPrincipalUIViewController : UIViewController <NSExtensionRequestHandling, PUAssetPickerCoordinatorActionHandler, _PUPickerExtensionContextVendorInterface, _PUPickerUnavailableViewControllerDelegate, _UIAppearanceRestriction> {
...
@property (nonatomic, retain) NSMutableDictionary *activityIndicatorTrackingIDs;
...
- (void)confirmPicking:(id)arg1 completionHandler:(id /* block */)arg2;
- (id)coordinator;
...
- (id)selectionDate;
- (void)setActivityIndicatorTrackingIDs:(id)arg1;
