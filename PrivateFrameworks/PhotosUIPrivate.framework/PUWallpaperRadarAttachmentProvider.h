...
+ (id)radarConfigurationForAsset:(id)arg1 suggestion:(id)arg2 layerStack:(id)arg3 segmentationItem:(id)arg4 posterDescriptor:(id)arg5 posterConfiguration:(id)arg6 component:(long long)arg7 completionHandler:(id /* block */)arg8;
