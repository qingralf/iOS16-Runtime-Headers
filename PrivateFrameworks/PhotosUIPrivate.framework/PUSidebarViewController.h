...
- (id)initWithNavigationRoot:(id)arg1 photoLibrary:(id)arg2 options:(unsigned long long)arg3 additionalAssetsFilterPredicate:(id)arg4 pickerAllPhotosVirtualCollection:(id)arg5;
- (bool)isUpdating;
