...
@interface PUMenuActionController : NSObject <PUAssetActionPerformerDelegate> {
    ...
    struct { 
        ...
        bool removeFromFeaturedPhotosAction; 
    }  _delegateRespondsTo;
...
- (void).cxx_destruct;
- (id)_actionsForDocument;
- (id)_actionsForPreview;
...
- (void)_handleActionCompletion:(id)arg1 actionStartedFromActionsMenu:(bool)arg2;
...
- (id)actions;
- (id)actionsForContext:(long long)arg1;
