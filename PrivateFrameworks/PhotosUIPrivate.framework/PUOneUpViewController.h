...
@interface PUOneUpViewController : UIViewController <PHAirPlayControllerContentProvider, PUAccessoryTileViewControllerDelegate, PUAccessoryVisibilityInteractionControllerDelegate, PUAssetActionPerformerDelegate, PUAssetDisplayDescriptorNavigator, PUBadgeTileViewControllerDelegate, PUBarsControllerDelegate, PUBrowsingViewModelChangeObserver, PUDoubleTapZoomControllerDelegate, PUImageTileViewControllerPresentingDelegate, PUInteractiveDismissalControllerDelegate, PUIrisImageTileViewControllerDelegate, PULivePhotoVideoOverlayTileViewControllerDelegate, PUMenuActionControllerDelegate, PUOneUpAccessoryViewControllersManagerDelegate, PUOneUpAssetTransitionViewController, PUOneUpBarsControllerDelegate, PUOneUpGestureRecognizerCoordinatorDelegate, PUOneUpLinkControllerDelegate, PUOneUpSuggestionsControllerDelegate, PUOneUpTilingLayoutDelegate, PUOverOneUpPresentationSessionDelegate, PUOverOneUpPresentationSessionViewController, PUPeopleTileDelegate, PUPlayButtonTileViewControllerDelegate, PUSyndicationAttributionTileViewControllerDelegate, PUTilingViewControllerTransitionEndPoint, PUTilingViewScrollDelegate, PUTilingViewTileSource, PUTilingViewTileTransitionDelegate, PUTilingViewTileUseDelegate, PUUserTransformTileViewControllerDelegate, PUViewControllerSpecChangeObserver, PXContentPrivacyAuthenticationContext, PXContextualNotificationDelegate, PXDiagnosticsEnvironment, PXFloatingCardContainer, PXFloatingCardPresentationControllerDelegate, PXForcedDismissableViewController, PXLoadingStatusManagerObserver, PXPreferencesObserver, PXPurgeableController, PXSettingsKeyObserver, TPKContentControllerDelegate, UIScrollViewDelegate> {
    ...
    PUOneUpLinkController * __linkController;
    ...
    bool  __needsUpdateLinkController;
    ...
    bool  __shouldShowActionsMenuPhotoTip;
    bool  __shouldShowInfoButtonTip;
    bool  __shouldShowLivePhotoEffectTip;
    bool  __shouldShowSydicatedPhotoTip;
...
@property (nonatomic, readonly) PUOneUpLinkController *_linkController;
...
@property (setter=_setNeedsUpdateLinkController:, nonatomic) bool _needsUpdateLinkController;
...
@property (setter=_setShouldShowActionsMenuPhotoTip:, nonatomic) bool _shouldShowActionsMenuPhotoTip;
@property (setter=_setShouldShowInfoButtonTip:, nonatomic) bool _shouldShowInfoButtonTip;
@property (setter=_setShouldShowLivePhotoEffectTip:, nonatomic) bool _shouldShowLivePhotoEffectTip;
@property (setter=_setShouldShowSyndicatedPhotoTip:, nonatomic) bool _shouldShowSydicatedPhotoTip;
...
@property (nonatomic, readonly) NSObject<OS_dispatch_queue> *tipKitQueue;
...
@property (nonatomic, readonly) bool wantsDocumentMenu;
...
- (void)_dismissTipPopoverAnimated:(bool)arg1 completion:(id /* block */)arg2;
...
- (void)_handleTipSuggestedActionCompletedWithIdentifier:(id)arg1 completion:(id /* block */)arg2;
...
- (bool)_needsUpdateLinkController;
...
- (void)_presentPopOverFromOneUpPresentationSession:(id)arg1 animated:(bool)arg2;
- (void)_presentTipPopovers:(id)arg1 content:(id)arg2 animated:(bool)arg3;
...
- (void)_setNeedsUpdateLinkController:(bool)arg1;
...
- (void)_setNeedsVisualImageAnalsis:(bool)arg1 forAssetViewModel:(id)arg2;
...
- (void)_setShouldShowActionsMenuPhotoTip:(bool)arg1;
- (void)_setShouldShowInfoButtonTip:(bool)arg1;
- (void)_setShouldShowLivePhotoEffectTip:(bool)arg1;
- (void)_setShouldShowSyndicatedPhotoTip:(bool)arg1;
...
- (bool)_shouldShowActionsMenuPhotoTip;
- (bool)_shouldShowInfoButtonTip;
- (bool)_shouldShowLivePhotoEffectTip;
- (bool)_shouldShowSydicatedPhotoTip;
...
- (bool)_vkImageOverlayHasSubjectAnalysisAvailableOrFailedFromProvider:(id)arg1;
...
- (void)menuActionController:(id)arg1 actionType:(id)arg2 actionStartedFromActionsMenu:(bool)arg3;
- (bool)menuActionControllerPreventRevealInMomentAction:(id)arg1;
- (id)menuActionControllerRemoveFromFeaturedPhotosAction:(id)arg1;
...
- (bool)oneUpBarsControllerWantsDocumentMenu:(id)arg1;
- (void)oneUpBarsControllerWillPresentActionsMenu:(id)arg1;
...
- (id)oneUpLinkControllerInteractionView:(id)arg1;
...
- (void)_axExecuteBlockOnTileViewControllers:(id /* block */)arg1;
