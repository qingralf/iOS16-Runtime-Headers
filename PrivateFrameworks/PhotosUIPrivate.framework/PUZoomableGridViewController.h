...
@interface PUZoomableGridViewController : PUPhotosGridViewController <PUMagnfiedViewControllerDelegate, PXChangeObserver, PXCloudQuotaControllerHelperDelegate, PXPhotosLibraryFooterViewModelPresentationDelegate> {
