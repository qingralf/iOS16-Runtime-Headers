...
- (void)_navigateToMomentShareWithURL:(id)arg1 animated:(bool)arg2;
...
- (void)_presentRetryAlertControllerWithTitle:(id)arg1 error:(id)arg2 retryHandler:(id /* block */)arg3;
...
- (void)navigateToCloudKitShareWithURL:(id)arg1 animated:(bool)arg2;
