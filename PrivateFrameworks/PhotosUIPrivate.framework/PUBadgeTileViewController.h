...
+ (struct CGSize { double x1; double x2; })_badgeTileSizeForBadgeInfo:(struct PXAssetBadgeInfo { unsigned long long x1; double x2; long long x3; long long x4; })arg1 contentWidth:(double)arg2;
