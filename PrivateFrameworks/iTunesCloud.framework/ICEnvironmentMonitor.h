...
@interface ICEnvironmentMonitor : NSObject <CoreTelephonyClientDataDelegate, CoreTelephonyClientRegistrationDelegate, NWNetworkOfInterestManagerDelegate> {
    ...
    bool  _currentNetworkLinkLowQuality;
...
@property (getter=isCurrentNetworkLinkLowQuality, nonatomic, readonly) bool currentNetworkLinkLowQuality;
...
- (bool)isCurrentNetworkLinkLowQuality;
