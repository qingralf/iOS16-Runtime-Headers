...
- (struct __CVBuffer { }*)newPixelBufferRenderedFromARFrame:(id)arg1 withEffect:(id)arg2 depthData:(id)arg3 videoDimensions:(struct { int x1; int x2; })arg4 fieldOfView:(float)arg5 captureOrientation:(long long)arg6 interfaceOrientation:(long long)arg7 preRecordedBlendShapes:(id)arg8;
- (id)preRecordedBlendShapesForFrame:(id)arg1 captureOrientation:(long long)arg2 interfaceOrientation:(long long)arg3;
- (void)renderAnimoji:(id)arg1 withPresentationTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 frame:(id)arg3 depthData:(id)arg4 completionBlock:(id /* block */)arg5;
- (void)renderFrame:(id)arg1 withEffect:(id)arg2 depthData:(id)arg3 videoDimensions:(struct { int x1; int x2; })arg4 fieldOfView:(float)arg5 captureOrientation:(long long)arg6 interfaceOrientation:(long long)arg7 preRecordedBlendShapes:(id)arg8 completionBlock:(id /* block */)arg9;
- (id)renderPassLock;
