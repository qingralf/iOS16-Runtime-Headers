...
- (id)JFX_renderAnimojiEffect:(id)arg1 forTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 withARFrame:(id)arg3 depthData:(id)arg4 inputBufferSize:(struct CGSize { double x1; double x2; })arg5 videoDimensions:(struct { int x1; int x2; })arg6 fieldOfView:(float)arg7 captureOrientation:(long long)arg8 interfaceOrientation:(long long)arg9 preRecordedBlendShapes:(id)arg10;
