...
- (void)_fetchBundleImageForBundleIdentifier:(id)arg1 activityCategory:(long long)arg2 contentSizeCategory:(id)arg3;
...
- (int)requestImageForBundleIdentifier:(id)arg1 activityCategory:(long long)arg2 contentSizeCategory:(id)arg3 resultHandler:(id /* block */)arg4;
