...
- (id)identifyComposeWarningsFromSubject:(id)arg1 content:(id)arg2 toRecipients:(id)arg3 ccRecipients:(id)arg4 bccRecipients:(id)arg5 originalToRecipients:(id)arg6 originalCcRecipients:(id)arg7 attachments:(id)arg8 error:(id*)arg9;
- (void)identifyComposeWarningsFromSubject:(id)arg1 content:(id)arg2 toRecipients:(id)arg3 ccRecipients:(id)arg4 bccRecipients:(id)arg5 originalToRecipients:(id)arg6 originalCcRecipients:(id)arg7 attachments:(id)arg8 withCompletion:(id /* block */)arg9;
...
- (id)identifyFollowUpWarningFromSubject:(id)arg1 content:(id)arg2 error:(id*)arg3;
- (void)identifyFollowUpWarningFromSubject:(id)arg1 content:(id)arg2 withCompletion:(id /* block */)arg3;
- (id)identifyWarningsFromSubject:(id)arg1 content:(id)arg2 toRecipients:(id)arg3 ccRecipients:(id)arg4 bccRecipients:(id)arg5 attachments:(id)arg6 error:(id*)arg7;
- (void)identifyWarningsFromSubject:(id)arg1 content:(id)arg2 toRecipients:(id)arg3 ccRecipients:(id)arg4 bccRecipients:(id)arg5 attachments:(id)arg6 withCompletion:(id /* block */)arg7;
- (id)identifyWarningsFromSubject:(id)arg1 content:(id)arg2 toRecipients:(id)arg3 ccRecipients:(id)arg4 bccRecipients:(id)arg5 originalToRecipients:(id)arg6 originalCcRecipients:(id)arg7 attachments:(id)arg8 error:(id*)arg9;
- (void)identifyWarningsFromSubject:(id)arg1 content:(id)arg2 toRecipients:(id)arg3 ccRecipients:(id)arg4 bccRecipients:(id)arg5 originalToRecipients:(id)arg6 originalCcRecipients:(id)arg7 attachments:(id)arg8 withCompletion:(id /* block */)arg9;
...
- (id)lastFollowUpWarningResultsWithLimit:(unsigned long long)arg1 includingResultsFromPreviousCall:(bool)arg2 error:(id*)arg3;
- (void)lastFollowUpWarningResultsWithLimit:(unsigned long long)arg1 includingResultsFromPreviousCall:(bool)arg2 withCompletion:(id /* block */)arg3;
...
- (id)reportMailIntelligenceFollowUpUserEngagement:(long long)arg1 forNSDataFromFollowUpWarning:(id)arg2 error:(id*)arg3;
- (void)reportMailIntelligenceFollowUpUserEngagement:(long long)arg1 forNSDataFromFollowUpWarning:(id)arg2 withCompletion:(id /* block */)arg3;
