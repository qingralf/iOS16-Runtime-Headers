...
@interface MRUMRMetadataDataSource : NSObject <MPArtworkCacheReference, MRUEndpointControllerObserver, MRUMetadataDataSource, _MCStateDumpPropertyListTransformable> {
    UIImage * _appIcon;
    MRUArtwork * _artwork;
    NSString * _bundleID;
