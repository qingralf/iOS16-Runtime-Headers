...
- (id)initWithIdentifier:(id)arg1 symbolName:(id)arg2 mainAction:(id /* block */)arg3;
- (id)initWithIdentifier:(id)arg1 symbolName:(id)arg2 mainAction:(id /* block */)arg3 holdBeganAction:(id /* block */)arg4 holdEndAction:(id /* block */)arg5;
- (bool)isEnabled;
