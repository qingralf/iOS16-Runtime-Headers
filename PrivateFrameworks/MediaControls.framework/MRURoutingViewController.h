...
@interface MRURoutingViewController : UIViewController <CARSessionObserving, MPAVRoutingControllerDelegate, MRUNowPlayingControllerObserver, MRURoutingTableViewCellDelegate, MRUVendorSpecificDeviceManagerDelegate, MRUVendorSpecificTableViewCellDelegate, UIGestureRecognizerDelegate, UITableViewDataSource, UITableViewDelegate, UITableViewDelegatePrivate> {
