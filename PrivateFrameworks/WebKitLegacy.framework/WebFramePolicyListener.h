...
- (void)download;
- (void)ignore;
- (id)initWithFrame:(struct NakedPtr<WebCore::Frame> { struct Frame {} *x1; })arg1 identifier:(struct PolicyCheckIdentifier { struct ObjectIdentifier<WebCore::ProcessIdentifierType> { unsigned long long x_1_1_1; } x1; unsigned long long x2; })arg2 policyFunction:(void*)arg3 defaultPolicy:(unsigned char)arg4;
- (id)initWithFrame:(struct NakedPtr<WebCore::Frame> { struct Frame {} *x1; })arg1 identifier:(struct PolicyCheckIdentifier { struct ObjectIdentifier<WebCore::ProcessIdentifierType> { unsigned long long x_1_1_1; } x1; unsigned long long x2; })arg2 policyFunction:(void*)arg3 defaultPolicy:(unsigned char)arg4 appLinkURL:(id)arg5;
- (void)invalidate;
