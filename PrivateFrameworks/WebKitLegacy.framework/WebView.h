...
- (struct Vector<WTF::String, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> { struct String {} *x1; unsigned int x2; unsigned int x3; })_dictationAlternatives:(struct ObjectIdentifier<WebCore::DictationContextType> { unsigned long long x1; })arg1;
