...
@property (nonatomic, copy) NSString *lastTimerID;
@property (nonatomic) double maximumInterval;
@property (nonatomic, retain) RMTimedDispatch *maximumTimer;
@property (nonatomic) double minimumInterval;
@property (nonatomic, retain) RMTimedDispatch *minimumTimer;
