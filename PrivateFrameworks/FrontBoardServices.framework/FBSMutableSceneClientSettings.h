...
@interface FBSMutableSceneClientSettings : FBSSceneClientSettings <BLSBacklightSceneClientSettings, BSDebugDescriptionProviding, BSXPCSecureCoding, PBMutablePosterSceneClientSettings, PREditingSceneClientSettings, PRMutableSceneClientSettings, PRRenderingSceneClientSettings, PRUIMutableSwitcherSceneClientSettings>
...
@property (setter=pr_setAverageColor:, nonatomic, retain) UIColor *pr_averageColor;
