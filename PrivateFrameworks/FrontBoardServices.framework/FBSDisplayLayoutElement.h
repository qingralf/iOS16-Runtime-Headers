...
@property (nonatomic, readonly) bool smu_isTVControlCenter;
@property (nonatomic, readonly) bool smu_isTVNotification;
@property (nonatomic, readonly) bool smu_isTVSystemIndicator;
