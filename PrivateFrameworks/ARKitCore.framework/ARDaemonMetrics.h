...
- (id)_reportDaemonHeartbeatForSessionUUID:(id)arg1 daemonUpTimeExcludingSleep:(id)arg2 daemonUpTimeIncludingSleep:(id)arg3 systemUpTime:(id)arg4 memoryFootprintInBytes:(unsigned long long)arg5;
- (id)init;
...
- (void)reportDaemonHeartbeatForSessionUUID:(id)arg1 daemonUpTimeExcludingSleep:(id)arg2 daemonUpTimeIncludingSleep:(id)arg3 systemUpTime:(id)arg4 memoryFootprintInBytes:(unsigned long long)arg5;
