...
@interface AuthenticationServicesCore.ASWebSocket : NSObject <NSURLSessionWebSocketDelegate> {
    void connectionCompletionHandler;
    void delegate;
    void isConnected;
    void testDelegate;
    void urlSession;
