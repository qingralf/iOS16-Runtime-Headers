...
@interface SessionCore.QoSObservationServiceClient : NSObject <ActivityKit.ActivityQoSObservationXPCServer> {
...
- (void).cxx_destruct;
- (id)init;
- (bool)subscribeToActivityQoSMatching:(id)arg1 error:(id*)arg2;
