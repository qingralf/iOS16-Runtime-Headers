...
@interface SessionCore.PresentationObservationServiceClient : NSObject <ActivityKit.ActivityPresentationObservationServiceXPCServer> {
...
- (void).cxx_destruct;
- (id)init;
- (bool)subscribeToActivityPresentationMatching:(id)arg1 error:(id*)arg2;
