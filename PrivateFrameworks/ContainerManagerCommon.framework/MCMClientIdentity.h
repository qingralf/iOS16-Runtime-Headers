...
- (id)init;
- (id)initInternal;
- (id)initWithPOSIXUser:(id)arg1 POSIXPID:(int)arg2 platform:(unsigned int)arg3 userIdentity:(id)arg4 effectiveAuditToken:(struct { unsigned int x1[8]; })arg5 realAuditToken:(struct { unsigned int x1[8]; })arg6 codeSignInfo:(id)arg7 sandboxed:(bool)arg8 sandboxContainerURL:(id)arg9 kernel:(bool)arg10;
...
- (bool)isKernel;
- (bool)isSandboxed;
- (char *)issueSandboxExtensionWithMetadata:(id)arg1 forceIssue:(bool)arg2 error:(unsigned long long*)arg3;
