...
- (void).cxx_destruct;
- (id)_clientIdentityWithClient:(struct container_client { char *x1; unsigned int x2; char *x3; unsigned int x4; unsigned int x5; struct { unsigned int x_6_1_1[8]; } x6; int x7; bool x8; bool x9; bool x10; id x11; }*)arg1 realAuditToken:(struct { unsigned int x1[8]; })arg2 error:(id*)arg3;
