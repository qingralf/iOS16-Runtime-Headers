...
- (void).cxx_destruct;
- (bool)_applyImplicitLinkOnBundleIdentity:(id)arg1 dataIdentity:(id)arg2 matchingIdentifier:(id)arg3 dataContainerClass:(unsigned long long)arg4 userIdentity:(id)arg5;
- (void)_applyImplicitLinksToMetadata:(id)arg1;
- (void)_checkAndRepairLinksToMetadata:(id)arg1 recursively:(bool)arg2;
...
- (bool)_shouldApplyImplicitLinksToMetadata:(id)arg1;
