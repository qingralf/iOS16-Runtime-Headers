...
@property (nonatomic, readonly) bool includeLinks;
...
- (id)initWithPlatform:(unsigned int)arg1 explicitFlags:(unsigned long long)arg2 identifiers:(id)arg3 containerClass:(unsigned long long)arg4 groupIdentifiers:(id)arg5 internalUUID:(id)arg6 createIfNecessary:(bool)arg7 includeInfoInResult:(bool)arg8 includePathInResult:(bool)arg9 issueSandboxExtensions:(bool)arg10 UID:(unsigned int)arg11 userIdentity:(id)arg12 transient:(bool)arg13 fuzzyMatchTransient:(bool)arg14 fuzzyMatchInternalUUID:(bool)arg15 includeUnowned:(bool)arg16 expectSingleResult:(bool)arg17 includeLinks:(bool)arg18 legacyPersonaPolicy:(bool)arg19 context:(id)arg20 resultPromise:(id)arg21;
- (id)internalUUID;
