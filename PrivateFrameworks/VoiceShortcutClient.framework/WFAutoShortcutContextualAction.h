...
+ (id)allActionsForAutoShortcut:(id)arg1 bundleIdentifier:(id)arg2;
...
- (id)initWithAutoShortcut:(id)arg1 phrase:(id)arg2 alternativePhrases:(id)arg3 bundleIdentifier:(id)arg4 orderOfShortcut:(unsigned long long)arg5 parentAction:(id)arg6 prominentDisplayEligibility:(id)arg7;
