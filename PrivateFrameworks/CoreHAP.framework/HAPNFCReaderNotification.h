...
- (id)_initializeNFCStream:(id)arg1 withSource:(unsigned long long)arg2 workQueue:(id)arg3 backgroundReadingSuported:(bool)arg4;
- (void)_initializeProxCardStreamWithQueue:(id)arg1 backgroundReadingSuported:(bool)arg2;
