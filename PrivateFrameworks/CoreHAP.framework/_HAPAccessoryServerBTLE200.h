...
@interface _HAPAccessoryServerBTLE200 : HAPAccessoryServerBTLE <CBPeripheralDelegate, HAPAuthSessionDelegate, HAPBTLEControlOutputStreamDelegate, HAPPairSetupSessionClientDelegate, HAPSecuritySessionDelegate, HMFLogging, HMFTimerDelegate> {
    ...
    NSMutableSet * _discoveredAccessoryCharacteriticsPendingRead;
...
@property (nonatomic, retain) NSMutableSet *discoveredAccessoryCharacteriticsPendingRead;
...
- (void)_readPendingDiscoveredCharacteritiscTypesWithCompletion:(id /* block */)arg1;
...
- (id)discoveredAccessoryCharacteriticsPendingRead;
- (id)discoveryContext;
...
- (void)setDiscoveredAccessoryCharacteriticsPendingRead:(id)arg1;
