...
- (void)_disconectFromHAPBLEPeripheral:(id)arg1 cbPeripheral:(id)arg2;
...
- (void)retrieveCurrentStateForIdentifer:(id)arg1 stateNumber:(id*)arg2 isReachable:(bool*)arg3 linkQuality:(unsigned long long*)arg4 lastSeen:(id*)arg5;
