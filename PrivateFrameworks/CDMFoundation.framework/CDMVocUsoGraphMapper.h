...
+ (id)buildEmergencyPhonePersonUSOGraphWithIdentifier:(id)arg1 withSemantic:(id)arg2 withInput:(id)arg3 withStartCharIndex:(unsigned int)arg4 withEndCharIndex:(unsigned int)arg5;
