...
@interface FCPersonalizationData : FCPrivateDataController <FCCoreConfigurationObserving, FCDerivedPersonalizationData, FCOperationThrottlerDelegate, FCPersonalizationDataSource> {
...
- (void)generateDerivedDataWithMaxAggregateCount:(unsigned long long)arg1 qualityOfService:(long long)arg2 completion:(id /* block */)arg3;
