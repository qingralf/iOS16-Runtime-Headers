...
- (id)initWithCaptureServer:(id)arg1 width:(int)arg2 height:(int)arg3 frameRate:(int)arg4 videoSourceToken:(struct _VCVideoSourceToken { union { struct { unsigned int x_1_2_1 : 24; unsigned int x_1_2_2 : 8; } x_1_1_1; unsigned int x_1_1_2; } x1; })arg5 cinematicFramingEnabled:(bool)arg6 videoOrientation:(int)arg7;
...
- (void)observeBackgroundBlurOnDevice:(id)arg1 observe:(bool)arg2;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void*)arg4;
- (bool)preferredAttributes:(id)arg1 baseFormat:(id)arg2;
- (void)prepareSynchronizedOutputs:(id)arg1;
- (void)processMetadataObjects:(id)arg1;
- (void)processSampleBuffer:(struct opaqueCMSampleBuffer { }*)arg1 captureOutput:(id)arg2;
- (void)processSampleBuffer:(struct opaqueCMSampleBuffer { }*)arg1 depthData:(id)arg2 faceData:(id)arg3 captureDevice:(id)arg4 clock:(struct OpaqueCMClock { }*)arg5;
- (void)processViewPointCorrection:(struct opaqueCMSampleBuffer { }*)arg1 shouldProcess:(bool)arg2;
