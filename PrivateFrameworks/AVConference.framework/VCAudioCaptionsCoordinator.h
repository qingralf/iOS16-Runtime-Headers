...
- (void)didStartCaptioningWithReason:(int)arg1;
- (void)didStopCaptioningWithReason:(int)arg1;
- (void)didUpdateCaptions:(id)arg1;
- (void)enableCaptions:(bool)arg1;
- (id)initWithOneToOneEnabled:(bool)arg1 reportingAgent:(struct opaqueRTCReporting { }*)arg2;
