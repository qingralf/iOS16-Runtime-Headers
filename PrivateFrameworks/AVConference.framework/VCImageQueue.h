...
- (void)dealloc;
- (id)description;
- (void)drawOverlayMessageForPixelBuffer:(struct __CVBuffer { }*)arg1;
...
- (bool)enqueuePixelBuffer:(struct __CVBuffer { }*)arg1 atTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2;
- (bool)enqueueSampleBuffer:(struct opaqueCMSampleBuffer { }*)arg1;
- (void)enqueueStreamOutputAttributes:(struct __CFDictionary { }*)arg1;
- (void)enqueueStreamOutputFrame:(struct __CVBuffer { }*)arg1 atTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2;
- (int)frameCount;
