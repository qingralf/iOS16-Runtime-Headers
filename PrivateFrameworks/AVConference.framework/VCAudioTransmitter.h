...
- (void)handleCodecModeChangeEvent:(struct _VCAudioCodecModeChangeEvent { int x1; int x2; int x3; unsigned int x4; })arg1 didUpdateBandwidth:(bool*)arg2 didUpdateBitrate:(bool*)arg3;
- (bool)ignoreSilence;
- (void)initAudioValues;
- (id)initWithConfig:(id)arg1;
- (unsigned char)inputMeter;
- (bool)isAudioStalled;
- (bool)isCodecModeChangeRequestValid:(struct _VCAudioCodecModeChangeEvent { int x1; int x2; int x3; unsigned int x4; })arg1;
...
- (bool)sendCodecModeChangeEvent:(struct _VCAudioCodecModeChangeEvent { int x1; int x2; int x3; unsigned int x4; })arg1;
- (int)sendSframeEncryptedAudioPacket:(struct tagAudioPacketData { struct tagAudioHeaderData { int x_1_1_1; unsigned int x_1_1_2; unsigned char x_1_1_3[16]; unsigned char x_1_1_4; float x_1_1_5; int x_1_1_6; int x_1_1_7; int x_1_1_8; unsigned char x_1_1_9; } x1; char *x2; int x3; })arg1;
...
- (bool)shouldUpdateCodecBandwidth:(struct _VCAudioCodecModeChangeEvent { int x1; int x2; int x3; unsigned int x4; })arg1;
- (bool)shouldUpdateCodecBitrate:(struct _VCAudioCodecModeChangeEvent { int x1; int x2; int x3; unsigned int x4; })arg1;
- (bool)shouldUseDtx;
- (void)start;
- (void)stop;
