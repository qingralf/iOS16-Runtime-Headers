...
- (bool)sendReliableMessage:(id)arg1 withTopic:(id)arg2 timeout:(id)arg3;
- (bool)sendReliableMessageInternal:(id)arg1 withTopic:(id)arg2 timeout:(id)arg3 useFastRetries:(bool)arg4;
