...
- (void)setRetainPixelBufferEnabled:(bool)arg1;
...
- (void)updateVideoBuffer:(struct __CVBuffer { }*)arg1 withPresentationTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg2 sampleBufferCopy:(struct opaqueCMSampleBuffer { }*)arg3 cameraStatusBits:(unsigned char)arg4 timestamp:(unsigned int)arg5 retainPixelBuffer:(bool)arg6;
- (int)videoCodec;
