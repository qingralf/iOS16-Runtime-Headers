...
@interface VCSessionParticipant : VCObject <VCAudioIODelegate, VCAudioIOSink, VCAudioPowerSpectrumSourceDelegate, VCConnectionChangedHandler, VCMediaStreamDelegate, VCMediaStreamGroupDelegate, VCRedundancyControllerDelegate, VCSecurityEventHandler> {
    bool  _audioEnabled;
    VCAudioIO * _audioIO;
    bool  _audioPaused;
...
@property (nonatomic, readonly) NSArray *allParticipantManagedStreamInfos;
...
@property (nonatomic, readonly) bool hasScreenStreams;
...
- (bool)configureVideoWithDeviceRole:(int)arg1 streamInfoArray:(id)arg2;
...
- (id)microphoneGroup;
- (id)newAudioRateControlConfigWithMediaControlInfoVersion:(unsigned char)arg1 isOneToOne:(bool)arg2;
...
- (id)newVideoRateControlConfigWithMediaControlInfoVersion:(unsigned char)arg1 enableMediaControlInfoGenerator:(bool)arg2 isOneToOne:(bool)arg3;
