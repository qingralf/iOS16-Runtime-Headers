...
- (int)configureWithBuffer:(const char *)arg1 length:(unsigned long long)arg2 optionalControlInfo:(struct { double x1; int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned short x8; bool x9; bool x10; }*)arg3;
- (id)delegate;
- (void)dispose;
...
- (id)initWithBuffer:(const char *)arg1 length:(unsigned long long)arg2 optionalControlInfo:(struct { double x1; int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned short x8; bool x9; bool x10; }*)arg3 version:(unsigned char)arg4;
- (void)invalidate;
