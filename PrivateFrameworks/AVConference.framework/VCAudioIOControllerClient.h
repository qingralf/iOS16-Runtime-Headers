...
@property (nonatomic, readonly) unsigned int channelIndex;
...
@property (nonatomic, readonly) struct _VCAudioIOControllerClientIO { void *x1; int (*x2)(); id x3; unsigned int x4; unsigned int x5; unsigned int x6; struct opaqueVCAudioBufferList {} *x7; }*sinkIO;
@property (nonatomic, readonly) struct _VCAudioIOControllerClientIO { void *x1; int (*x2)(); id x3; unsigned int x4; unsigned int x5; unsigned int x6; struct opaqueVCAudioBufferList {} *x7; }*sourceIO;
...
- (id)initWithDelegate:(id)arg1 audioSessionId:(unsigned int)arg2 channelIndex:(unsigned int)arg3 sourceContext:(void*)arg4 sourceProcess:(int (*)arg5 sinkContext:(void*)arg6 sinkProcess:(int (*)arg7 clientPid:(int)arg8 isPrewarmingClient:(bool)arg9 spatialToken:(unsigned long long)arg10;
...
- (struct _VCAudioIOControllerClientIO { void *x1; int (*x2)(); id x3; unsigned int x4; unsigned int x5; unsigned int x6; struct opaqueVCAudioBufferList {} *x7; }*)sinkIO;
- (struct _VCAudioIOControllerClientIO { void *x1; int (*x2)(); id x3; unsigned int x4; unsigned int x5; unsigned int x6; struct opaqueVCAudioBufferList {} *x7; }*)sourceIO;
