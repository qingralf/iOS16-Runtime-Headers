...
+ (void)computeMaxNetworkBitrate:(unsigned int*)arg1 maxMediaBitrate:(unsigned int*)arg2 maxPacketsPerSecond:(float*)arg3 maxIDSStreamIDCount:(unsigned int)arg4 internalPacketsPerSecond:(unsigned int)arg5 audioConfig:(struct _VCMediaStreamConfigurationProviderAudio { unsigned int x1; unsigned int x2; struct _VCMediaStreamConfigurationProviderAudioBitrateInfo { int x_3_1_1; unsigned int x_3_1_2; unsigned int x_3_1_3; unsigned int x_3_1_4; } x3; unsigned int x4; struct _VCMediaStreamConfigurationProviderAudioPayload { long long x_5_1_1; int x_5_1_2; } x5[4]; unsigned int x6; unsigned int x7[4]; int x8; bool x9; unsigned int x10; unsigned int x11; unsigned int x12; long long x13[9]; }*)arg6;
...
+ (bool)isVideoStreamOnDemand:(struct _VCMediaStreamConfigurationProviderVideo { long long x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; int x7; unsigned int x8; bool x9; unsigned int x10; }*)arg1;
...
- (bool)initializeVideoStreamWithConfig:(struct _VCMediaStreamConfigurationProviderVideo { long long x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; int x7; unsigned int x8; bool x9; unsigned int x10; }*)arg1 streamIndex:(unsigned int)arg2;
- (bool)initializeVideoStreamWithDefaults;
- (bool)initializeVideoStreams;
- (bool)isEncodingSqaures;
- (int)streamPayloadFromProviderConfig:(struct _VCMediaStreamConfigurationProviderVideo { long long x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; int x7; unsigned int x8; bool x9; unsigned int x10; }*)arg1;
