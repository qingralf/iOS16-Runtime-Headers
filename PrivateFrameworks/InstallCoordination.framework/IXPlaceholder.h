...
+ (id)_placeholderForBundle:(id)arg1 client:(unsigned long long)arg2 withParent:(id)arg3 installType:(unsigned long long)arg4 metadata:(id)arg5 placeholderType:(unsigned long long)arg6 error:(id*)arg7;
...
- (bool)_doInitWithBundleName:(id)arg1 bundleID:(id)arg2 installType:(unsigned long long)arg3 placeholderType:(unsigned long long)arg4;
...
- (bool)_internalInitAppExtensionPlaceholderWithBundleName:(id)arg1 bundleID:(id)arg2 parentPlaceholder:(id)arg3 placeholderType:(unsigned long long)arg4 client:(unsigned long long)arg5;
