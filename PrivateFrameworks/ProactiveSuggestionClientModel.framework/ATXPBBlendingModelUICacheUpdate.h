...
@property (nonatomic, readonly) bool hasSpotlightSuggestionLayout;
...
@property (nonatomic, retain) ATXPBSpotlightSuggestionLayout *spotlightSuggestionLayout;
...
- (void)setSpotlightSuggestionLayout:(id)arg1;
- (void)setSuggestionLayout:(id)arg1;
- (void)setUuidString:(id)arg1;
- (id)spotlightSuggestionLayout;
- (id)suggestionLayout;
- (id)uuidString;
