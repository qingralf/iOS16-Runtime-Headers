...
- (id)initFromFaceInfo:(const struct { unsigned char x1; unsigned short x2; unsigned short x3; unsigned short x4; unsigned short x5; unsigned int x6; float x7; float x8; float x9; }*)arg1;
