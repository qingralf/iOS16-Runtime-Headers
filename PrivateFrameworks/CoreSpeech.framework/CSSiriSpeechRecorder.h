...
- (void)_stopRecordingForEndpointReason:(union { struct { unsigned short x_1_1_1; unsigned short x_1_1_2; } x1; unsigned int x2; })arg1;
...
- (void)updateEndpointHintForDuration:(double)arg1 completion:(id /* block */)arg2;
