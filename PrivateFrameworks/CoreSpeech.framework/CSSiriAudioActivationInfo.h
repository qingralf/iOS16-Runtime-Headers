...
- (void).cxx_destruct;
- (long long)_activationMode;
- (id)_alertBehaviorForRecordRoute:(id)arg1 recordingInfo:(id)arg2 playbackRoute:(id)arg3 attemptsToUsePastDataBufferFrames:(bool)arg4;
- (id)_appendDictationApplicationInfoSettings:(id)arg1;
- (long long)_audioAlertStyleForListenAfterSpeakingWithRecordRoute:(id)arg1 playbackRoute:(id)arg2 echoCancellation:(bool)arg3 useDeviceSpeakerForTTS:(long long)arg4;
...
- (long long)audioAlertStyleForRecordRoute:(id)arg1 recordingInfo:(id)arg2 playbackRoute:(id)arg3;
...
- (bool)shouldOverrideRecordingStartingAlertBehaviorForAlertStyle:(long long)arg1;
