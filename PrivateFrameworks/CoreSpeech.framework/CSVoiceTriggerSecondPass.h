...
@interface CSVoiceTriggerSecondPass : NSObject <CSAudioServerCrashMonitorDelegate, CSAudioStreamProvidingDelegate, CSMediaPlayingMonitorDelegate, CSPhraseNDEAPIScorerDelegate, CSSelfTriggerDetectorDelegate, CSVoiceTriggerEnabledMonitorDelegate, CSVolumeMonitorDelegate, SSRSpeakerRecognitionControllerDelegate> {
    NSString * _UUID;
...
- (void)_analyzeForChannel:(unsigned long long)arg1 keywordDetectorResult:(id)arg2;
...
- (id)initWithPHSEnabled:(bool)arg1 speechManager:(id)arg2 stateQueue:(id)arg3 secondPassQueue:(id)arg4;
