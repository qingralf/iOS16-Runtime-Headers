...
- (id)initWithAsset:(id)arg1 assetConfig:(id)arg2 firstPassSource:(unsigned long long)arg3 activeChannel:(unsigned long long)arg4 siriLanguage:(id)arg5 shouldEnableShadowMicScore:(bool)arg6;
