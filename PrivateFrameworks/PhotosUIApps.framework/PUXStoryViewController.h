...
@interface PUXStoryViewController : UIViewController <PXActionPerformerDelegate, PXAssetCollectionActionPerformerDelegate, PXStoryExportActivityHelper, PXStoryPlayerTestElement, PXStoryViewActionPerformer, PXStoryViewController, PXStoryViewControllerTransitionEndPoint, PXTapToRadarDiagnosticProvider, PXUserInterfaceFeatureViewController, UIAdaptivePresentationControllerDelegate> {
    ...
    void viewEnvironmentActionPerformer;
...
@property (nonatomic, retain) <PXStoryViewEnvironmentActionPerformer> *viewEnvironmentActionPerformer;
...
- (void)setViewEnvironmentActionPerformer:(id)arg1;
...
- (void)viewDidLoad;
- (id)viewEnvironmentActionPerformer;
