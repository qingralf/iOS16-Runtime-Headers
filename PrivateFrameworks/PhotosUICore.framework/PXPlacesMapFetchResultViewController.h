...
@interface PXPlacesMapFetchResultViewController : UIViewController <PXChangeObserver, PXOneUpPresentationDelegate, PXPlacesMapControllerChangeDelegate, PXPlacesMapControllerSelectionDelegate, PXPlacesMapFetchResultControllerAccess> {
