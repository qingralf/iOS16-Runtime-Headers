...
@property (nonatomic, readonly) bool px_isNotUploadedSmartAlbum;
...
@property (nonatomic, readonly) bool px_isSharedLibrarySmartAlbum;
...
- (bool)px_isNotUploadedSmartAlbum;
...
- (bool)px_isSharedLibrarySmartAlbum;
