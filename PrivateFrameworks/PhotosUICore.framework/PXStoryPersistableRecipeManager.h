...
+ (bool)_addCurationChangeList:(id)arg1 toPersistableRecipe:(id)arg2 originalPersistableRecipe:(id)arg3 availableAssets:(id)arg4 userCuration:(bool)arg5 error:(id*)arg6;
