...
+ (void)_requestImageForContact:(id)arg1 targetSize:(struct CGSize { double x1; double x2; })arg2 displayScale:(double)arg3 isRTL:(bool)arg4 completion:(id /* block */)arg5;
...
+ (void)requestImageForContact:(id)arg1 targetSize:(struct CGSize { double x1; double x2; })arg2 displayScale:(double)arg3 isRTL:(bool)arg4 completion:(id /* block */)arg5;
