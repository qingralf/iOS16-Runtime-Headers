...
@property (nonatomic, readonly, copy) PXStoryItemPlacement *viewControllerDismissalTargetPlacement;
...
+ (void)registerViewModelDesiringPlayback:(id)arg1;
+ (void)unregisterViewModelDesiringPlayback:(id)arg1;
