...
- (id)init;
- (id)initWithDataSourceManager:(id)arg1 selectionManager:(id)arg2 mediaProvider:(id)arg3 specManager:(id)arg4 loadingStatusManager:(id)arg5 badgesModifier:(id /* block */)arg6 preferredAssetCropDelegate:(id)arg7;
