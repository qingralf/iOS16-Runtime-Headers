...
@property (nonatomic, readonly) NSArray *assetUUIDsAllowedToHighlightText;
...
@property (nonatomic, readonly) NSArray *matchedQueryStrings;
...
- (id)_dci_contextMenuInteraction:(id)arg1 previewForDismissingToSecondaryItemWithIdentifier:(id)arg2 configuration:(id)arg3;
- (id)_dci_contextMenuInteraction:(id)arg1 previewForHighlightingSecondaryItemWithIdentifier:(id)arg2 configuration:(id)arg3;
