...
@interface PXPeopleCollectionViewController : UICollectionViewController <PXChangeObserver, PXPeopleCollectionViewCellDelegate, PXPeopleDragAndDropCollectionViewDelegate, PXPeopleDragAndDropCollectionViewDelegateLayout, PXPeopleSectionedDataSourceChangeObserver, PXPeopleSwipeSelectionManagerDelegate, UICollectionViewDelegateFlowLayout, UIGestureRecognizerDelegate, UIPopoverPresentationControllerDelegate, UIViewControllerTransitioningDelegate> {
...
@property (nonatomic, retain) UIAction *manualSortAction;
...
@property (nonatomic, retain) UIAction *nameSortAction;
