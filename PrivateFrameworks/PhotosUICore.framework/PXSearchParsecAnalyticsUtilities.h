...
+ (id)SFSearchResultFromSearchSuggestion:(id)arg1 isZeroKeyword:(bool)arg2 queryId:(long long)arg3;
...
+ (id)_descriptionForSearchUserCategory:(unsigned long long)arg1;
...
+ (id)_resultSectionForSearchSuggestions:(id)arg1 isZeroKeywordSection:(bool)arg2 queryId:(long long)arg3;
