...
- (id)estimationQueue;
- (id)init;
- (id)initWithMediaProvider:(id)arg1 screenScale:(double)arg2 videoSessionManager:(id)arg3 loadingStatusReporter:(id)arg4 storyQueue:(id)arg5 isExporting:(bool)arg6;
- (double)isExporting;
