...
- (void)processCollectionSearchResults:(id)arg1 assetSearchResults:(id)arg2 personSearchResults:(id)arg3 searchSuggestions:(id)arg4 sceneIdentifiers:(id)arg5 matchedQueryStrings:(id)arg6 matchedOCRAssetUUIDs:(id)arg7 forSearchQuery:(id)arg8;
