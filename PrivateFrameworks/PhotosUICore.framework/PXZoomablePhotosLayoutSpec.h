...
- (id)initWithExtendedTraitCollection:(id)arg1 options:(unsigned long long)arg2 availableThumbnailSizes:(id)arg3 gridStyle:(long long)arg4 itemAspectRatio:(double)arg5 userDefaults:(id)arg6 forceSaliency:(bool)arg7;
