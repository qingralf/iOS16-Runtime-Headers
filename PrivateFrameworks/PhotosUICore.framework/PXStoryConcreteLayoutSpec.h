...
@interface PXStoryConcreteLayoutSpec : PXFeatureSpec <PXStoryLayoutSpec> {
    ...
    bool  _thumbnailMenuPrefersFeatureLessActionDisambiguationSubmenu;
    struct CGSize { 
        double width; 
        double height; 
...
@property (nonatomic, readonly) bool thumbnailMenuPrefersFeatureLessActionDisambiguationSubmenu;
...
- (bool)thumbnailMenuPrefersFeatureLessActionDisambiguationSubmenu;
