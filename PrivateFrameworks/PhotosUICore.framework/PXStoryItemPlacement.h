...
@interface PXStoryItemPlacement : NSObject <NSCopying, PXStoryMutableItemPlacement> {
    double  _alpha;
    double  _chromeAlpha;
    ...
    PXStoryItemPlacement * _otherItemsPlacement;
    struct CGRect { 
        struct CGPoint { 
            double x; 
            double y; 
...
@property (nonatomic, readonly) PXStoryItemPlacement *adjustedPreferredPlacement;
...
@property (nonatomic, readonly) PXStoryItemPlacement *otherItemsPlacement;
