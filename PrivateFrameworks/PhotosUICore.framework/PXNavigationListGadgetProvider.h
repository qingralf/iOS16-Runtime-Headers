...
- (id)initWithType:(unsigned long long)arg1 extendedTraitCollection:(id)arg2 isPresentedInPicker:(bool)arg3 isLimitedLibraryPicker:(bool)arg4 assetsFilterPredicate:(id)arg5 excludesHiddenAlbum:(bool)arg6;
