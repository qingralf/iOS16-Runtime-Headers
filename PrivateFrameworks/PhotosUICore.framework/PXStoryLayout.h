...
@interface PXStoryLayout : PXGAbsoluteCompositeLayout <PXChangeObserver, PXGShadowSource, PXStoryItemPlacementController, PXTapToRadarDiagnosticProvider> {
...
@property (nonatomic, retain) PXStoryItemPlacement *fullsizeContentPlacementOverride;
