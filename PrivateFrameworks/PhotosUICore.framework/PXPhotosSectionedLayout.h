...
@interface PXPhotosSectionedLayout : PXGStackLayout <PXAssetSectionLayoutDelegate, PXChangeObserver, PXGSublayoutFaultingDelegate, PXGSublayoutProvider, PXPhotosSectionBodyLayoutProviderInvalidationDelegate, PXPhotosSectionHeaderLayoutProviderInvalidationDelegate> {
