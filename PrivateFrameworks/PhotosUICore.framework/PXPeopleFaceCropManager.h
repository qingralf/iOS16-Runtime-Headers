...
+ (double)_cornerRadiusForCornerStyle:(long long)arg1 pixelTargetSize:(struct CGSize { double x1; double x2; })arg2;
+ (double)_cropFactorValueForCropFactor:(long long)arg1;
+ (id)_cropQueue;
+ (id)_faceCropManagerLog;
+ (id)_fetchQueue;
+ (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_normalizedFaceCropRectForFace:(id)arg1 cropFactor:(long long)arg2;
...
- (void)_invalidateCacheForLocalIdentifiers:(id)arg1 wantsNotificationPosted:(bool)arg2;
