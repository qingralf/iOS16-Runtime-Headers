...
- (id)description;
- (id)init;
- (id)initWithCustomColorGradeKind:(long long)arg1 originalColorGradeCategory:(id)arg2 songResource:(id)arg3 cueSource:(id)arg4 autoEditDecisionList:(id)arg5 styleOptions:(struct { unsigned long long x1; bool x2; })arg6 isCustomized:(bool)arg7;
- (bool)isCustomized;
