...
@property (nonatomic, readonly) <PXGDisplayAssetPixelBufferSourcesProvider> *pixelBufferSourcesProvider;
...
- (id)_requestOptionsForUseCase:(unsigned long long)arg1 forDrawing:(bool)arg2 intent:(unsigned long long)arg3;
...
- (void)_workQueue_handleCGImageResult:(struct CGImage { }*)arg1 orientation:(unsigned int)arg2 info:(id)arg3 targetSize:(struct CGSize { double x1; double x2; })arg4 adjustment:(id)arg5 shouldCache:(bool)arg6 textureRequestID:(int)arg7;
...
- (void)_workQueue_provideCGImage:(struct CGImage { }*)arg1 options:(struct { id x1; })arg2 isDegraded:(bool)arg3 forRequestID:(int)arg4;
