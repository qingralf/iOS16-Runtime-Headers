...
- (void)_processedQueryResultsForSearchQuery:(id)arg1 psiQuery:(id)arg2 assetResults:(id)arg3 assetResultsForCompletions:(id)arg4 collectionResults:(id)arg5 topAssetsResult:(id)arg6 topCollectionResults:(id)arg7;
