...
- (id)description;
- (id)init;
- (id)initWithThumbnailSize:(struct CGSize { double x1; double x2; })arg1 pixelFormat:(unsigned long long)arg2 capacityPerAtlas:(unsigned int)arg3 requestQueue:(id)arg4 layoutQueue:(id)arg5 colorProgram:(id)arg6 context:(id)arg7;
- (id)layoutQueue;
