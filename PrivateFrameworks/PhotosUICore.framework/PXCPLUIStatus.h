...
@interface PXCPLUIStatus : NSObject {
    ...
    long long  _serviceAction2;
    long long  _state;
    NSString * _stateDescription;
}

@property (nonatomic, copy) id /* block */ action;
@property (nonatomic, copy) id /* block */ action2;
...
@property (nonatomic) long long serviceAction2;
...
- (long long)serviceAction2;
- (void)setAction2:(id /* block */)arg1;
...
- (void)setServiceAction2:(long long)arg1;
