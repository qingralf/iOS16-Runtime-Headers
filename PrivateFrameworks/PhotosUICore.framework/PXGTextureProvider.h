...
- (void)provideCGImage:(struct CGImage { }*)arg1 options:(struct { id x1; })arg2 forRequestID:(int)arg3;
- (void)provideCGImage:(struct CGImage { }*)arg1 options:(struct { id x1; })arg2 isDegraded:(bool)arg3 forRequestID:(int)arg4;
...
- (void)providePixelBuffer:(struct __CVBuffer { }*)arg1 options:(struct { id x1; })arg2 forRequestID:(int)arg3;
