...
@interface PXGTextureManager : NSObject <PXGTextureAtlasManagerDelegate, PXGTextureProviderDelegate> {
    ...
    struct { struct { unsigned int x_1_1_1; } x1; int x2; int x3; int x4; unsigned short x5; void *x6; unsigned int x7; void *x8; unsigned int x9; unsigned int x10; unsigned char x11; } * _streamInfoBySpriteIndex;
...
- (void)_applyAdjustment:(id)arg1 toTexture:(id)arg2 fromTextureProvider:(id)arg3 withTextureConverter:(id)arg4 forRequestID:(int)arg5 deliveryOrder:(unsigned int)arg6 requestDetails:(struct { int x1; unsigned int x2; })arg7;
...
- (id)_createTextureForCGImage:(void *)arg1 requestID:(void *)arg2 requestDetails:(void *)arg3 transform:(void *)arg4 fromTextureProvider:(void *)arg5 withTextureConverter:(void *)arg6; // needs 6 arg types, found 5: struct CGImage { }*, int, struct { int x1; unsigned int x2; }, id, id
- (id)_createTextureForCVPixelBuffer:(void *)arg1 requestID:(void *)arg2 requestDetails:(void *)arg3 transform:(void *)arg4 fromTextureProvider:(void *)arg5 withTextureConverter:(void *)arg6; // needs 6 arg types, found 5: struct __CVBuffer { }*, int, struct { int x1; unsigned int x2; }, id, id
...
- (bool)_getRequestDetails:(out struct { int x1; unsigned int x2; }*)arg1 forRequestID:(int)arg2;
- (void)_handleProvidedSpriteTexture:(id)arg1 fromTextureProvider:(id)arg2 requestID:(int)arg3 deliveryOrder:(unsigned int)arg4;
- (void)_lookupLock_requestTexturesForSpritesInRange:(struct _PXGSpriteIndexRange { unsigned int x1; unsigned int x2; })arg1 textureProvider:(id)arg2 mediaKind:(int)arg3 presentationType:(int)arg4 isAppearing:(bool)arg5 layout:(id)arg6 leafSpriteIndexRange:(struct _PXGSpriteIndexRange { unsigned int x1; unsigned int x2; })arg7 sprites:(struct { unsigned int x1; struct { /* ? */ } *x2; struct { /* ? */ } *x3; struct { /* ? */ } *x4; struct { /* ? */ } *x5; })arg8 textureStreamInfos:(struct { struct { unsigned int x_1_1_1; } x1; int x2; int x3; int x4; unsigned short x5; void *x6; unsigned int x7; void *x8; unsigned int x9; unsigned int x10; unsigned char x11; }*)arg9 loadingStatus:(id)arg10;
- (void)_processCGImage:(struct CGImage { }*)arg1 options:(struct { id x1; })arg2 isDegraded:(bool)arg3 fromTextureProvider:(id)arg4 withTextureConverter:(id)arg5 requestID:(int)arg6 requestDetails:(struct { int x1; unsigned int x2; })arg7 deliveryOrder:(unsigned int)arg8;
- (void)_processPixelBuffer:(struct __CVBuffer { }*)arg1 options:(struct { id x1; })arg2 fromTextureProvider:(id)arg3 withTextureConverter:(id)arg4 forRequestID:(int)arg5 requestDetails:(struct { int x1; unsigned int x2; })arg6 deliveryOrder:(unsigned int)arg7;
...
- (void)textureProvider:(id)arg1 didProvideCGImage:(struct CGImage { }*)arg2 options:(struct { id x1; })arg3 isDegraded:(bool)arg4 forRequestID:(int)arg5;
...
- (void)textureProvider:(id)arg1 didProvidePixelBuffer:(struct __CVBuffer { }*)arg2 options:(struct { id x1; })arg3 forRequestID:(int)arg4;
