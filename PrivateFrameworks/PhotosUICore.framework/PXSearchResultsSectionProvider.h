...
@property (nonatomic, copy) NSArray *matchedOCRAssetUUIDs;
...
- (void)_setSearchResults:(id)arg1 searchAssetResults:(id)arg2 curatedAssetsFetchResult:(id)arg3 reloadItemIdentifiers:(id)arg4 localizedQueryString:(id)arg5 matchedQueryStrings:(id)arg6 matchedOCRAssetUUIDs:(id)arg7;
...
- (void)setMatchedOCRAssetUUIDs:(id)arg1;
