...
@property (nonatomic, readonly, copy) NSArray *matchedOCRAssetUUIDs;
@property (nonatomic, readonly, copy) NSArray *matchedQueryStrings;
...
- (id)initWithSearchQuery:(id)arg1 searchResults:(id)arg2 searchAssetResults:(id)arg3 curatedAssetsFetchResult:(id)arg4 searchSuggestions:(id)arg5 sceneIdentifiers:(id)arg6 matchedQueryStrings:(id)arg7 matchedOCRAssetUUIDs:(id)arg8 reloadItemIdentifiers:(id)arg9;
