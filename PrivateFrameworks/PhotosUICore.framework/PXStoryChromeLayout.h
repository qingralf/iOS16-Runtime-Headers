...
@interface PXStoryChromeLayout : PXGAbsoluteCompositeLayout <PXChangeObserver, PXGNamedImageSource, PXGStringSource, PXGViewSource, PXMenuDelegate> {
...
- (void)_handleToggleFullscreenButton:(id)arg1;
