...
- (void)_fetchUserRecordIDWithCompletionHandler:(id /* block */)arg1;
...
- (void)_unlinkContainersWithPristineContainerIDs:(id)arg1;
...
- (void)setOptimizeStorageEnabled:(bool)arg1 forKey:(id)arg2;
...
- (bool)shouldStartCiconiaBasedOnItemsCount:(unsigned long long)arg1;
