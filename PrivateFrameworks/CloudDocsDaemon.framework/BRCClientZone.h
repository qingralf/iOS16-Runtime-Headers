...
- (bool)existsByParentID:(id)arg1 andCaseInsensitiveLogicalName:(id)arg2 excludingItemID:(id)arg3;
- (bool)existsByParentID:(id)arg1 andCaseInsensitiveLogicalName:(id)arg2 excludingItemID:(id)arg3 db:(id)arg4;
