...
- (void)_addExternalDocumentReferenceTo:(id)arg1 session:(id)arg2 inContainer:(id)arg3 underParent:(id)arg4 reply:(id /* block */)arg5;
- (void)_addExternalDocumentReferenceTo:(id)arg1 session:(id)arg2 underParent:(id)arg3 forceReparent:(bool)arg4 reply:(id /* block */)arg5;
...
- (bool)_isErrorAnExpectedError:(id)arg1 originatorId:(unsigned long long)arg2;
...
- (void)_t_dropReaderJobAtURL:(id)arg1 reply:(id /* block */)arg2;
...
- (void)_t_getReaderStateAtURL:(id)arg1 reply:(id /* block */)arg2;
...
- (void)launchSyncConsistencyChecksWithReply:(id /* block */)arg1;
...
- (void)queryLoggedInAccountDescriptorsWithReply:(id /* block */)arg1;
- (void)queryPathsForPersona:(id)arg1 reply:(id /* block */)arg2;
- (void)querySyncedRootURLsForPersona:(id)arg1 reply:(id /* block */)arg2;
- (void)queryTelemetryEnablement:(id /* block */)arg1;
...
- (void)reportCleanupFailureDuringSilentMigration:(id)arg1 operationType:(id)arg2 uuid:(id)arg3 reply:(id /* block */)arg4;
...
- (void)reportOverBounceDuringSilentMigration:(id)arg1 total:(unsigned long long)arg2 uuid:(id)arg3 reply:(id /* block */)arg4;
