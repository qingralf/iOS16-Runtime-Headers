...
- (void)startWithParametersUpdateCallback:(struct function<void (const std::string &, const std::optional<LM::TrialParameters> &)>={__value_func<void (const std::string &, const std::optional<LM::TrialParameters> &)>={type=[24C] {})arg1;
