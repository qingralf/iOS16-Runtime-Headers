...
@interface _MPCPlaybackEngineMediaFoundationImplementation : NSObject <MFPlaybackStackControllerDelegate, MPCAssetLoaderDelegate, MPCPlaybackEngineImplementation, MPCQueueControllerDelegate> {
...
@property (nonatomic, retain) MPCPlayPerfAnalytics *playPerfAnalytics;
...
- (void)setPlayPerfAnalytics:(id)arg1;
