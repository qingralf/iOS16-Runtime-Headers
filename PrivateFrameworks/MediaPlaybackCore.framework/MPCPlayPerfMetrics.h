...
@property (setter=set_assetLocation:, nonatomic, retain) NSString *assetLocation;
...
@property (setter=set_checkpointItemBegin:, nonatomic, retain) NSNumber *checkpointItemBegin;
@property (setter=set_checkpointItemConfigBegin:, nonatomic, retain) NSNumber *checkpointItemConfigBegin;
...
@property (setter=set_getTracksWaitTime:, nonatomic, retain) NSNumber *getTracksWaitTime;
...
- (void)set_checkpointItemBegin:(id)arg1;
- (void)set_checkpointItemConfigBegin:(id)arg1;
...
- (void)set_getTracksWaitTime:(id)arg1;
