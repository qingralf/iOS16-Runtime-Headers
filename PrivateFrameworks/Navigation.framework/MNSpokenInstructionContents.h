...
+ (id)contentsWithStep:(id)arg1 destination:(id)arg2 options:(struct { long long x1; double x2; bool x3; bool x4; bool x5; bool x6; int x7; int x8; }*)arg3 isSecondary:(bool)arg4;
