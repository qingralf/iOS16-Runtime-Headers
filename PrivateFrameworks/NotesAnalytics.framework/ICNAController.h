...
- (void)endSessionSynchronously:(bool)arg1;
- (void)endSessionSynchronously:(bool)arg1 forSessionType:(id)arg2;
- (void)endSessionSynchronously:(bool)arg1 forSessionType:(id)arg2 successHandler:(id /* block */)arg3;
- (void)endWindowSceneSessionSynchronously:(bool)arg1 forSessionType:(id)arg2 windowScene:(id)arg3;
- (void)endWindowSceneSessionSynchronously:(bool)arg1 forSessionType:(id)arg2 windowScene:(id)arg3 successHandler:(id /* block */)arg4;
- (id)flushManager;
...
- (id)sessionDataWithType:(id)arg1;
...
- (void)submitEventOfType:(Class)arg1;
