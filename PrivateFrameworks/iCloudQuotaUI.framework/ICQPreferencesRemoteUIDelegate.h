...
@interface ICQPreferencesRemoteUIDelegate : NSObject <ICQUpgradeFlowManagerDelegate, PSCloudStorageOffersManagerDelegate, PreferencesRemoteUIDelegateProtocol, RUILoaderDelegate, RUIObjectModelDelegate> {
    ACAccount * _account;
