...
@interface ICQCloudStorageGroupController : NSObject <CloudStorageGroupControllerProtocol, DelayedPushDelegate, PSCloudStorageOffersManagerDelegate, RUITableViewRowDelegate> {
    bool  _buyMore;
