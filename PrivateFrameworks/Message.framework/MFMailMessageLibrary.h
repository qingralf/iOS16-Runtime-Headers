...
@interface MFMailMessageLibrary : NSObject <EDMessageChangeHookResponder, EFContentProtectionObserver, EFLoggable, EFSignpostable> {
...
- (id)_predicatesSeparatedByMailboxForAndPredicate:(id)arg1 containsMailboxPredicate:(bool*)arg2;
- (id)_predicatesSeparatedByMailboxForOrPredicate:(id)arg1 containsMailboxPredicate:(bool*)arg2;
- (id)_predicatesSeparatedByMailboxForPredicate:(id)arg1 containsMailboxPredicate:(bool*)arg2;
...
- (id)_sqlQueryForQuery:(id)arg1 byConvertingToCriteria:(bool)arg2 queryTransformer:(id)arg3 connection:(id)arg4 options:(unsigned int)arg5;
- (bool)_storeRemoteContentLinksCachedOnMessage:(id)arg1 linksToVerify:(id*)arg2;
- (id)_stringsForIndexSet:(id)arg1;
- (bool)_writeEmlxFile:(id)arg1 withData:(id)arg2 protectionClass:(int)arg3;
...
- (void)detectDataFromPlainTextMessage:(id)arg1 globalMessageID:(long long)arg2 mimePart:(id)arg3;
...
- (void)iterateMessagesMatchingQuery:(id)arg1 byConvertingToCriteria:(bool)arg2 queryTransformer:(id)arg3 withResultHandler:(id)arg4 options:(unsigned int)arg5 withMonitor:(id)arg6;
...
- (id)newestUIDsMissingBodyDataForMailbox:(id)arg1 excluding:(id)arg2 inLatest:(long long)arg3 limit:(long long)arg4;
