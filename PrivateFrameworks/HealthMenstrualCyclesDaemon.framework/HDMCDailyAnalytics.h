...
- (bool)_collectSensitiveFieldsForMetric:(id)arg1 settingsManager:(id)arg2 heartRateInputFeatureStatus:(id)arg3 wristTemperatureInputFeatureStatus:(id)arg4 gregorianCalendar:(id)arg5 error:(id*)arg6;
