...
- (void).cxx_destruct;
- (id)_analysisWithAlgorithmsAnalysis:(id)arg1 algorithmsCycles:(id)arg2 recentSymptoms:(unsigned long long)arg3 mostRecentBasalBodyTemperature:(id)arg4 lastLoggedDayIndex:(id)arg5 lastMenstrualFlowDayIndex:(id)arg6 numberOfDailySleepHeartRateStatisticsForPast100Days:(long long)arg7 numberOfDailyAwakeHeartRateStatisticsForPast100Days:(long long)arg8 useHeartRateInput:(bool)arg9 isHeartRateInputOnboarded:(bool)arg10 useWristTemperatureInput:(bool)arg11 isWristTemperatureInputOnboarded:(bool)arg12;
- (id)_analyzeWithForceIncludeCycles:(bool)arg1 error:(id*)arg2;
- (void)_calendarDayDidChange:(id)arg1;
- (void)_forceDisablePredictionsFromOngoingCycleFactors:(id)arg1 useHeartRateInput:(bool)arg2 isHeartRateInputOnboarded:(bool)arg3 useWristTemperatureInput:(bool)arg4 isWristTemperatureInputOnboarded:(bool)arg5;
- (id)_processorConfigurationForTodayIndex:(long long)arg1 calendar:(id)arg2;
- (void)_queue_analyzeIfNeeded;
- (id)_queue_analyzeNowWithForceIncludeCycles:(bool)arg1 error:(id*)arg2;
- (id)_queue_computeAnalysisWithDatabaseAccessibilityAssertion:(id)arg1 forceIncludeCycles:(bool)arg2 error:(id*)arg3;
...
- (id)initWithProfile:(id)arg1 settingsManager:(id)arg2 featureAvailabilityManager:(id)arg3 heartRateAvailabilityManager:(id)arg4 wristTemperatureAvailabilityManager:(id)arg5 deviationsAvailabilityManager:(id)arg6 calendarCache:(id)arg7;
