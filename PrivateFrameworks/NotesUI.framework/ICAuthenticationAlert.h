...
+ (id)changeOtherAccountCustomPasswordsActionAlertWithAccount:(id)arg1 otherAccount:(id)arg2;
...
+ (void)markSwitchToDevicePasswordPromptPresentedCountForAccount:(id)arg1;
+ (id)messageForAuthenticationCannotLockReason:(unsigned long long)arg1;
