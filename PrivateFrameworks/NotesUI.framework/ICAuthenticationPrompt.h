...
@property (nonatomic, readonly) bool forcesAlternativeAuthentication;
@property (nonatomic, readonly) bool forcesBiometricAuthentication;
@property (nonatomic, readonly) bool forcesSecondaryAuthentication;
@property (nonatomic) bool hasCloudAccount;
@property (nonatomic) bool hasDevicePassword;
@property (nonatomic, readonly) bool hasDivergedPassphrase;
@property (nonatomic) bool hasKeychainItem;
@property (nonatomic, readonly) bool hasPassphrase;
...
@property (nonatomic, readonly) bool needsDevicePassword;
@property (nonatomic, readonly) bool needsKeychain;
