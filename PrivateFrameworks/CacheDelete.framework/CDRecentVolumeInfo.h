...
- (id)thresholds;
- (id)timestamp;
- (bool)updateServiceInfoAmount:(id)arg1 forService:(id)arg2 atUrgency:(int)arg3 withTimestamp:(double)arg4 nonPurgeableAmount:(id)arg5 deductFromCurrentAmount:(bool)arg6;
