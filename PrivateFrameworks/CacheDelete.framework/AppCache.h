...
+ (id)appCacheWithRecords:(id)arg1 identifier:(id)arg2 dataContainerURL:(id)arg3 personaUniqueString:(id)arg4 isEnterprise:(bool)arg5 isPlaceholder:(bool)arg6 isPlugin:(bool)arg7 telemetry:(id)arg8;
...
- (id)identifier;
- (id)initWithBundleRecords:(id)arg1 identifier:(id)arg2 dataContainerURL:(id)arg3 personaUniqueString:(id)arg4 isEnterprise:(bool)arg5 isPlaceholder:(bool)arg6 isPlugin:(bool)arg7 telemetry:(id)arg8;
- (void)invalidate;
- (bool)isEnterprise;
- (bool)isPlaceholder;
- (bool)isPlugin;
