...
+ (void)generateCollectionFromPasteboard:(id)arg1 sandboxExtensionProvider:(id)arg2 completionHandler:(id /* block */)arg3;
+ (id)requiredResourcesForContentInPasteboard:(id)arg1;

- (void)getRecipients:(id /* block */)arg1;
- (void)getRecipientsIgnoringContactAccessResourceAvailability:(bool)arg1 completion:(id /* block */)arg2;
