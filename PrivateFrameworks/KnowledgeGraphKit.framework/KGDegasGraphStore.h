...
- (bool)openWithMode:(unsigned long long)arg1 nameCache:(id)arg2 error:(id*)arg3;
- (id)orderedArrayOfEdgesWithIdentifiers:(id)arg1 error:(id*)arg2;
- (id)orderedArrayOfNodesWithIdentifiers:(id)arg1 error:(id*)arg2;
