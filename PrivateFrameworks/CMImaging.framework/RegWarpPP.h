...
+ (int)CheckParameters:(struct { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; float x8; float x9; unsigned int x10; bool x11; bool x12; }*)arg1 imageWidth:(unsigned int)arg2 imageHeight:(unsigned int)arg3 imageFormat:(unsigned int)arg4;
+ (unsigned int)computeExternalMemoryBlockSize:(struct { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; float x8; float x9; unsigned int x10; bool x11; bool x12; }*)arg1 imageWidth:(unsigned int)arg2 imageHeight:(unsigned int)arg3 imageFormat:(unsigned int)arg4;
...
+ (void)getDefaults:(struct { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; float x8; float x9; unsigned int x10; bool x11; bool x12; }*)arg1;
...
- (id)initWithConfig:(struct { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; float x8; float x9; unsigned int x10; bool x11; bool x12; }*)arg1;
