...
- (const struct opaqueCMFormatDescription { }*)audioFormat;
- (id)audioInput;
...
- (id)initWithVideoFormat:(const struct opaqueCMFormatDescription { }*)arg1 audioFormat:(const struct opaqueCMFormatDescription { }*)arg2 initialFragmentSequenceNumber:(unsigned long long)arg3 preferredOutputSegmentInterval:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg4;
...
- (const struct opaqueCMFormatDescription { }*)videoFormat;
- (id)videoInput;
- (id)workQueue;
