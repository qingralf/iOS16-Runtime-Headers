...
- (id)initWithModelAtURL:(id)arg1 key:(id)arg2 modelAttributes:(id)arg3 standardizeURL:(bool)arg4 string_id:(unsigned long long)arg5 generateNewStringId:(bool)arg6;
