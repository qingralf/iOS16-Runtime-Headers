...
- (void).cxx_destruct;
- (void)_addInstallationStatusForLegacyDictationAssets:(id*)arg1;
...
- (id)_overrideAssetStatus:(unsigned long long)arg1;
- (bool)_purgeInstalledAssetsExceptLanguages:(id)arg1 assetType:(unsigned long long)arg2 error:(id*)arg3;
- (void)_purgeLegacyDictationAssetForLanguage:(id)arg1;
