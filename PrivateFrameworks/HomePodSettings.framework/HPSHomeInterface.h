...
- (void)_deviceDidUpdateSetting:(id)arg1 withValue:(id)arg2;
...
- (void)homeKitAccessorySettingForKeyPath:(id)arg1 value:(id)arg2 completion:(id /* block */)arg3;
- (void)homeKitSettingValueForKeyPath:(id)arg1 completion:(id /* block */)arg2;
- (id)hpsConnection;
- (id)initWithDelegate:(id)arg1;
- (void)isAutomaticSoftwareUpdateEnabled:(id /* block */)arg1;
- (void)isHomeKitSyncComplete:(id /* block */)arg1;
- (void)isValidHome:(id /* block */)arg1;
