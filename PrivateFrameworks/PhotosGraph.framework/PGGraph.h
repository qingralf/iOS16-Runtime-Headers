...
- (void)enumerateSocialGroupsIncludingMeNode:(bool)arg1 socialGroupsVersion:(unsigned long long)arg2 validGroupsBlock:(id /* block */)arg3 invalidGroupsBlock:(id /* block */)arg4 averageWeight:(out float*)arg5;
