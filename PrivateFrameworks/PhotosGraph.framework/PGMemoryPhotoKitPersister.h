...
- (bool)persistGraphEphemeralMemoriesFromEnrichedMemories:(id)arg1 graph:(id)arg2 progressReporter:(id)arg3 error:(id*)arg4;
- (bool)updateExistingMemories:(id)arg1 fetchedGraphEphemeralMemoryByUniqueIdentifier:(id)arg2 progressReporter:(id)arg3;
