...
- (id)_debugInformationForRelated:(id)arg1 referenceKeywords:(id)arg2 andRelatedMoment:(id)arg3 relatedType:(unsigned long long)arg4 precision:(unsigned long long)arg5 curationContext:(id)arg6;
...
- (bool)performLibraryAnalysisWithGraphURL:(id)arg1 withRecipe:(id)arg2 processedGraphUpdate:(id*)arg3 progressBlock:(id /* block */)arg4;
...
- (void)regenerateMeaningsWithProgressReporter:(id)arg1 completionBlock:(id /* block */)arg2;
...
- (id)relatedDebugInformationBetweenAsset:(id)arg1 andRelatedAssetCollection:(id)arg2 relatedType:(unsigned long long)arg3 precision:(unsigned long long)arg4 curationContext:(id)arg5;
- (id)relatedDebugInformationBetweenReferenceAssetCollection:(id)arg1 andRelatedAssetCollection:(id)arg2 relatedType:(unsigned long long)arg3 precision:(unsigned long long)arg4 curationContext:(id)arg5;
...
- (bool)swapInGraphAtURL:(id)arg1 progressBlock:(id /* block */)arg2;
