...
- (bool)_shouldUpdateRepresentativeAssetUUIDsForPerson:(id)arg1 actionValueString:(id)arg2 assetIsPassingSceneCriteria:(bool)arg3 personLocalIdentifierIsDoingActionInAsset:(bool)arg4;
