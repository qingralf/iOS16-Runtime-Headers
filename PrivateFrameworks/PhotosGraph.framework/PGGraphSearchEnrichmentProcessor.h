...
- (void)_processGraphUpdateInventory:(id)arg1 onGraph:(id)arg2 photoLibrary:(id)arg3 curationManager:(id)arg4 curationContext:(id)arg5 searchComputationCache:(id)arg6 progressBlock:(id /* block */)arg7 completionBlock:(id /* block */)arg8;
