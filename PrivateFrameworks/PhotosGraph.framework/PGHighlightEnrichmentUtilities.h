...
+ (bool)canUseSharingComposition:(unsigned short)arg1 forHighlightFilter:(unsigned short)arg2;
+ (id)childHighlightNodeOfGroupHighlightNode:(id)arg1 withLocalIdentifier:(id)arg2;
+ (id)filteredAssetsInAssets:(id)arg1 withSharingComposition:(unsigned short)arg2 forHighlightFilter:(unsigned short)arg3;
+ (id)filteredHighlightNodesWithHighlightNodes:(id)arg1 forHighlightFilter:(unsigned short)arg2;
+ (id)filteredMomentNodesWithHighlightNode:(id)arg1 forHighlightFilter:(unsigned short)arg2;
+ (id)headKeyAssetWithExtendedCuration:(id)arg1;
+ (id)internalPredicateForFetchingAssetsForSharingFilter:(unsigned short)arg1;
+ (id)keyAssetForDayGroupHighlightWithHighlightInfo:(id)arg1 sharingFilter:(unsigned short)arg2 curationManager:(id)arg3;
