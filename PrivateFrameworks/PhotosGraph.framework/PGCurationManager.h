...
- (id)cache;
- (double)contentScoreForAssetCollection:(id)arg1 precision:(unsigned long long)arg2 curationContext:(id)arg3;
...
- (id)curatedAssetsForAssetCollection:(id)arg1 duration:(unsigned long long)arg2 precision:(unsigned long long)arg3 referencePersonLocalIdentifiers:(id)arg4 curationContext:(id)arg5 progressBlock:(id /* block */)arg6;
...
- (bool)isAssetCollectionInteresting:(id)arg1 precision:(unsigned long long)arg2 curationContext:(id)arg3;
...
- (unsigned long long)optimalDurationForAssetCollection:(id)arg1 duration:(unsigned long long)arg2 precision:(unsigned long long)arg3 options:(id)arg4 curationContext:(id)arg5;
- (id)photoLibrary;
- (id)sceneGeography;
