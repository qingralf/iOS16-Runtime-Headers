...
@interface USKData : NSObject {
    ...
    struct VtValue { 
        ...
        struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::VtValue::_TypeInfo> { 
...
- (id)initWithVtValue:(struct VtValue { struct type { unsigned char x_1_1_1[8]; } x1; struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::VtValue::_TypeInfo> { struct _TypeInfo {} *x_2_1_1; } x2; })arg1 typeName:(struct TfToken { struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::TfToken::_Rep> { struct _Rep {} *x_1_1_1; } x1; })arg2;
- (id)initWithVtValue:(struct VtValue { struct type { unsigned char x_1_1_1[8]; } x1; struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::VtValue::_TypeInfo> { struct _TypeInfo {} *x_2_1_1; } x2; })arg1 typeName:(struct TfToken { struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::TfToken::_Rep> { struct _Rep {} *x_1_1_1; } x1; })arg2 withNodeOwner:(id)arg3;
- (id)initWithVtValue:(struct VtValue { struct type { unsigned char x_1_1_1[8]; } x1; struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::VtValue::_TypeInfo> { struct _TypeInfo {} *x_2_1_1; } x2; })arg1 typeName:(struct TfToken { struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::TfToken::_Rep> { struct _Rep {} *x_1_1_1; } x1; })arg2 withPropertyOwner:(id)arg3;
- (id)initWithVtValue:(struct VtValue { struct type { unsigned char x_1_1_1[8]; } x1; struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::VtValue::_TypeInfo> { struct _TypeInfo {} *x_2_1_1; } x2; })arg1 typeName:(struct TfToken { struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::TfToken::_Rep> { struct _Rep {} *x_1_1_1; } x1; })arg2 withSceneOwner:(id)arg3;
...
- (void)setValue:(struct VtValue { struct type { unsigned char x_1_1_1[8]; } x1; struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::VtValue::_TypeInfo> { struct _TypeInfo {} *x_2_1_1; } x2; })arg1;
- (id)stringArray;
- (id)stringValue;
- (id)timeCodeValue;
- (id)tokenArray;
...
- (id)urlValue;
- (struct VtValue { struct type { unsigned char x_1_1_1[8]; } x1; struct TfPointerAndBits<const pxrInternal_v0_21__aapl__pxrReserved__::VtValue::_TypeInfo> { struct _TypeInfo {} *x_2_1_1; } x2; })value;
