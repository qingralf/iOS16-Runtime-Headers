...
@interface USKScene : USKObject {
    NSURL * _fileURL;
    struct TfRefPtr<pxrInternal_v0_21__aapl__pxrReserved__::UsdStage> { 
...
- (id)initWithUsdStage:(struct TfRefPtr<pxrInternal_v0_21__aapl__pxrReserved__::UsdStage> { struct TfRefBase {} *x1; })arg1 fileURL:(id)arg2;
...
- (id)subLayerOffsets;
- (id)subLayerPaths;
- (struct TfRefPtr<pxrInternal_v0_21__aapl__pxrReserved__::UsdStage> { struct TfRefBase {} *x1; })usdStage;
