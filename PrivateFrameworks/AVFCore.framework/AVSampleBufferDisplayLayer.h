...
@interface AVSampleBufferDisplayLayer : CALayer <AVContentKeyRecipient, AVContentKeyRecipientInternal, AVMediaDataRequesterConsumer, AVPictureInPictureContentSource, AVQueuedSampleBufferRendering, AVQueuedSampleBufferRenderingInternal> {
    CALayer * _STSLayer;
    struct CGRect { 
        struct CGPoint { 
            double x; 
