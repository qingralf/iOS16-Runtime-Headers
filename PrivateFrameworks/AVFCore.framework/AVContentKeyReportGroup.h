...
- (bool)_associateRequestWithGroupWithRequestID:(long long)arg1 error:(id*)arg2;
...
- (bool)hasProtector;
- (id)initWithKeySystem:(id)arg1 keySession:(id)arg2 contentKeyBoss:(struct CMBaseObject { }*)arg3 groupID:(long long)arg4 storageDirectoryAtURL:(id)arg5;
