...
- (id)identifier;
- (id)initWithContentKeySession:(id)arg1 contentKeyBoss:(struct CMBaseObject { }*)arg2 keySpecifier:(struct FigContentKeySpecifier { }*)arg3 initializationData:(id)arg4 keyIDFromInitializationData:(id)arg5 contentIdentifier:(id)arg6 isRenewalRequest:(bool)arg7 requestID:(long long)arg8 providesPersistableKey:(bool)arg9 preloadingRequestOptions:(id)arg10 identifier:(id)arg11;
