...
- (id)initWithURL:(id)arg1 filteredLocalDestinationURL:(id)arg2 linkedURL:(id)arg3 filteredLinkedURL:(id)arg4 videoThumbnailPath:(id)arg5 UUID:(id)arg6 duration:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg7 dimensions:(struct { int x1; int x2; })arg8 stillPersistenceUUID:(id)arg9 stillDisplayTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg10 creationDate:(id)arg11 adjustmentsData:(id)arg12 coordinationInfo:(id)arg13 localPrivateMetadataFileURL:(id)arg14 error:(id)arg15;
