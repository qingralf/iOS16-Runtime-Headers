...
- (id)_zoomRangeStringForZoomFactor:(float)arg1 mode:(long long)arg2 devicePosition:(long long)arg3;
- (id)eventName;
...
- (void)populatePortraitStatus:(long long)arg1 lightingEffectIntensity:(double)arg2 apertureValue:(double)arg3 zoomFactor:(double)arg4;
