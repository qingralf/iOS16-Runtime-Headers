...
- (void)_configureForControlMode:(long long)arg1 zoomFactor:(double)arg2 zoomPoints:(id)arg3 zoomFactors:(id)arg4 displayZoomFactors:(id)arg5 zoomButtonContentType:(long long)arg6 compactPlatterLayout:(bool)arg7 animated:(bool)arg8;
...
- (bool)configureForContinuousZoomWithZoomFactor:(double)arg1 zoomPoints:(id)arg2 animated:(bool)arg3;
