...
@interface CAMUserPreferences : NSObject {
    ...
    long long  _maximumHEICPhotoResolution;
...
@property (nonatomic, readonly) long long maximumHEICPhotoResolution;
...
- (double)defaultZoomFactorForGraphConfiguration:(id)arg1 captureOrientation:(long long)arg2;
...
- (long long)maximumHEICPhotoResolution;
...
- (bool)shouldEnableHDR10BitVideoForMode:(long long)arg1;
...
- (long long)videoEncodingBehaviorForConfiguration:(long long)arg1 mode:(long long)arg2 wantsHDR10BitVideo:(bool)arg3 desiredProResVideoMode:(long long)arg4;
- (long long)videoStabilizationStrengthForVideoStabilizationMode:(long long)arg1;
