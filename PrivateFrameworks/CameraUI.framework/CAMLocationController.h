...
@interface CAMLocationController : NSObject <CLLocationManagerDelegate> {
    ...
    int  __authorizationQueue_currentAuthorizationStatus;
...
@property (nonatomic) int _authorizationQueue_currentAuthorizationStatus;
...
- (int)_authorizationQueue_currentAuthorizationStatus;
...
- (void)set_authorizationQueue_currentAuthorizationStatus:(int)arg1;
