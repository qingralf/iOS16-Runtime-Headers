...
- (id)_commandForConfiguration:(id)arg1 zoomFactor:(double)arg2 outRequestID:(int*)arg3;
...
- (int)applyCaptureConfiguration:(id)arg1 zoomFactor:(double)arg2;
...
- (void)changeToMacroMode:(long long)arg1;
...
- (void)startRampToVideoZoomFactor:(double)arg1 withDuration:(double)arg2 zoomRampTuning:(long long)arg3;
...
- (id)initWithCaptureConfiguration:(id)arg1 zoomFactor:(double)arg2 engineOptions:(long long)arg3 locationController:(id)arg4 motionController:(id)arg5 burstController:(id)arg6 protectionController:(id)arg7 powerController:(id)arg8 irisVideoController:(id)arg9 remoteShutterController:(id)arg10;
