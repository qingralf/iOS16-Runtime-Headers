...
@interface CAMViewfinderViewController : UIViewController <BCSActionDelegate, CAMAvailabilityDelegate, CAMBadgeTrayDelegate, CAMBarsAccessibilityHUDManagerDelegate, CAMBurstDelegate, CAMCameraRollControllerImageWellDelegate, CAMCameraRollControllerPresentationDelegate, CAMCameraRollControllerSessionDelegate, CAMCaptureInterruptionDelegate, CAMCaptureRecoveryDelegate, CAMCaptureRunningDelegate, CAMClosedViewfinderControllerDelegate, CAMConfigurationDelegate, CAMControlDrawerDelegate, CAMControlStatusBarDelegate, CAMControlVisibilityDelegate, CAMControlVisibilityUpdateDelegate, CAMDescriptionOverlayViewDelegate, CAMDisabledPreviewControllerDelegate, CAMDynamicShutterControlDelegate, CAMFacesDelegate, CAMFullscreenModeSelectorDataSource, CAMFullscreenModeSelectorDelegate, CAMFullscreenViewfinderDelegate, CAMHistogramDelegate, CAMImageAnalysisButtonDelegate, CAMLibrarySelectionDelegate, CAMMachineReadableCodeDelegate, CAMModeDialDataSource, CAMPanoramaCaptureRequestDelegate, CAMPhysicalCaptureNotifierDelegate, CAMPreviewLayerOverCaptureStatusDelegate, CAMPreviewViewControllerDelegate, CAMProminentObjectManagerDelegate, CAMRemoteShutterDelegate, CAMSemanticStyleSettingsControllerDelegate, CAMShallowDepthOfFieldStatusDelegate, CAMShutterButtonDelegate, CAMStillImageCaptureRequestDelegate, CAMStillImageCapturingVideoDelegate, CAMStorageControllerDelegate, CAMSuggestionDelegate, CAMTextRegionResultDelegate, CAMTimelapseControllerDelegate, CAMTimerButtonDelegate, CAMTimerCacheDelegate, CAMVideoCaptureRequestDelegate, CAMVideoConfigurationStatusIndicatorDelegate, CAMVideoThumbnailContentsDelegate, CAMZoomControlDelegate, CAMZoomDelegate, CAMZoomSliderDelegate, CEKLightingControlDelegate, CEKWheelScrubberViewDelegate, UIGestureRecognizerDelegate, VKCImageAnalysisInteractionDelegate, VKCaptureTextAnalysisRequestDelegate, VKTextLiftingViewDelegate> {
...
- (void)_dockMRCButtonIfNeededFromIndicator:(id)arg1 mrc:(id)arg2;
...
- (long long)_lowLightModeForMode:(long long)arg1 captureMode:(long long)arg2 device:(long long)arg3 ctmCaptureType:(long long)arg4 isBurst:(bool)arg5;
- (id)_machineReadableCodeLoggingController;
- (long long)_mappedVideoConfigurationForVideoConfiguration:(long long)arg1 proResVideoMode:(long long)arg2;
...
- (void)set_lastDefaultApertureValue:(double)arg1;
