...
@property (getter=_isShowingPointIndicator, nonatomic, readonly) bool _showingPointIndicator;
...
@property (nonatomic, readonly) UIImage *significantMRCIcon;
@property (nonatomic, readonly) CAMMachineReadableCodeIndicatorView *significantMRCIndicatorView;
@property (nonatomic, readonly, copy) NSString *significantMRCTitle;
...
- (id)significantMRCIcon;
- (id)significantMRCIndicatorView;
- (id)significantMRCTitle;
