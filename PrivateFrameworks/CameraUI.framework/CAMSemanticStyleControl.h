...
@interface CAMSemanticStyleControl : UIControl <CAMSemanticStyleSliderDelegate, UIGestureRecognizerDelegate> {
...
@property (nonatomic, readonly) CAMSemanticStyleSlider *_toneSlider;
@property (nonatomic, readonly) CAMSemanticStyleSlider *_warmthSlider;
