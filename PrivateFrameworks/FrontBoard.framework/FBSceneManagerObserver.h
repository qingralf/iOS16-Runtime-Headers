...
@interface FBSceneManagerObserver : NSObject <BSDescriptionProviding, FBSceneManagerDelegate_Private, FBSceneManagerInternalObserver, FBSceneWorkspaceDelegate> {
