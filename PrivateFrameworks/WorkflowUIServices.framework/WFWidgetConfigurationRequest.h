...
- (id)initWithIntent:(id)arg1 bundleIdentifier:(id)arg2 widgetBundleScopedURL:(id)arg3 schemaBundleURL:(id)arg4 family:(long long)arg5 widgetConfigurationStyle:(unsigned long long)arg6 defaultCardSize:(struct CGSize { double x1; double x2; })arg7 initialCardFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg8 widgetDisplayName:(id)arg9 widgetDescription:(id)arg10 usesWidgetAccentColor:(bool)arg11;
- (id)initWithIntent:(id)arg1 bundleIdentifier:(id)arg2 widgetBundleScopedURL:(id)arg3 schemaBundleURL:(id)arg4 family:(long long)arg5 widgetConfigurationStyle:(unsigned long long)arg6 defaultCardSize:(struct CGSize { double x1; double x2; })arg7 initialCardFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg8 widgetDisplayName:(id)arg9 widgetDescription:(id)arg10 widgetPrimaryColor:(id)arg11 widgetTintColor:(id)arg12 usesWidgetAccentColor:(bool)arg13;
