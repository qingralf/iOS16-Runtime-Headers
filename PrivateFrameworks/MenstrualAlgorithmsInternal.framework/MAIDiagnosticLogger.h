...
@property (nonatomic, readonly) /* Warning: unhandled struct encoding: '{basic_string<char' */ struct  jsonObjectName; /* unknown property attribute:  std::allocator<char>>={__rep=(?={__long=*QQ}{__short=[23c]{?=C}}{__raw=[3Q]})}}} */
