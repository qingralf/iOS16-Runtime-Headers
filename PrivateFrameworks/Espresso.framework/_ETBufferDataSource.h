...
@property /* Warning: unhandled struct encoding: '{unordered_map<std::string' */ struct  blobShapes; /* unknown property attribute:  true>>=f}}} */
@property /* Warning: unhandled struct encoding: '{unordered_map<std::string' */ struct  dataStorage; /* unknown property attribute:  true>>=f}}} */
