...
- (const void*)getDefaultMXSession:(unsigned int)arg1;
...
- (struct tuple<int, AudioSessionDuckingInfo> { struct __tuple_impl<std::__tuple_indices<0, 1>, int, AudioSessionDuckingInfo> { int x_1_1_1; struct AudioSessionDuckingInfo { bool x_2_2_1; float x_2_2_2; float x_2_2_3; } x_1_1_2; } x1; })setPlayState:(unsigned int)arg1 sessionID:(unsigned int)arg2 playerType:(unsigned int)arg3 playerRef:(void*)arg4 modes:(unsigned int)arg5 subsessionRef:(const void*)arg6;
- (void)startXPCServer;
