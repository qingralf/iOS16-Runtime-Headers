...
+ (id)announceVoicemailRequestForNotification:(id)arg1 synchronousBurstIndex:(id)arg2 isSameTypeAsLastAnnouncement:(bool)arg3 appBundleIdOfLastAnnouncement:(id)arg4 timeSinceLastAnnouncement:(double)arg5;
