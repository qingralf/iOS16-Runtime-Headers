...
@interface NewsUI2.TagFeedViewController : UIViewController <TSTabBarSplitViewAutoObserver, TeaUI.GutterViewBoundsObserver, UICollectionViewDelegate> {
    void _lastImpression;
    void backgroundContainerView;
