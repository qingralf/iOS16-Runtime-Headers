...
@property (nonatomic, retain) NSMutableDictionary *playersByJoinType;
...
- (void)sharePlayDataReceivedNotification:(id)arg1;
- (void)sharePlayReceiveData:(id)arg1 fromPlayerID:(id)arg2;
- (bool)sharePlaySendData:(id)arg1 toPlayers:(id)arg2 error:(id*)arg3;
