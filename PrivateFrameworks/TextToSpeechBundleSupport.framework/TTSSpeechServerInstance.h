...
- (void)_cleanupAfterRequest:(id)arg1;
...
- (bool)_languageCodeHasChanged:(id)arg1;
- (void)_loadOnDiskRules:(id)arg1;
...
- (id)_unzipFile:(id)arg1 withPassword:(id)arg2;
...
- (void)processMarker:(long long)arg1 withByteOffset:(unsigned int)arg2 markerPosition:(unsigned int)arg3 markerLength:(unsigned int)arg4 context:(id)arg5 currentTime:(unsigned long long)arg6 secondPass:(bool)arg7;
- (id)serviceQueue;
