...
- (void)_transcodeVideoAsync:(id)arg1 target:(long long)arg2 maxBytes:(unsigned long long)arg3 removeAlpha:(bool)arg4 preserveHEVC:(bool)arg5 preserveAA:(bool)arg6 userInfo:(id)arg7 completionHandler:(id /* block */)arg8;
