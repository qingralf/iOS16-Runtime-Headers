...
@property (nonatomic, readonly) bool hasExternalPluginViewControllerProvider;
...
- (bool)hasExternalPluginViewControllerProvider;
...
- (unsigned long long)presentationStyleInOrientation:(long long)arg1 forPluginID:(id)arg2;
