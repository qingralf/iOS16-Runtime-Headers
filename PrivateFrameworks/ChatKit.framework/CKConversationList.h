...
- (id)_conversationsToSort;
- (id)_copyEntitiesForAddressStrings:(id)arg1;
- (id)_filterConversations:(id)arg1 byHandleID:(id)arg2;
...
- (id)_handleIDForSIMFilterIndex:(long long)arg1;
...
- (void)recoverConversations:(id)arg1 synchronousQuery:(bool)arg2 completionHandler:(id /* block */)arg3;
