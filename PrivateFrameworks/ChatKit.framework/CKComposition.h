...
+ (id)updateCollaborationMetadata:(id)arg1 withBundleIDs:(id)arg2;
...
- (id)initWithText:(id)arg1 subject:(id)arg2 shelfPluginPayload:(id)arg3 bizIntent:(id)arg4 shelfMediaObject:(id)arg5;
- (id)initWithText:(id)arg1 subject:(id)arg2 shelfPluginPayload:(id)arg3 bizIntent:(id)arg4 shelfMediaObject:(id)arg5 collaborationOptions:(id)arg6;
- (id)initWithText:(id)arg1 subject:(id)arg2 shelfPluginPayload:(id)arg3 bizIntent:(id)arg4 shelfMediaObject:(id)arg5 collaborationShareOptions:(id)arg6;
