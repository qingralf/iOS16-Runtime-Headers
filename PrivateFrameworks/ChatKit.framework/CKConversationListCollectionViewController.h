...
- (id)_conversationActionMenusForItemIdentifier:(id)arg1 inSection:(unsigned long long)arg2 withCell:(id)arg3;
...
- (void)_handleSIMSubscriptionUpdate:(id)arg1;
...
- (id)_permanentDeleteAction:(id)arg1;
...
- (id)_recentlyDeletedMenuWithConversations:(id)arg1;
- (id)_recoverAction:(id)arg1;
