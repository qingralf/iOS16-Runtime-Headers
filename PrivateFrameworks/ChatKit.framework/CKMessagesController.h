...
@interface CKMessagesController : UISplitViewController <CKAlertSuppressionContextsProviding, CKAlertUtilitiesProtocol, CKBrowserViewControllerStoreSendDelegate, CKChatControllerDelegate, CKComposeChatControllerDelegate, CKConversationListControllerDelegate, CKCoreChatControllerDelegate, CKInboxViewControllerDelegate, CKInteractionNotificationViewDelegate, CKMacToolbarDelegate, CKMessagesNavigationProviding, CKOnboardingControllerDelegate, CKSelectionViewControllerDelegate, IMFocusStateManagerDelegate, UINavigationControllerDelegate, UIResponderStandardEditActions, UISplitViewControllerDelegate> {
...
- (void)_accessibilityReloadElementRelations:(bool)arg1;
- (void)loadView;
