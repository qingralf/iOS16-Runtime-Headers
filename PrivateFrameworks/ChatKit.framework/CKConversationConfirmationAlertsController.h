...
- (void)_presentJunkReportConfirmationWithActionCompletionBlock:(id /* block */)arg1;
...
- (void)presentRecoverConfirmationFromViewController:(id)arg1 forConversations:(id)arg2 alertControllerStyle:(long long)arg3 alertsCompletedBlock:(id /* block */)arg4 cancelBlock:(id /* block */)arg5;
