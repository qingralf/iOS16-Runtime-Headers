...
@interface CKTranscriptCollectionViewController : CKViewController <CKAssociatedMessageTranscriptCellDelegate, CKAudioControllerDelegate, CKBalloonViewDelegate, CKCommunicationSafetyEDUScreenProtocol, CKCoreTranscriptControllerProtocol, CKFullScreenEffectManagerDelegate, CKLocationShareBalloonViewDelegate, CKLocationSharingDelegate, CKMovieBalloonViewDelegate, CKPluginPlaybackManagerDelegate, CKSendAnimationManagerDelegate, CKTitledImageBalloonViewDelegate, CKTranscriptActionButtonCellDelegate, CKTranscriptBalloonSelectionManagerDataSource, CKTranscriptBalloonSelectionManagerDelegate, CKTranscriptCollectionViewDelegate, CKTranscriptCompositorDatasourceDelegate, CKTranscriptPhotoStackCellDelegate, CKVideoPlayerBalloonViewDelegate, CNAvatarViewDelegate, IMStateLoggable, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout> {
    ...
    bool  _dynamicsDisabledBeforeInitialLoad;
...
- (void)_updateTranscriptChatItemsWithAnimation:(id)arg1 withIMChatItems:(id)arg2 oldChatItems:(id)arg3 insertedChatItems:(id)arg4 inserted:(id)arg5 removed:(id)arg6 reload:(id)arg7 wantsScrollToBottom:(bool)arg8 scrollToBottomDuration:(double*)arg9 completion:(id /* block */)arg10;
...
- (bool)collectionView:(id)arg1 isSelectableDuringEditModeForItemAtIndexPath:(id)arg2;
...
- (bool)dynamicsDisabledBeforeInitialLoad;
...
- (void)setDynamicsDisabledBeforeInitialLoad:(bool)arg1;
...
- (void)setAxBuddyWasTyping:(bool)arg1;
