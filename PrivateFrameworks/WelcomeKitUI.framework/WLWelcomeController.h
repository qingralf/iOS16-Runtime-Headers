...
- (void)daemon:(id)arg1 didUpdateProgress:(float)arg2 remainingTime:(unsigned long long)arg3;
...
- (void)updateProgress:(float)arg1 remainingTime:(unsigned long long)arg2;
