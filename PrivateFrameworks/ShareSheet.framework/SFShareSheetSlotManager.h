...
- (void)activityViewControllerPerformedActivityWithSessionID:(id)arg1 presentationMs:(long long)arg2 activityType:(id)arg3 success:(bool)arg4;
...
- (void)connectToDaemonWithSessionID:(id)arg1 discoveryContext:(id)arg2 assetIdentifiers:(id)arg3 urlsBeingShared:(id)arg4 shouldSuggestFamilyMembers:(id)arg5 isSharePlayAvailable:(id)arg6 peopleSuggestionBundleIds:(id)arg7 completionHandler:(id /* block */)arg8;
