...
@interface SHSheetSession : NSObject <SFCollaborationItemChangeObserver, SFCollaborationItemsProviderDelegate, SHSheetActivitiesManagerDelegate, SHSheetActivityItemsManagerCollaborationDelegate, SHSheetActivityItemsManagerDelegate, SHSheetSession> {
