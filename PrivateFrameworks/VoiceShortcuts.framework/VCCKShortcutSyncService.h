...
- (void)handleFetchedOrSavedAutoShortcutsPreferencesFromRecord:(id)arg1;
...
- (id)syncFlagsRecord;
- (void)updateLocalAutoShortcutsPreferencesIfRemoteModificationDateNewerOnRecord:(id)arg1;
