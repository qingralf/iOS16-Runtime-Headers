...
- (void)sendProcessControlEvent:(id)arg1 toPid:(id)arg2 error:(id*)arg3;
- (void)showNotificiationCenterWidget:(id)arg1 withError:(id*)arg2;
- (void)showSBWidget:(id)arg1 withError:(id*)arg2;
- (void)simulateNotificationForBundleID:(id)arg1 payload:(id)arg2 withError:(id*)arg3;
