...
@interface SAUISystemApertureManager : NSObject <SAAlertingConfiguring, SAElementHosting, SAElementRegistering, SAUIElementConsideringDelegate, SAUIElementViewControllingObserving, SAUILayoutHostingPrivate, SAUILayoutSpecifyingOverridingParticipant> {
...
- (void)_ax_layoutSpecifierRequestsDiminishment:(id)arg1;
...
- (bool)isActivityElementAlerting:(id)arg1;
- (bool)isElementExpandedDueToUserInteraction:(id)arg1;
...
- (long long)preferredLayoutModeForElement:(id)arg1;
- (long long)preferredLayoutModeForElement:(id)arg1 fromUserAction:(bool*)arg2;
