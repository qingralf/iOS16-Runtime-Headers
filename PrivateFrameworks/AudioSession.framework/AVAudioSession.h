...
- (void)addCategoryOptionsToDictionary:(id)arg1 nonXPCArray:(id)arg2 category:(id)arg3 options:(unsigned long long)arg4 useXPC:(bool)arg5;
...
- (bool)privateCreateSessionInServerUsingAudioToolbox:(void*)arg1 type:(unsigned int)arg2 identifier:(id)arg3;
