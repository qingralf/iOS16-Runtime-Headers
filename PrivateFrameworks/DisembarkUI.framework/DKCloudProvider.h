...
@interface DKCloudProvider : NSObject <BYClientDaemonCloudSyncProtocol, DKCloudProvider> {
    ...
    NSMutableDictionary * _backupResultByAltDSID;
...
@property (nonatomic, retain) NSMutableDictionary *backupResultByAltDSID;
...
- (void)setBackupResultByAltDSID:(id)arg1;
