...
- (void)accessibilityZoom:(double)arg1 point:(struct CGPoint { double x1; double x2; })arg2 animated:(bool)arg3 completionHandler:(id /* block */)arg4;
- (void)accessibilityZoom:(double)arg1 point:(struct CGPoint { double x1; double x2; })arg2 completionHandler:(id /* block */)arg3;
