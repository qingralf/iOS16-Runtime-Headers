...
+ (id)groupedSenderMessageListForMailboxes:(id)arg1 senderBuckets:(id)arg2 includeVIPs:(bool)arg3 limitDate:(id)arg4 withRepository:(id)arg5;
+ (id)log;
+ (id)simpleMessageListForMailboxes:(id)arg1 withRepository:(id)arg2 shouldTrackOldestItems:(bool)arg3 shouldUpdateDisplayDate:(bool)arg4;
+ (id)simpleMessageListForMailboxes:(id)arg1 withRepository:(id)arg2 shouldTrackOldestItems:(bool)arg3 shouldUpdateDisplayDate:(bool)arg4 orderByDisplayDate:(bool)arg5 transformPredicate:(id /* block */)arg6 ignoreMessageAdditionsPredicate:(id)arg7;
+ (id)threadedMessageListForMailboxes:(id)arg1 withRepository:(id)arg2 shouldTrackOldestItems:(bool)arg3 shouldUpdateDisplayDate:(bool)arg4;
+ (id)threadedMessageListForMailboxes:(id)arg1 withRepository:(id)arg2 shouldTrackOldestItems:(bool)arg3 shouldUpdateDisplayDate:(bool)arg4 orderByDisplayDate:(bool)arg5 transformPredicate:(id /* block */)arg6 ignoreMessageAdditionsPredicate:(id)arg7;
...
- (void)finishRecovery;
- (id)initWithMailboxes:(id)arg1 repository:(id)arg2 orderByDisplayDate:(bool)arg3 transformPredicate:(id /* block */)arg4 ignoreMessageAdditionsPredicate:(id)arg5 targetClass:(Class)arg6 shouldTrackOldestItems:(bool)arg7 shouldUpdateDisplayDate:(bool)arg8 labelPrefix:(id)arg9;
