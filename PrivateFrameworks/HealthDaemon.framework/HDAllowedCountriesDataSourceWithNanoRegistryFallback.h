...
- (id)initWithAllowedCountriesDataSource:(id)arg1 pairedDeviceCapabilityProvider:(id)arg2 availableRegionsDevicePropertyName:(id)arg3 loggingCategory:(id)arg4 shouldReturnLocalAvailabilityForNilDeviceRegions:(bool)arg5;
- (id)localCountrySet;
