...
- (id)delegate;
- (id)description;
- (id)initWithAllowedCountriesDataSource:(id)arg1 profile:(id)arg2 pairedDeviceCapabilityProvider:(id)arg3 featureCapability:(id)arg4 loggingCategory:(id)arg5;
- (id)initWithAllowedCountriesDataSource:(id)arg1 profile:(id)arg2 pairedDeviceCapabilityProvider:(id)arg3 featureCapability:(id)arg4 reloadsLocalCountrySetOnRemoteCountrySetUpdate:(bool)arg5 loggingCategory:(id)arg6;
