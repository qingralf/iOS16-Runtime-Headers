...
+ (id)insertCodableCluster:(id)arg1 syncProvenance:(long long)arg2 transaction:(id)arg3 error:(id*)arg4;
+ (id)insertOrUpdateRacingCluster:(id)arg1 routeSnapshot:(id)arg2 transaction:(id)arg3 error:(id*)arg4;
