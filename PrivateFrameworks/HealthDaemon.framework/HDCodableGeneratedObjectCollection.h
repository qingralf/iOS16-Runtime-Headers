...
@property (nonatomic, retain) NSMutableArray *signedClinicalDataRecords;
@property (nonatomic, retain) NSMutableArray *unknownRecords;
@property (nonatomic, retain) NSMutableArray *vaccinationRecords;
@property (nonatomic, retain) NSMutableArray *verifiableClinicalRecords;
