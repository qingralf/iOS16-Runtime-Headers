...
+ (long long)storeUserDomainConcept:(id)arg1 method:(long long)arg2 syncProvenance:(long long)arg3 syncVersion:(struct { int x1; int x2; })arg4 transaction:(id)arg5 error:(id*)arg6;
