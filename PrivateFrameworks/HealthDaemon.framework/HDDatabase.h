...
@interface HDDatabase : NSObject <HDAnalyticsSubmissionCoordinatorDelegate, HDAssertionObserver, HDContentProtectionObserver, HDDatabaseCorruptionEventStoreDelegate, HDDatabaseJournalDelegate, HDDatabaseMigrationTransactionDelegate, HDDiagnosticObject, HDHealthDaemonReadyObserver, HDHealthDatabase, HDProfileReadyObserver, HDSQLiteDatabaseDelegate, HDSQLiteDatabasePoolDelegate, HDSQLiteDatabaseProvider> {
