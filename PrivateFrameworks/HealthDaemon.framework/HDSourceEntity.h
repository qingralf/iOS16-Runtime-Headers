...
+ (id)foreignKeys;
+ (id)indices;
+ (id)insertSourceWithUUID:(id)arg1 logicalSourceID:(long long)arg2 name:(id)arg3 options:(unsigned long long)arg4 isCurrentDevice:(bool)arg5 productType:(id)arg6 deleted:(bool)arg7 modificationDate:(id)arg8 provenance:(long long)arg9 syncIdentity:(id)arg10 transaction:(id)arg11 error:(id*)arg12;
...
- (bool)deleteSourceWithTombstoneLogicalSourceID:(long long)arg1 database:(id)arg2 error:(id*)arg3;
