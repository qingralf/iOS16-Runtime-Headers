...
- (bool)updateOntologyWithShardIdentifier:(id)arg1 schemaType:(id)arg2 schemaVersion:(int)arg3 localShardURL:(id)arg4 shardVersion:(long long)arg5 error:(id*)arg6;
