...
+ (bool)enumerateSummariesWithTransactionID:(unsigned long long)arg1 package:(id)arg2 names:(id)arg3 databaseTransaction:(id)arg4 error:(id*)arg5 enumerationHandler:(id /* block */)arg6;
+ (id)foreignKeys;
