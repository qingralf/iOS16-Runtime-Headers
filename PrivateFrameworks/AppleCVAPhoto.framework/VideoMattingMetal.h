...
- (void).cxx_destruct;
- (void)alphaMattingWithPostprocessedDisparity:(struct __CVBuffer { }*)arg1 source:(struct __CVBuffer { }*)arg2 inSegmentation:(struct __CVBuffer { }*)arg3 alpha:(struct __CVBuffer { }*)arg4 staticParams:(const struct VideoMattingStaticParams { bool x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; int x8; int x9; unsigned int x10; float x11; float x12; float x13; float x14; float x15; float x16; float x17; float x18; float x19; float x20; float x21; unsigned int x22; unsigned int x23; int x24; float x25; float x26; float x27; float x28; }*)arg5 dynamicParams:(const void*)arg6 usePostprocessedDisparity:(bool)arg7 isFinalStage:(bool)arg8 dilateForegroundMask:(bool)arg9 callbackQueue:(id)arg10 callback:(id /* block */)arg11;
...
- (void)dealloc;
- (id)disparityPostprocessingWithCanonicalDisparity:(struct __CVBuffer { }*)arg1 color:(struct __CVBuffer { }*)arg2 postProcessedDisparity:(struct __CVBuffer { }*)arg3 staticParams:(const struct VideoMattingStaticParams { bool x1; unsigned int x2; unsigned int x3; unsigned int x4; unsigned int x5; unsigned int x6; unsigned int x7; int x8; int x9; unsigned int x10; float x11; float x12; float x13; float x14; float x15; float x16; float x17; float x18; float x19; float x20; float x21; unsigned int x22; unsigned int x23; int x24; float x25; float x26; float x27; float x28; }*)arg4 dynamicParams:(const void*)arg5 postProcessingParams:(const struct VideoPostprocessingParams { bool x1; float x2; bool x3; float x4; float x5; bool x6; }*)arg6 facesArray:(id)arg7 faceModel:(id)arg8 isFinalStage:(bool)arg9 callbackQueue:(id)arg10 callback:(id /* block */)arg11;
