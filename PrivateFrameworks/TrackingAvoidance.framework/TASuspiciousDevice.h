...
- (id)initWithLatestAdv:(id)arg1 detectionSummary:(id)arg2 date:(id)arg3 locHistory:(id)arg4 detectionMetrics:(id)arg5 detectionType:(unsigned long long)arg6 immediacyType:(unsigned long long)arg7;
