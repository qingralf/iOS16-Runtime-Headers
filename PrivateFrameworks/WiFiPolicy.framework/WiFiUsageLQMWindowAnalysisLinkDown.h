...
- (id)initWithRollingWindow:(id)arg1 WithIsInvoluntary:(bool)arg2 AndLinkChangeReason:(long long)arg3 AndLinkChangeSubreason:(long long)arg4 AndDuration:(unsigned long long)arg5 andActiveCall:(bool)arg6 AndTimestamp:(id)arg7 onQueue:(id)arg8;
- (bool)isInvoluntary;
- (id)linkDownReason;
