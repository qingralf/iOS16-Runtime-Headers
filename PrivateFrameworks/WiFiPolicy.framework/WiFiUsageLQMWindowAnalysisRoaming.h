...
- (id)initWithRollingWindow:(id)arg1 WithRoamingState:(bool)arg2 andReasonString:(id)arg3 andStatus:(unsigned long long)arg4 asString:(id)arg5 andLatency:(unsigned long long)arg6 andRoamData:(id)arg7 andCurrentBSSSession:(id)arg8 andActiveCall:(bool)arg9 andPingPongStats:(id)arg10 andTimestamp:(id)arg11 onQueue:(id)arg12;
- (bool)isWNMScoreRoam;
- (long long)latency;
