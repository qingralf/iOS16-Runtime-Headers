...
@interface WiFiUsageLQMUserSample : WiFiUsageLQMSample {
    ...
    unsigned long long  _roamRecommended;
    long long  _rssi;
    ...
    long long  _snr;
    unsigned long long  _tdRecommended;
    NSDate * _timestamp;
...
- (unsigned long long)roamRecommended;
- (long long)rssi;
...
- (void)setRoamRecommended:(unsigned long long)arg1;
...
- (void)setTdRecommended:(unsigned long long)arg1;
...
- (long long)snr;
- (unsigned long long)tdRecommended;
- (id)timestamp;
