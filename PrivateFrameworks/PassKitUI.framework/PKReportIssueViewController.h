...
- (id)initWithTransaction:(id)arg1 transactionSourceCollection:(id)arg2 paymentPass:(id)arg3 familyCollection:(id)arg4 account:(id)arg5 accountUserCollection:(id)arg6 physicalCards:(id)arg7 detailViewStyle:(long long)arg8;
