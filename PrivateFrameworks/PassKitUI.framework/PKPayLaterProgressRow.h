...
+ (void)_purchaseStringsForInstallmentNumber:(unsigned long long)arg1 installmentAmount:(id)arg2 title:(id*)arg3 amountString:(id*)arg4 dynamicContentPage:(id)arg5;
+ (id)progressRowsWithInstallmentAmounts:(id)arg1 firstRowFont:(id)arg2 dynamicContentPage:(id)arg3;
