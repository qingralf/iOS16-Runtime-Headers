...
- (void)_setupItemForExpressUpgradeWithAsset:(id)arg1 hideDisableAction:(unsigned long long)arg2 pass:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)allowIdleTimer;
- (void)applicationMessageView:(id)arg1 requestsLocalMessageDismissal:(id)arg2;
...
- (void)presentExpressUpgradeDetailForPassUniqueID:(id)arg1 assetIdentifier:(id)arg2 hideDisableAction:(unsigned long long)arg3 animated:(bool)arg4 completionHandler:(id /* block */)arg5;
