...
@interface PKPaymentCardManualEntryViewController : PKPaymentSetupProvisioningFieldsViewController <PKPaymentCameraCaptureViewControllerDelegate, PKPaymentSetupDisambiguationViewControllerDelegate> {
