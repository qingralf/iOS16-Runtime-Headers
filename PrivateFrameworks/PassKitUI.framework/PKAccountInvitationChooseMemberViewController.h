...
@interface PKAccountInvitationChooseMemberViewController : UIViewController <PKAccountInvitationControllerObserver, PKDeviceSharingCapabilitiesManagerObserver, PKViewControllerPreflightable, UITableViewDelegate, UITableViewDelegatePrivate, _PKUIKVisibilityBackdropViewDelegate> {
