...
+ (id)createForTransactionWithPass:(id)arg1 primaryText:(id)arg2 secondaryText:(id)arg3 trailingViewConfiguration:(id)arg4;
+ (id)createWithPass:(id)arg1 primaryText:(id)arg2 secondaryText:(id)arg3 trailingViewConfiguration:(id)arg4;
