...
@interface PKExpressTransactionBannerViewController : UIViewController <PKBannerViewController, PKExpressBannerLabelViewDelegate, PKExpressBannerLeadingViewDelegate, PKExpressBannerTrailingViewDelegate, PKPaymentServiceDelegate> {
