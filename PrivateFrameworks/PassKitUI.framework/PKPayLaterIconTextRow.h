...
+ (id)rowConfiguredForDisputeLayoutWithFiancingPlan:(id)arg1 payment:(id)arg2 selectionHandler:(id /* block */)arg3;
...
- (id)icon;
- (id)identifier;
- (id)initWithPrimaryTitle:(id)arg1 selectionHandler:(id /* block */)arg2;
