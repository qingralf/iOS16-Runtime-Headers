...
@interface PKDashboardPassViewController : PKDashboardViewController <BKOperationDelegate, LANotificationObserver, PKAccountServiceObserver, PKDashboardMoreMenuFactoryDelegate, PKDashboardPassTilesItemPresenterDelegate, PKForegroundActiveArbiterObserver, PKInvalidatable, _PKUIKVisibilityBackdropViewDelegate> {
...
- (void)notification:(id)arg1 completionHandler:(id /* block */)arg2;
