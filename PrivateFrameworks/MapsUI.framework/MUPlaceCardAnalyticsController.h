...
- (void).cxx_destruct;
- (void)_infoCardAnalyticsDidSelectAction:(int)arg1 target:(int)arg2 eventValue:(id)arg3 actionURL:(id)arg4 photoID:(id)arg5 feedbackDelegateSelector:(int)arg6 modules:(id)arg7 completion:(id /* block */)arg8;
...
- (void)instrumentRevealIfNeededWithImpressionsSessionId:(id)arg1;
