...
@property (nonatomic) MUPlaceTileCellConfiguration *cellConfiguration;
...
+ (struct CGSize { double x1; double x2; })preferredSizeForViewModels:(id)arg1 cellConfiguration:(id)arg2;
+ (id)reuseIdentifier;
