...
- (bool)_enoughTimeHasPassedSinceInitializationToMarkNotWithYouForDeviceType:(id)arg1;
...
- (double)_maxAgeOfWithYouAdvertisementForDeviceType:(unsigned long long)arg1 forMonitoringState:(unsigned long long)arg2;
