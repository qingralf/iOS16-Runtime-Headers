...
- (unsigned long long)convertSADeviceTypeForCoreAnalytics:(id)arg1;
...
- (id)lastLocation;
- (double)minimumTimeSinceScenarioTransitionForAlertForDevice:(id)arg1 alertType:(unsigned long long)arg2;
...
- (double)timeDelayForRetryScanForAlertForDevice:(id)arg1 alertType:(unsigned long long)arg2;
