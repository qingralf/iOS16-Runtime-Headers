...
- (id)coreDataAutoShortcutsPreferencesForAppDescriptorHash:(unsigned long long)arg1 error:(id*)arg2;
...
- (id)descriptorsForResult:(id)arg1 state:(id*)arg2 error:(id*)arg3;
