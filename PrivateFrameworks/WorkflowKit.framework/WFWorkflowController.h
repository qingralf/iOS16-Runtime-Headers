...
@interface WFWorkflowController : NSObject <WFActionParameterInputProvider, WFActionRunningDelegate, WFVariableDataSource, WFWorkflowNoInputBehaviorDelegate> {
...
- (void)action:(id)arg1 wantsToToastSessionKitSessionWithIdentifier:(id)arg2 completionHandler:(id /* block */)arg3;
