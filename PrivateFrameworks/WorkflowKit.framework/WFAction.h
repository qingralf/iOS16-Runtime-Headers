...
@interface WFAction : NSObject <NSCopying, NSItemProviderReading, NSItemProviderWriting, NSSecureCoding, WFAppInstalledResourceDelegate, WFParameterEventObserver, WFUUIDProvider, WFVariableProvider> {
...
@property (nonatomic, readonly) WFImage *iconImage;
...
@property (nonatomic, readonly) WFImage *outputIconImage;
...
@property (nonatomic, readonly) <WFActionSandboxExtensionProvider> *sandboxExtensionProvider;
