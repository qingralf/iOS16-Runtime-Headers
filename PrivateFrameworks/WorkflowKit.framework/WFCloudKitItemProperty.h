...
+ (id)assetPropertyWithName:(id)arg1 fileType:(id)arg2 ignoredByDefault:(bool)arg3;
...
- (void).cxx_destruct;
- (id)fileType;
- (id)initWithType:(unsigned long long)arg1 name:(id)arg2 itemClass:(Class)arg3 ignoredByDefault:(bool)arg4 nilValue:(id)arg5 fileType:(id)arg6;
