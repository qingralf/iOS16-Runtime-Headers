...
+ (id)serializedIdentifierFromLinkValue:(id)arg1;
+ (id)serializedRepresentationFromLinkValue:(id)arg1;
+ (id)serializedRepresentationFromValue:(id)arg1;
+ (id)valueFromSerializedRepresentation:(id)arg1 variableProvider:(id)arg2 parameter:(id)arg3;
+ (id)valueFromSerializedValueRepresentation:(id)arg1 valueType:(id)arg2 variableProvider:(id)arg3 parameter:(id)arg4;
