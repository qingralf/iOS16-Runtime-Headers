...
@interface SVXSession : NSObject <AFAssistantUIService, AFSpeechDelegate, SVXAudioSessionProviding, SVXSpeechSynthesisListening, SVXTaskTrackingCenterDelegate> {
